...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T05:04:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T050450Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787192113` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-20 02:15:13` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T13:13:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T131308Z` |
...
| `start_time` | `str` | Pendiente de documentar | `12:53:18` |
...
| `bearing` | `float64` | Pendiente de documentar | `123.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787231573` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T131308Z` |
| `entity_id` | `str` | Pendiente de documentar | `7e5314f5-7db3-4b48-981a-3e7d0870bcee` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.479042053222656` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09829711914062` |
| `bearing` | `float64` | Pendiente de documentar | `123.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787231573` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-20 07:12:53-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T04:56:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T045646Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-20T04:56:47.195628` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T045646Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-20T04:56:47.116930` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3261501488` |
| `lon` | `float64` | Pendiente de documentar | `-99.3286760802` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-20T04:44:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-20T05:15:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3285956139, 19.3267670951], [-99.3286009783, 19.3267120446], [-99.3286197538` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24453242284007000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
