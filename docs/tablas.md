...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-16T21:33:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T213334Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1781645455` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-16 21:30:55` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-16T23:49:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T234948Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:11:19` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781653770` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T234948Z` |
| `entity_id` | `str` | Pendiente de documentar | `e3486140-4039-4860-b245-b5babe4d76e2` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46600341796875` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06063079833984` |
| `bearing` | `float64` | Pendiente de documentar | `133.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `24.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781653770` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-16 17:49:30-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-16T21:24:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T212428Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-16T21:24:29.447722` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.986207` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T212428Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-16T21:24:29.333452` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3596053642` |
| `lon` | `float64` | Pendiente de documentar | `-99.3515311832` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-16T21:15:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-16T21:42:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3515754396, 19.3595691458], [-99.3515311832, 19.3596053642], [-99.3509330506` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2854a05b-83f3-499c-b803-c30b2f24b6df-TTL24441700916015000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
