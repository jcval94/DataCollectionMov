...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T18:09:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T180947Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:03:26` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786730968` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T180947Z` |
| `entity_id` | `str` | Pendiente de documentar | `45a174ad-628e-4de6-be6f-44b256b7c2ae` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.505653381347656` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1907196044922` |
| `bearing` | `float64` | Pendiente de documentar | `153.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786730968` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-14 12:09:28-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
