...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-11T19:47:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260611T194714Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:16:50` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781207218` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260611T194714Z` |
| `entity_id` | `str` | Pendiente de documentar | `37789dd9-b2ce-4684-8b5d-912f7eb0783b` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.482770919799805` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11420440673828` |
| `bearing` | `float64` | Pendiente de documentar | `143.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `23.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781207218` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-11 13:46:58-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-11T20:40:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260611T204043Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-11T20:40:43.750387` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.44474034620506` |
| `confidence` | `float64` | Pendiente de documentar | `0.783925` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 9, "freeFlowSpeed": 13, "currentTravelTime": 1085, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260611T204043Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-11T20:40:43.706859` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-06-11T20:59:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-208c1abc-26cd-42ed-a876-d2f71f564b3d-TTR24415734756020000", "iconCategory": 9, "magnitudeOfDelay": 0, "start` |
