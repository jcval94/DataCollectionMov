...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-30T21:07:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T210714Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:22:55` |
...
| `bearing` | `float64` | Pendiente de documentar | `264.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782853627` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T210714Z` |
| `entity_id` | `str` | Pendiente de documentar | `3b8c9f4b-f1ea-48e7-a137-c64f9da966cf` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.490880966186523` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13229370117188` |
| `bearing` | `float64` | Pendiente de documentar | `264.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782853627` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-30 15:07:07-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
