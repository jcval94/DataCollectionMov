...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-17T20:21:28Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T202124Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:23:00` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789676460` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T202124Z` |
| `entity_id` | `str` | Pendiente de documentar | `fd590db3-7831-4172-aa7e-da3c3251f1f5` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.50390243530273` |
| `longitude` | `float64` | Pendiente de documentar | `-99.18301391601562` |
| `bearing` | `float64` | Pendiente de documentar | `291.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789676460` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-17 14:21:00-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
