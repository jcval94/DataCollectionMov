...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-01T05:29:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T052950Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788234518` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-01 03:48:38` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-01T16:42:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T164235Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:32:18` |
| `start_date` | `float64` | Pendiente de documentar | `20260901.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788280940` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T164235Z` |
| `entity_id` | `str` | Pendiente de documentar | `a855cda5-f80e-424c-a4b1-5ee938f1e7d1` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.497577667236328` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1655044555664` |
| `bearing` | `float64` | Pendiente de documentar | `116.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `8.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788280940` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-01 10:42:20-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-31T19:34:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260831T193439Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-31T19:34:40.228641` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `464.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `429.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `7.733333333333333` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `8.158508158508159` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260831T193439Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-31T19:34:41.504526` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260831T193439Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-31T19:34:40.134171` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260831T193439Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-31T19:34:44.239632` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `588.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `537.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `9.8` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.95` |
| `delay_seconds` | `float64` | Pendiente de documentar | `51.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `0.85` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `9.49720670391061` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `0.85` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `9.49720670391061` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0574742268041237` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0980592441266598` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.3428951182809783` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `12.876316116238227` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-01T05:19:34Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T051931Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-01T05:19:31.595453` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T051931Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-01T05:19:31.552644` |
...
| `lat` | `float64` | Pendiente de documentar | `19.375002546` |
| `lon` | `float64` | Pendiente de documentar | `-99.331343537` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-29T22:45:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-01T05:47:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3301553184, 19.3747223141], [-99.3302103037, 19.3747383657], [-99.3303310031` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4f54caf4-b222-4646-895c-ec863c842a32-TTR24444586752020000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
