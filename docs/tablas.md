...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-18T03:41:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260718T034146Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784345590` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-18 03:33:10` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-18T03:29:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260718T032900Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:00:08` |
| `start_date` | `float64` | Pendiente de documentar | `20260718.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784345326` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260718T032900Z` |
| `entity_id` | `str` | Pendiente de documentar | `a2e2726e-2a70-4b39-9091-85acc24f11c0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48225975036621` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10575103759766` |
| `bearing` | `float64` | Pendiente de documentar | `292.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784345326` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-17 21:28:46-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-18T03:38:37Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260718T033833Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-18T03:38:34.233975` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.266536964980545` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 15, "freeFlowSpeed": 19, "currentTravelTime": 651, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260718T033833Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-18T03:38:34.144023` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3001662899` |
| `lon` | `float64` | Pendiente de documentar | `-99.3648765142` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-18T03:13:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-18T03:59:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24453241936104000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
