...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-16T17:23:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T172256Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:15:40` |
...
| `bearing` | `float64` | Pendiente de documentar | `169.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781630557` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T172256Z` |
| `entity_id` | `str` | Pendiente de documentar | `a4f53d8c-9c6b-4931-ba0c-bca4f6c2ef35` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.1194076538086` |
| `bearing` | `float64` | Pendiente de documentar | `169.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781630557` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-16 11:22:37-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
