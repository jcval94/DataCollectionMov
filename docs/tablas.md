...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-13T23:04:45Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T230442Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:24:22` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786662273` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T230442Z` |
| `entity_id` | `str` | Pendiente de documentar | `7519d2e8-5e23-45e6-8e21-44fbc33e8aa9` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.12397003173828` |
| `bearing` | `float64` | Pendiente de documentar | `308.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786662273` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-13 17:04:33-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
