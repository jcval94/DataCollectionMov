...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T15:10:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T151024Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:46:24` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786115430` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T151024Z` |
| `entity_id` | `str` | Pendiente de documentar | `0666f0e0-8005-4666-8c52-0d2519e997fd` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47327995300293` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0688018798828` |
| `bearing` | `float64` | Pendiente de documentar | `317.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786115430` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-07 09:10:30-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
