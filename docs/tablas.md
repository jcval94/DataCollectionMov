...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-29T18:25:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T182522Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:10:46` |
...
| `bearing` | `float64` | Pendiente de documentar | `964.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782757507` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T182522Z` |
| `entity_id` | `str` | Pendiente de documentar | `56330b0b-c6d5-4843-b506-633df756a4b4` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49773406982422` |
| `longitude` | `float64` | Pendiente de documentar | `-99.16604614257812` |
| `bearing` | `float64` | Pendiente de documentar | `964.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `29.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782757507` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-29 12:25:07-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-29T18:28:20Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T182816Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-29T18:28:16.841801` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.993291` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T182816Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-29T18:28:16.751505` |
...
| `lat` | `float64` | Pendiente de documentar | `19.496399376` |
| `lon` | `float64` | Pendiente de documentar | `-99.3631746525` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-29T18:06:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-29T18:47:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.362282818, 19.4971691193], [-99.362398153, 19.4972000133], [-99.3624772782, ` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-d78aba7a-98dd-4e36-8e61-64835b4cc286-TTL24418619376027000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
