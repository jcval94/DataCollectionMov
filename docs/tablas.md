...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-10T22:58:12Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T225809Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:26:45` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786402677` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T225809Z` |
| `entity_id` | `str` | Pendiente de documentar | `e74c31f0-a2d5-427b-8e17-179813758a1a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.486860275268555` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1180419921875` |
| `bearing` | `float64` | Pendiente de documentar | `180.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `17.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786402677` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-10 16:57:57-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
