...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-10T13:50:20Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T135016Z` |
...
| `start_time` | `str` | Pendiente de documentar | `13:34:08` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786369812` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T135016Z` |
| `entity_id` | `str` | Pendiente de documentar | `9eb8d2b6-2236-40f8-8e90-6217de7185b7` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.468847274780277` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08474731445312` |
| `bearing` | `float64` | Pendiente de documentar | `317.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `36.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786369812` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-10 07:50:12-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
