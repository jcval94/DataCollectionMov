...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-30T04:33:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T043318Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:39:32` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782793990` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T043318Z` |
| `entity_id` | `str` | Pendiente de documentar | `fc90f5fc-6e14-45e7-b5e9-ad5f936c3643` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.468338012695312` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0632553100586` |
| `bearing` | `float64` | Pendiente de documentar | `132.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `49.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782793990` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-29 22:33:10-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
