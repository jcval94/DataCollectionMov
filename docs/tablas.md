...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-29T21:56:37Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T215636Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782769797` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-29 21:49:57` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-29T22:33:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T223303Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:41:53` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782772372` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T223303Z` |
| `entity_id` | `str` | Pendiente de documentar | `b92b1a60-e683-4034-893f-cf0da93b3e8a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49705696105957` |
| `longitude` | `float64` | Pendiente de documentar | `-99.16291046142578` |
| `bearing` | `float64` | Pendiente de documentar | `262.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `50.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782772372` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-29 16:32:52-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
