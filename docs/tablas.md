...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T15:02:59Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T150257Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785250848` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-28 15:00:48` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T06:39:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T063902Z` |
...
| `start_time` | `str` | Pendiente de documentar | `05:25:22` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785220393` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T063902Z` |
| `entity_id` | `str` | Pendiente de documentar | `5b87e37a-ebe4-4a39-a1c0-65ac59099804` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47835922241211` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06487274169922` |
| `bearing` | `float64` | Pendiente de documentar | `275.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785220393` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-28 00:33:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T14:56:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T145603Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-28T14:56:04.217923` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.979701` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T145603Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-28T14:56:04.117812` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-28T14:50:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-28T15:14:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441700956022000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
