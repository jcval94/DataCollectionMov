...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-23T00:53:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T005349Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1790124752` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-23 00:52:32` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-22T22:59:49Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260922T225945Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:40:50` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790117980` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260922T225945Z` |
| `entity_id` | `str` | Pendiente de documentar | `73e41b16-45fd-48a7-a336-ed35b7718e12` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4945011138916` |
| `longitude` | `float64` | Pendiente de documentar | `-99.15128326416016` |
| `bearing` | `float64` | Pendiente de documentar | `103.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `49.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790117980` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-22 16:59:40-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-23T00:46:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T004626Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-23T00:46:26.708740` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.991168` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T004626Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-23T00:46:26.612869` |
...
| `lat` | `float64` | Pendiente de documentar | `19.41699393` |
| `lon` | `float64` | Pendiente de documentar | `-99.3683915491` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-23T00:43:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-23T01:04:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-54cec490-cc44-44e3-a958-ad290dd1e9c9-TTL24430159944010000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
