...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-08T16:45:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T164541Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-08T16:45:41.534169` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.5817120622568093` |
| `confidence` | `float64` | Pendiente de documentar | `0.992757` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 12, "freeFlowSpeed": 19, "currentTravelTime": 813, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T164541Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-08T16:45:41.460401` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3616733622` |
| `lon` | `float64` | Pendiente de documentar | `-99.3519227857` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-08T16:39:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-08T17:04:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ad320136-f8e8-4f16-a113-574c85e74a9b-TTL24441700996014000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
