...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-24T21:48:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T214842Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:05:58` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782337707` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T214842Z` |
| `entity_id` | `str` | Pendiente de documentar | `f940675e-e082-462d-9647-1050d331c53a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.489717483520508` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13074493408205` |
| `bearing` | `float64` | Pendiente de documentar | `288.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782337707` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-24 15:48:27-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
