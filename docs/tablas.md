...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-28T22:23:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260828T222351Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:52:50` |
| `start_date` | `float64` | Pendiente de documentar | `20260828.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `650.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787955823` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260828T222351Z` |
| `entity_id` | `str` | Pendiente de documentar | `2d465451-b7db-4d04-b7f9-7fe72db0748f` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47198867797852` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07068634033205` |
| `bearing` | `float64` | Pendiente de documentar | `650.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `47.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787955823` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-28 16:23:43-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
