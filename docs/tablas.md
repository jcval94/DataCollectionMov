...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-04T20:14:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260804T201429Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785869940` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-04 18:59:00` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-04T20:45:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260804T204515Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:14:47` |
...
| `bearing` | `float64` | Pendiente de documentar | `158.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785876311` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260804T204515Z` |
| `entity_id` | `str` | Pendiente de documentar | `1d3f2b47-3520-489a-a53c-1484b8881d12` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.470853805541992` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07101440429688` |
| `bearing` | `float64` | Pendiente de documentar | `158.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `31.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785876311` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-04 14:45:11-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-04T20:06:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260804T200621Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-04T20:06:22.310869` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.99094` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260804T200621Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-04T20:06:22.230318` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3584922357` |
| `lon` | `float64` | Pendiente de documentar | `-99.3533711786` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-04T19:49:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-04T20:24:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3527851159, 19.3593746888], [-99.3529205675, 19.3592767881], [-99.3529822583` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ec25b321-e5cd-4e06-8756-a264821e8718-TTL24441700972015000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
