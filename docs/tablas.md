...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-17T05:08:49Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T050848Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1789615111` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-17 03:18:31` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-17T17:03:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T170307Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:02:40` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789664575` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T170307Z` |
| `entity_id` | `str` | Pendiente de documentar | `eea1d085-787f-4592-bd58-d5f20243fd26` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46344947814941` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05913543701172` |
| `bearing` | `float64` | Pendiente de documentar | `329.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `58.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789664575` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-17 11:02:55-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-17T05:00:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T050040Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-17T05:00:40.568433` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T050040Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-17T05:00:40.518433` |
...
| `end_time` | `float64` | Pendiente de documentar | `` |
