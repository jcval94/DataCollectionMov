...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T15:48:29Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T154822Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:07:31` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787154491` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T154822Z` |
| `entity_id` | `str` | Pendiente de documentar | `70ab05b8-e5de-4b2e-a750-e0cf56db7e45` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49013328552246` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1311492919922` |
| `bearing` | `float64` | Pendiente de documentar | `305.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787154491` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 09:48:11-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
