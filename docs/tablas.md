...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T20:33:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T203344Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:20:47` |
...
| `bearing` | `float64` | Pendiente de documentar | `199.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783110815` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T203344Z` |
| `entity_id` | `str` | Pendiente de documentar | `95a1c578-49b6-469e-9d16-735d7fae3a9b` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478235244750977` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07807159423828` |
| `bearing` | `float64` | Pendiente de documentar | `199.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783110815` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-03 14:33:35-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
