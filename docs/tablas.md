...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-10T18:10:16Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T181010Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `27` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `5` |
| `num_docks_available` | `int64` | Pendiente de documentar | `7` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783706845` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-10 18:07:25` |
