...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-26T15:14:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T151422Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782486645` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-26 15:10:45` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-26T17:11:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T171121Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:58:31` |
...
| `bearing` | `float64` | Pendiente de documentar | `107.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782493869` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T171121Z` |
| `entity_id` | `str` | Pendiente de documentar | `d1c5eb4a-acd3-4d19-96f6-fe9fe86ac769` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.497285842895508` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1639175415039` |
| `bearing` | `float64` | Pendiente de documentar | `107.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `45.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782493869` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-26 11:11:09-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-26T18:08:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T180826Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-26T18:08:26.572689` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.993443` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T180826Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-26T18:08:26.485958` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-26T17:25:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-26T18:26:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-19ee81bd-39c4-4110-b867-271d942821dd-TTL24441700920019000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
