...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-25T04:37:37Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T043733Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-25T04:37:33.508895` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.1003382187147688` |
| `confidence` | `float64` | Pendiente de documentar | `0.766165` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 10, "freeFlowSpeed": 11, "currentTravelTime": 976, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T043733Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-25T04:37:33.434933` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-16T16:41:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-25T04:47:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-19ee81bd-39c4-4110-b867-271d942821dd-TTR24415734680060000", "iconCategory": 9, "magnitudeOfDelay": 0, "start` |
