...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T15:37:49Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T153748Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782228850` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-23 15:34:10` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T18:16:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T181606Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:08:53` |
| `start_date` | `float64` | Pendiente de documentar | `20260623.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `307.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782238555` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T181606Z` |
| `entity_id` | `str` | Pendiente de documentar | `5e5a0e99-3373-4cb8-aca2-7f691fdcbbb2` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.480831146240234` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07626342773438` |
| `bearing` | `float64` | Pendiente de documentar | `307.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782238555` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-23 12:15:55-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T16:10:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T161040Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-23T16:10:40.441673` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-10.585585585585587` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T161040Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-23T16:10:41.745958` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T161040Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-23T16:10:40.347006` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T161040Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-23T16:10:44.390097` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `516.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `493.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `8.6` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.216666666666667` |
| `delay_seconds` | `float64` | Pendiente de documentar | `23.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `0.3833333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `4.665314401622722` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `0.3833333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `4.665314401622722` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0299156226029148` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0965427266797129` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.2360817253047723` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `9.44683295701657` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T15:29:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T152907Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-23T15:29:07.745016` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.974614` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T152907Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-23T15:29:07.661624` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4202890106` |
| `lon` | `float64` | Pendiente de documentar | `-99.3573006148` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-23T15:26:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-23T15:47:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-19ee81bd-39c4-4110-b867-271d942821dd-TTL24430159896178000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
