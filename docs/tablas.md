...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T15:30:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T153050Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786116561` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-07 15:29:21` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T17:10:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T171017Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:34:06` |
...
| `bearing` | `float64` | Pendiente de documentar | `287.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `25.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786122601` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T171017Z` |
| `entity_id` | `str` | Pendiente de documentar | `674a00d4-6891-43d3-ab3d-26f4a19885d1` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48613548278809` |
| `longitude` | `float64` | Pendiente de documentar | `-99.12155151367188` |
| `bearing` | `float64` | Pendiente de documentar | `287.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `25.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `90.0` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786122601` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-07 11:10:01-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T15:15:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T151513Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-07T15:15:14.178871` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.636531365313653` |
| `confidence` | `float64` | Pendiente de documentar | `0.993774` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 11, "freeFlowSpeed": 18, "currentTravelTime": 887, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T151513Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-07T15:15:14.115815` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4168476842` |
| `lon` | `float64` | Pendiente de documentar | `-99.3684720153` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-07T15:11:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-07T15:33:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ec25b321-e5cd-4e06-8756-a264821e8718-TTL24441702012018000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
