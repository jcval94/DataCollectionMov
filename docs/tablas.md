...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T16:07:16Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T160713Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:40:25` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786723631` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T160713Z` |
| `entity_id` | `str` | Pendiente de documentar | `0ed11493-7b1e-4659-9193-2844213b2e81` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.488637924194336` |
| `longitude` | `float64` | Pendiente de documentar | `-99.12791442871094` |
| `bearing` | `float64` | Pendiente de documentar | `109.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786723631` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-14 10:07:11-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
