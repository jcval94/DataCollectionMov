...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-01T19:57:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T195722Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:49:31` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788292623` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T195722Z` |
| `entity_id` | `str` | Pendiente de documentar | `a4a4d84e-e027-4489-8c04-168c25b12c65` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.492584228515625` |
| `longitude` | `float64` | Pendiente de documentar | `-99.14242553710938` |
| `bearing` | `float64` | Pendiente de documentar | `285.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `56.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788292623` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-01 13:57:03-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
