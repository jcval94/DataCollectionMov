...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T22:19:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T221942Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:10:00` |
...
| `bearing` | `float64` | Pendiente de documentar | `197.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785190772` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T221942Z` |
| `entity_id` | `str` | Pendiente de documentar | `4021d24f-8857-488b-bb91-052f42904e6d` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478559494018555` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07804107666016` |
| `bearing` | `float64` | Pendiente de documentar | `197.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785190772` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-27 16:19:32-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
