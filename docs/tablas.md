...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T21:09:43Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T210925Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:38:52` |
...
| `bearing` | `float64` | Pendiente de documentar | `131.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786482569` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T210925Z` |
| `entity_id` | `str` | Pendiente de documentar | `1c12051c-2bf8-4d0d-afa1-176c15402dbb` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.465242385864254` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05987548828124` |
| `bearing` | `float64` | Pendiente de documentar | `131.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786482569` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-11 15:09:29-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
