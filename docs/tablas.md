...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T02:02:06Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T020205Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787104903` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-19 02:01:43` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T03:09:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T030948Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:32:55` |
...
| `bearing` | `float64` | Pendiente de documentar | `137.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787108979` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T030948Z` |
| `entity_id` | `str` | Pendiente de documentar | `b9969b94-0b50-44c6-b2c2-3941c613c393` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.469989776611328` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06533813476562` |
| `bearing` | `float64` | Pendiente de documentar | `137.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `35.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787108979` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-18 21:09:39-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T03:14:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T031358Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-19T03:13:58.772175` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T031358Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-19T03:13:58.707999` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-19T02:45:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-19T03:32:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24418619364011000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
