...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-15T05:10:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T051034Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `8` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `0` |
| `num_docks_available` | `int64` | Pendiente de documentar | `31` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1789439169` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-15 02:26:09` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-15T17:03:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T170312Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:59:22` |
| `start_date` | `float64` | Pendiente de documentar | `20260915.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `310.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `13.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789491772` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T170312Z` |
| `entity_id` | `str` | Pendiente de documentar | `d111d5a3-b032-4892-9de4-9f1c010a29cc` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47306060791016` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06879425048828` |
| `bearing` | `float64` | Pendiente de documentar | `310.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `13.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `46.8` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789491772` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-15 11:02:52-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-14T18:49:40Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260914T184936Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-14T18:49:36.386924` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `409.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `421.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.816666666666666` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `7.016666666666667` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-12.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.2` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-2.8503562945368155` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260914T184936Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-14T18:49:37.619219` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260914T184936Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-14T18:49:36.304886` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260914T184936Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-14T18:49:40.013331` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `591.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `482.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `9.85` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.033333333333333` |
| `delay_seconds` | `float64` | Pendiente de documentar | `109.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `1.8166666666666669` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `22.61410788381744` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `1.8166666666666669` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `22.61410788381744` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0466768138001014` |
| `delay_score` | `float64` | Pendiente de documentar | `0.1298611111111111` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.502336256338031` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `16.692320636654078` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-15T05:02:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T050228Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-15T05:02:28.667277` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.356031128404669` |
| `confidence` | `float64` | Pendiente de documentar | `0.982742` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 14, "freeFlowSpeed": 19, "currentTravelTime": 697, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T050228Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-15T05:02:28.610718` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3598842778` |
| `lon` | `float64` | Pendiente de documentar | `-99.3519965465` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-12T23:48:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-15T05:36:00Z` |
...
| `event_codes` | `str` | Pendiente de documentar | `401` |
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.351477539, 19.3601471378], [-99.3519965465, 19.3598842778]]}` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3e4a0d0f-4280-4c32-855f-d24afaed7dea-TTR24441700992014000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
