...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-18T15:58:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260618T155806Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-18T15:58:07.162769` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.996159` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260618T155806Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-18T15:58:07.088179` |
...
| `lat` | `float64` | Pendiente de documentar | `19.5466049298` |
| `lon` | `float64` | Pendiente de documentar | `-99.3463035578` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-05-27T16:35:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-18T16:16:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.345818078, 19.5470542159], [-99.3461707885, 19.5467618799], [-99.3462445492,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2854a05b-83f3-499c-b803-c30b2f24b6df-TTR24415734756020000", "iconCategory": 9, "magnitudeOfDelay": 0, "start` |
