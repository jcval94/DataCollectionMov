...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T03:48:01Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T034758Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:49:46` |
...
| `bearing` | `float64` | Pendiente de documentar | `354.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `42.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785469666` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T034758Z` |
| `entity_id` | `str` | Pendiente de documentar | `1343c01f-4f72-4a2a-99df-ec3450ede6db` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.509552001953125` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19129180908205` |
| `bearing` | `float64` | Pendiente de documentar | `354.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `42.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `151.20000000000002` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785469666` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-30 21:47:46-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
