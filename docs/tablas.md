...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T15:03:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T150259Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:27:13` |
...
| `bearing` | `float64` | Pendiente de documentar | `143.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787583773` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T150259Z` |
| `entity_id` | `str` | Pendiente de documentar | `e121e3e8-0d18-4c5e-ac97-2c4971bcd480` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46963882446289` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06520080566406` |
| `bearing` | `float64` | Pendiente de documentar | `143.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `38.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787583773` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-24 09:02:53-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
