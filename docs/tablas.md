...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T21:44:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T214359Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785274275` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-28 21:31:15` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T22:18:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T221804Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:14:24` |
...
| `bearing` | `float64` | Pendiente de documentar | `318.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785277090` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T221804Z` |
| `entity_id` | `str` | Pendiente de documentar | `6285cf8e-a569-4b2c-a7ed-ec2906da5659` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.471715927124023` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06720733642578` |
| `bearing` | `float64` | Pendiente de documentar | `318.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785277090` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-28 16:18:10-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T15:43:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T154306Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-28T15:43:06.765376` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-11.67048054919908` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T154306Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-28T15:43:08.085305` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T154306Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-28T15:43:06.677516` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T154306Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-28T15:43:10.767727` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.85` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-11.67048054919908` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0279286268425135` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0956862745098039` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.1372678390364225` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `7.3511645964847` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T21:35:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T213547Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-28T21:35:47.685031` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.999867` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T213547Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-28T21:35:47.615122` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-28T21:05:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-28T21:54:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441700956023000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
