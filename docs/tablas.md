...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-03T20:16:27Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T201626Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785787938` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-03 20:12:18` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-03T21:31:39Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T213135Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:22:29` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785792687` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T213135Z` |
| `entity_id` | `str` | Pendiente de documentar | `1066fc94-b494-47e9-9323-9e0e01a8bb44` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.507234573364254` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19944763183594` |
| `bearing` | `float64` | Pendiente de documentar | `169.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `2.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785792687` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-03 15:31:27-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-03T21:36:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T213621Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-03T21:36:21.701498` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.997125` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T213621Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-03T21:36:21.644883` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-08-03T21:54:30Z` |
