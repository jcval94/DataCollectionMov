...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T22:13:20Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T221301Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:11:55` |
...
| `bearing` | `float64` | Pendiente de documentar | `308.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784671975` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T221301Z` |
| `entity_id` | `str` | Pendiente de documentar | `de9e8d65-e2b7-4689-b72d-63fe84857ecf` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46788787841797` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0627212524414` |
| `bearing` | `float64` | Pendiente de documentar | `308.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `45.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784671975` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-21 16:12:55-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
