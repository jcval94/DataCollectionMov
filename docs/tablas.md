...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T20:04:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T200408Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784664002` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-21 20:00:02` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T20:37:43Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T203726Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:57:20` |
...
| `bearing` | `float64` | Pendiente de documentar | `177.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784666250` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T203726Z` |
| `entity_id` | `str` | Pendiente de documentar | `23d23222-6b7b-477e-bed0-99638d2e3e7c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49050712585449` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13563537597656` |
| `bearing` | `float64` | Pendiente de documentar | `177.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `28.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784666250` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-21 14:37:30-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T15:22:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T152247Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-21T15:22:47.900141` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T152247Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-21T15:22:49.295157` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T152247Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-21T15:22:47.809006` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T152247Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-21T15:22:52.620793` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `582.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `492.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `9.7` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.2` |
| `delay_seconds` | `float64` | Pendiente de documentar | `90.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `1.5` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `18.29268292682926` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `1.5` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `18.29268292682926` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0459483929379809` |
| `delay_score` | `float64` | Pendiente de documentar | `0.1034176653351087` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.3438506883064963` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `12.564309735067877` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T21:37:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T213750Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-21T21:37:50.461644` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.990592` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T213750Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-21T21:37:50.383137` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-21T21:30:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-21T21:56:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3492901976, 19.3619133656], [-99.3495208675, 19.3617832815], [-99.3498668725` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24441701004011000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
