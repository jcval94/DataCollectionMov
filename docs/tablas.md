...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T21:57:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T215718Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:46:08` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786139835` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T215718Z` |
| `entity_id` | `str` | Pendiente de documentar | `98ec8e93-2e1d-4c38-8df7-e19333e47c42` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.482553482055664` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11444091796876` |
| `bearing` | `float64` | Pendiente de documentar | `106.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `11.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786139835` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-07 15:57:15-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
