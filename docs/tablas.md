...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T15:25:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T152459Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787671196` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-25 15:19:56` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T16:02:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T160230Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:59:44` |
...
| `bearing` | `float64` | Pendiente de documentar | `826.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787673733` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T160230Z` |
| `entity_id` | `str` | Pendiente de documentar | `111f7b0a-0933-4c43-98b8-67041904e68a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.51157569885254` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19766235351562` |
| `bearing` | `float64` | Pendiente de documentar | `826.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `27.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787673733` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-25 10:02:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T15:11:55Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T151151Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-25T15:11:52.059561` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.971787` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T151151Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-25T15:11:51.946474` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-25T15:06:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-25T15:30:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-8bdb8a22-bc89-4292-91ed-a170049c774c-TTL24441700956011000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
