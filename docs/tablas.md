...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T04:49:40Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T044936Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:33:30` |
...
| `bearing` | `float64` | Pendiente de documentar | `333.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787028567` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T044936Z` |
| `entity_id` | `str` | Pendiente de documentar | `7dfd9dcc-448b-47d0-838b-1482bbd7216e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.479448318481445` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06392669677734` |
| `bearing` | `float64` | Pendiente de documentar | `333.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787028567` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 22:49:27-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
