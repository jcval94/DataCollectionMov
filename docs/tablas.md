...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T04:52:57Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T045253Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:30:16` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782881557` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T045253Z` |
| `entity_id` | `str` | Pendiente de documentar | `e015450d-35ee-4513-90e4-70e25d89c0b8` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49347686767578` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1468734741211` |
| `bearing` | `float64` | Pendiente de documentar | `108.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `11.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782881557` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-30 22:52:37-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
