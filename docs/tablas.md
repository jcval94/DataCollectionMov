...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-08T21:22:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T212247Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788902136` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-08 21:15:36` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-08T19:56:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T195611Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:45:03` |
| `start_date` | `float64` | Pendiente de documentar | `20260908.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `326.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788897366` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T195611Z` |
| `entity_id` | `str` | Pendiente de documentar | `4809f123-c9e0-475b-8d72-2c7d0b1b28de` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48103141784668` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0763931274414` |
| `bearing` | `float64` | Pendiente de documentar | `326.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788897366` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-08 13:56:06-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-08T21:17:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T211705Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-08T21:17:05.960904` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.985883` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T211705Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-08T21:17:05.859212` |
...
| `lat` | `float64` | Pendiente de documentar | `19.360486467` |
| `lon` | `float64` | Pendiente de documentar | `-99.3497126455` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-08T20:59:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-08T21:35:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3507600481, 19.3621158856], [-99.3502718861, 19.3613621876], [-99.3498722369` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ad320136-f8e8-4f16-a113-574c85e74a9b-TTL24441700956014000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
