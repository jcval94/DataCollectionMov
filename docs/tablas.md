...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-17T16:26:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260617T162609Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `22` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `7` |
| `num_docks_available` | `int64` | Pendiente de documentar | `10` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1781713490` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-17 16:24:50` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-17T16:07:28Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260617T160725Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:59:04` |
| `start_date` | `float64` | Pendiente de documentar | `20260617.0` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-17T16:09:43Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260617T160940Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-17T16:09:40.611660` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.665983606557377` |
| `confidence` | `float64` | Pendiente de documentar | `0.991197` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 12, "freeFlowSpeed": 20, "currentTravelTime": 813, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260617T160940Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-17T16:09:40.544429` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3607358825` |
| `lon` | `float64` | Pendiente de documentar | `-99.3498722369` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-17T16:01:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-17T16:28:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3489991779, 19.3609692447], [-99.3492177779, 19.3608847884], [-99.3496066982` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2854a05b-83f3-499c-b803-c30b2f24b6df-TTL24441700996014000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
