...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-26T13:37:04Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T133703Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787750971` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-26 13:29:31` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-26T15:54:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T155419Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:50:49` |
| `start_date` | `float64` | Pendiente de documentar | `20260826.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `260.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787759654` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T155419Z` |
| `entity_id` | `str` | Pendiente de documentar | `d3961b86-1625-49c7-a3b3-a1253cf75466` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.491369247436523` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13574981689452` |
| `bearing` | `float64` | Pendiente de documentar | `260.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `16.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787759654` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-26 09:54:14-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-26T13:31:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T133114Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-26T13:31:14.384647` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T133114Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-26T13:31:14.327209` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3311149185` |
| `lon` | `float64` | Pendiente de documentar | `-99.3152931983` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-26T13:16:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-26T13:45:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3172243888, 19.326484091], [-99.3171278293, 19.3266423614], [-99.317035293, ` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-8bdb8a22-bc89-4292-91ed-a170049c774c-TTL24456127836024001", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
