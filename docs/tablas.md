...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T03:55:06Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T035505Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783479587` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-08 02:59:47` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T03:50:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T035021Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-08T03:50:21.826761` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.25` |
| `confidence` | `float64` | Pendiente de documentar | `0.995124` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 16, "freeFlowSpeed": 20, "currentTravelTime": 610, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T035021Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-08T03:50:21.784506` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-07T21:04:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-08T05:59:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-41b82937-4433-431b-afaa-fdf8681ff54e-TTR24415734752060000", "iconCategory": 9, "magnitudeOfDelay": 0, "start` |
