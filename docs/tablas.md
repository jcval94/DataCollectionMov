...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T20:32:04Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T203146Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:58:39` |
...
| `bearing` | `float64` | Pendiente de documentar | `248.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784838708` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T203146Z` |
| `entity_id` | `str` | Pendiente de documentar | `0209369c-71e4-4694-b88a-d08b8da1ec30` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48859977722168` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11651611328124` |
| `bearing` | `float64` | Pendiente de documentar | `248.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784838708` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-23 14:31:48-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
