...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T23:39:55Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T233952Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:23:43` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787182772` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T233952Z` |
| `entity_id` | `str` | Pendiente de documentar | `12237440-1d13-4471-93aa-2e579123212a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.481914520263672` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10501098632812` |
| `bearing` | `float64` | Pendiente de documentar | `108.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787182772` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 17:39:32-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
