...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-22T01:06:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260922T010630Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1790036706` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-22 00:25:06` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-22T04:51:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260922T045111Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:30:39` |
| `start_date` | `float64` | Pendiente de documentar | `20260922.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `218.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790052659` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260922T045111Z` |
| `entity_id` | `str` | Pendiente de documentar | `44684f41-80a2-4c2b-8952-2efbdd506062` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.474855422973636` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08860778808594` |
| `bearing` | `float64` | Pendiente de documentar | `218.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790052659` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-21 22:50:59-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-22T00:57:40Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260922T005736Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-22T00:57:36.973308` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.5452961672473868` |
| `confidence` | `float64` | Pendiente de documentar | `0.988872` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 11, "freeFlowSpeed": 17, "currentTravelTime": 887, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260922T005736Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-22T00:57:36.872457` |
...
| `lat` | `float64` | Pendiente de documentar | `19.496605916` |
| `lon` | `float64` | Pendiente de documentar | `-99.3630056734` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-22T00:40:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-22T01:18:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3e4a0d0f-4280-4c32-855f-d24afaed7dea-TTL24418619396019000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
