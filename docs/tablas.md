...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T20:27:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T202724Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `14` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782937597` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-01 20:26:37` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T21:53:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T215333Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:41:01` |
...
| `bearing` | `float64` | Pendiente de documentar | `182.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782942799` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T215333Z` |
| `entity_id` | `str` | Pendiente de documentar | `4e70fc50-c447-4ace-94b9-776f30f4ea8b` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.471080780029297` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07965850830078` |
| `bearing` | `float64` | Pendiente de documentar | `182.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `13.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782942799` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-01 15:53:19-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
