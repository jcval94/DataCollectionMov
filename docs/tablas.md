...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T20:58:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T205807Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787173072` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-19 20:57:52` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T22:44:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T224418Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:40:02` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787179443` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T224418Z` |
| `entity_id` | `str` | Pendiente de documentar | `f17e52fe-be56-4054-a1ed-ae94edc667e4` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.473651885986328` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06907653808594` |
| `bearing` | `float64` | Pendiente de documentar | `317.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `29.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787179443` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 16:44:03-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T20:56:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T205626Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-19T20:56:27.261597` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.993899` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T205626Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-19T20:56:27.160315` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-19T20:44:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-19T21:15:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441700956011000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
