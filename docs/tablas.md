...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T14:57:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T145703Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:23:01` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787237810` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T145703Z` |
| `entity_id` | `str` | Pendiente de documentar | `8c47049c-f79a-4736-a931-79f6ffe2ad1e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46969413757324` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0648956298828` |
| `bearing` | `float64` | Pendiente de documentar | `125.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787237810` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-20 08:56:50-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
