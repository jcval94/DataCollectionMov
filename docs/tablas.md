...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T15:57:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T155750Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:55:21` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787587056` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T155750Z` |
| `entity_id` | `str` | Pendiente de documentar | `58879416-19bb-4212-b0d9-ebe650a9014d` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.486906051635746` |
| `longitude` | `float64` | Pendiente de documentar | `-99.12316131591795` |
| `bearing` | `float64` | Pendiente de documentar | `110.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `28.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787587056` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-24 09:57:36-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
