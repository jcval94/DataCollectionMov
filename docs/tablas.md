...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T03:45:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T034504Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784087017` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-15 03:43:37` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T03:31:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T033111Z` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784086261` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T033111Z` |
| `entity_id` | `str` | Pendiente de documentar | `356b0d2a-f52e-4300-96ae-c61f944a544b` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.488433837890625` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1176300048828` |
| `bearing` | `float64` | Pendiente de documentar | `195.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `28.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784086261` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-14 21:31:01-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T03:40:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T034047Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-15T03:40:47.245083` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.0825565912117177` |
| `confidence` | `float64` | Pendiente de documentar | `0.849347` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 12, "freeFlowSpeed": 13, "currentTravelTime": 813, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T034047Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-15T03:40:47.206135` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-08T22:44:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-15T03:59:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTR24415734752060000", "iconCategory": 9, "magnitudeOfDelay": 0, "start` |
