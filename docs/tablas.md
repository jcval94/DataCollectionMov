...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-16T23:31:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260716T233117Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784244048` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-16 23:20:48` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T00:14:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T001355Z` |
...
| `start_time` | `str` | Pendiente de documentar | `00:06:49` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784247231` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T001355Z` |
| `entity_id` | `str` | Pendiente de documentar | `6a47030e-3cc7-49ac-ba88-55fa20b14625` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.480382919311523` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07579040527344` |
| `bearing` | `float64` | Pendiente de documentar | `310.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `30.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784247231` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-16 18:13:51-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-16T23:23:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260716T232311Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-16T23:23:12.080400` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.5` |
| `confidence` | `float64` | Pendiente de documentar | `0.970478` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 8, "freeFlowSpeed": 20, "currentTravelTime": 1220, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260716T232311Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-16T23:23:11.987319` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3589106483` |
| `lon` | `float64` | Pendiente de documentar | `-99.3554203863` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-16T22:09:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-16T23:43:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.358162945, 19.3562646906], [-99.3581495339, 19.3562820885], [-99.3580261523,` |
