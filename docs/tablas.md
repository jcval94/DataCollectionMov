...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-24T00:12:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T001250Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:11:02` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782259952` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T001250Z` |
| `entity_id` | `str` | Pendiente de documentar | `4f17d5e2-30fb-4b49-89b9-bd4c8d444bd4` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46463394165039` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05918884277344` |
| `bearing` | `float64` | Pendiente de documentar | `136.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782259952` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-23 18:12:32-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
