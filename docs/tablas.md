...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-05T21:52:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T215201Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785966658` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-05 21:50:58` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-05T20:40:59Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T204056Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:14:55` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785962447` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T204056Z` |
| `entity_id` | `str` | Pendiente de documentar | `c801d866-2813-41aa-bf7a-45e1ee6f2f2e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.476865768432617` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09241485595705` |
| `bearing` | `float64` | Pendiente de documentar | `113.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `40.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785962447` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-05 14:40:47-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-05T21:43:55Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T214351Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-05T21:43:51.854826` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `3.402439024390244` |
| `confidence` | `float64` | Pendiente de documentar | `0.929731` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 5, "freeFlowSpeed": 17, "currentTravelTime": 1953, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T214351Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-05T21:43:51.790419` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-05T21:40:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-05T22:02:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ec25b321-e5cd-4e06-8756-a264821e8718-TTL24441700916027000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
