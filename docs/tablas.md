...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T04:52:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T045234Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:39:31` |
...
| `bearing` | `float64` | Pendiente de documentar | `252.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787287938` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T045234Z` |
| `entity_id` | `str` | Pendiente de documentar | `bcc5058f-930b-4040-b121-0940acf0405e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47821044921875` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06491088867188` |
| `bearing` | `float64` | Pendiente de documentar | `252.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787287938` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-20 22:52:18-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
