...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T21:26:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T212646Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784323268` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-17 21:21:08` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T23:10:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T231033Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:34:55` |
...
| `bearing` | `float64` | Pendiente de documentar | `293.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784329826` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T231033Z` |
| `entity_id` | `str` | Pendiente de documentar | `b0f55f3b-9c96-4f3b-a688-0dcfe43b2198` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.485567092895508` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11994171142578` |
| `bearing` | `float64` | Pendiente de documentar | `293.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `41.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784329826` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-17 17:10:26-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T21:12:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T211242Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-17T21:12:43.165229` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.981854` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T211242Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-17T21:12:43.055804` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-17T20:38:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-17T21:36:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24441700916003000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
