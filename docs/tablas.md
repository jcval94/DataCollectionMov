...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T20:38:43Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T203840Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:23:20` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783543104` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T203840Z` |
| `entity_id` | `str` | Pendiente de documentar | `f9529ef7-1b1e-40fe-8089-632a4c00b785` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46525764465332` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0805435180664` |
| `bearing` | `float64` | Pendiente de documentar | `282.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `1.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783543104` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-08 14:38:24-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T21:36:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T213648Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-08T21:36:48.730576` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.993299` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T213648Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-08T21:36:48.663210` |
...
| `lat` | `float64` | Pendiente de documentar | `19.297033409` |
| `lon` | `float64` | Pendiente de documentar | `-99.3620454425` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-07-08T22:07:00Z` |
