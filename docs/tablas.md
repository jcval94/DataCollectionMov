...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T02:02:42Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T020241Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787622255` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-25 01:44:15` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T01:50:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T015032Z` |
...
| `start_time` | `str` | Pendiente de documentar | `01:36:52` |
| `start_date` | `float64` | Pendiente de documentar | `20260825.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787622611` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T01:50:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T015032Z` |
| `entity_id` | `str` | Pendiente de documentar | `e9cf2de3-4ea0-4471-9e82-aaa9e937bae3` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.473615646362305` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07910919189452` |
| `bearing` | `float64` | Pendiente de documentar | `183.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `32.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787622611` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-24 19:50:11-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T01:56:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T015611Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-25T01:56:11.618185` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.994537` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T015611Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-25T01:56:11.533339` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4972000133` |
| `lon` | `float64` | Pendiente de documentar | `-99.362398153` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-25T01:38:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-25T02:15:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3573783988, 19.4961297832], [-99.3574642295, 19.4961230671], [-99.3582367057` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-8bdb8a22-bc89-4292-91ed-a170049c774c-TTL24418619396019000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
