...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-21T18:18:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T181846Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `12` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `1` |
| `num_docks_available` | `int64` | Pendiente de documentar | `26` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1790014720` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-21 18:18:40` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-21T22:01:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T220123Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:55:01` |
| `start_date` | `float64` | Pendiente de documentar | `20260921.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `320.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790028062` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T220123Z` |
| `entity_id` | `str` | Pendiente de documentar | `c8b7531e-fb87-4864-b34d-0e3fc8275cfc` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.479711532592773` |
| `longitude` | `float64` | Pendiente de documentar | `-99.074951171875` |
| `bearing` | `float64` | Pendiente de documentar | `320.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `47.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790028062` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-21 16:01:02-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-21T18:52:24Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T185220Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-21T18:52:20.925885` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `474.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `412.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `7.9` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `15.048543689320384` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T185220Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-21T18:52:22.207796` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T185220Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-21T18:52:20.839050` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T185220Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-21T18:52:24.726341` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `341.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `380.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `5.683333333333334` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `6.333333333333333` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-39.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.65` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-10.26315789473684` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.65` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-10.26315789473684` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0005594405594405` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0019157088122605` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `0.0922246336039438` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-21T18:17:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T181731Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-21T18:17:32.174622` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.99` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T181731Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-21T18:17:32.100628` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4117702646` |
| `lon` | `float64` | Pendiente de documentar | `-99.3700612242` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-21T18:07:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-21T18:38:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3e4a0d0f-4280-4c32-855f-d24afaed7dea-TTL24430159816106000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
