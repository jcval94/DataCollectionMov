...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T14:55:59Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T145558Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785336933` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-29 14:55:33` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T16:39:40Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T163935Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:37:23` |
...
| `bearing` | `float64` | Pendiente de documentar | `510.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785343164` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T163935Z` |
| `entity_id` | `str` | Pendiente de documentar | `099bcdf5-8218-443b-b50d-ed55655bb681` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.51150894165039` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1981964111328` |
| `bearing` | `float64` | Pendiente de documentar | `510.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `21.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785343164` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-29 10:39:24-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T17:45:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T174514Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-29T17:45:14.574239` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T174514Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-29T17:45:14.512204` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-29T17:31:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-29T18:05:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441700912027000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
