...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-05T18:08:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T180820Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785952719` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-05 17:58:39` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-05T18:55:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T185518Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:46:48` |
| `start_date` | `float64` | Pendiente de documentar | `20260805.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `185.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785956106` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T185518Z` |
| `entity_id` | `str` | Pendiente de documentar | `7dad06fc-df7d-472b-ae3d-9a9101255e8d` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48358726501465` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11390686035156` |
| `bearing` | `float64` | Pendiente de documentar | `185.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `7.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785956106` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-05 12:55:06-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-05T17:59:59Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T175955Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-05T17:59:56.063334` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.936409` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T175955Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-05T17:59:55.989503` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-05T17:42:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-05T18:18:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ec25b321-e5cd-4e06-8756-a264821e8718-TTL24444587476154000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
