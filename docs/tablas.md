...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T17:33:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T173351Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786467622` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-11 17:00:22` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T19:27:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T192714Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:50:54` |
...
| `bearing` | `float64` | Pendiente de documentar | `133.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786476430` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T192714Z` |
| `entity_id` | `str` | Pendiente de documentar | `285f20be-0bd2-4679-8deb-147dadc9e860` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.467077255249023` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06189727783205` |
| `bearing` | `float64` | Pendiente de documentar | `133.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `16.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786476430` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-11 13:27:10-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T14:36:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T143643Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-11T14:36:43.702980` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `387.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `437.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.45` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-11.441647597254` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T143643Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-11T14:36:45.079440` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T143643Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-11T14:36:43.587203` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T143643Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-11T14:36:47.968415` |
...
| `distance_meters` | `int64` | Pendiente de documentar | `3871` |
| `duration_seconds` | `float64` | Pendiente de documentar | `645.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `663.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `10.75` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `11.05` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-18.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.3` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-2.714932126696834` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.3` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-2.714932126696834` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0692739754524651` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0258064516129032` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.1859313162412129` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `7.739181026636804` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T19:31:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T193148Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-11T19:31:48.638702` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.990947` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T193148Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-11T19:31:48.570552` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2979091535` |
| `lon` | `float64` | Pendiente de documentar | `-99.3630593175` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-11T19:23:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-11T19:50:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24447470888017001", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
