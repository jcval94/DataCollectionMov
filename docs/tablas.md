...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-19T00:35:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260919T003531Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1789776097` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-19 00:01:37` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-19T04:34:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260919T043429Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:59:04` |
| `start_date` | `float64` | Pendiente de documentar | `20260919.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `193.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789792454` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260919T043429Z` |
| `entity_id` | `str` | Pendiente de documentar | `60644236-b09f-4646-990b-f7c41d08aada` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48587989807129` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1183853149414` |
| `bearing` | `float64` | Pendiente de documentar | `193.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789792454` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-18 22:34:14-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
