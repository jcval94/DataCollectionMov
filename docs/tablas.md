...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T19:09:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T190859Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787079759` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-18 19:02:39` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T20:42:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T204210Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:31:27` |
| `start_date` | `float64` | Pendiente de documentar | `20260818.0` |
...
| `speed_mps` | `float64` | Pendiente de documentar | `10.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787085718` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T204210Z` |
| `entity_id` | `str` | Pendiente de documentar | `6b8a52b5-0863-4c77-9a73-20d7b9b4c726` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.483030319213867` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11370849609376` |
| `bearing` | `float64` | Pendiente de documentar | `289.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `10.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `36.0` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787085718` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-18 14:41:58-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T19:05:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T190541Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-18T19:05:41.537018` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.97315` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T190541Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-18T19:05:41.445700` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4072749384` |
| `lon` | `float64` | Pendiente de documentar | `-99.3716061766` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-18T19:02:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-18T19:24:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24427274352162000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
