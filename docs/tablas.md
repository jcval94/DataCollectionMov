...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-03T20:00:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T200016Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:21:43` |
...
| `bearing` | `float64` | Pendiente de documentar | `115.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785787208` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T200016Z` |
| `entity_id` | `str` | Pendiente de documentar | `75a80991-d557-4be7-98ff-7930f96526e6` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.481822967529297` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10485076904295` |
| `bearing` | `float64` | Pendiente de documentar | `115.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785787208` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-03 14:00:08-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
