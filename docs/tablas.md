...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-26T13:19:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T131935Z` |
...
| `start_time` | `str` | Pendiente de documentar | `12:51:21` |
...
| `bearing` | `float64` | Pendiente de documentar | `96.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787750366` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T131935Z` |
| `entity_id` | `str` | Pendiente de documentar | `373676b5-d774-436d-b0e3-85481cce0772` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46649742126465` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07354736328124` |
| `bearing` | `float64` | Pendiente de documentar | `96.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787750366` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-26 07:19:26-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
