...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T15:19:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T151946Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787584352` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-24 15:12:32` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T16:57:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T165737Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:36:32` |
| `start_date` | `float64` | Pendiente de documentar | `20260824.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `290.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `34.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787590642` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T165737Z` |
| `entity_id` | `str` | Pendiente de documentar | `f762cfdd-d7d6-460f-bed6-a391aa274181` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47921371459961` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09806060791016` |
| `bearing` | `float64` | Pendiente de documentar | `290.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `34.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `122.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787590642` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-24 10:57:22-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T14:11:31Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T141127Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-24T14:11:28.001313` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-12.12121212121212` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T141127Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-24T14:11:29.264604` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T141127Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-24T14:11:27.903987` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T141127Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-24T14:11:31.828983` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `273.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `323.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `4.55` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `5.383333333333334` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-50.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.8333333333333334` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-15.479876160990711` |
...
| `delay_score` | `float64` | Pendiente de documentar | `0.0095895665515918` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0345068557344217` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `1.0257719439941508` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T15:07:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T150707Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-24T15:07:07.589181` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.980239` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T150707Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-24T15:07:07.508845` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3576808713` |
| `lon` | `float64` | Pendiente de documentar | `-99.357084697` |
| `icon_category` | `int64` | Pendiente de documentar | `1` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-24T14:22:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-24T15:11:00Z` |
| `last_report_time` | `float64` | Ultimo reporte del incidente segun TomTom. | `2026-06-04T13:30:00Z` |
| `event_descriptions` | `str` | Pendiente de documentar | `Accidente \| Dos carriles bloqueados` |
| `event_codes` | `str` | Pendiente de documentar | `201,511` |
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3570270295, 19.3577666736], [-99.3570618982, 19.3577197789], [-99.357084697,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-8bdb8a22-bc89-4292-91ed-a170049c774c-TTR24441700976007001", "iconCategory": 1, "magnitudeOfDelay": 0, "start` |
