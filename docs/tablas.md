...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T21:01:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T210104Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:58:46` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786136461` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T210104Z` |
| `entity_id` | `str` | Pendiente de documentar | `489a1f14-33e1-4e80-9b52-b4db1a8ba8bc` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46855354309082` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06343841552734` |
| `bearing` | `float64` | Pendiente de documentar | `325.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786136461` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-07 15:01:01-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
