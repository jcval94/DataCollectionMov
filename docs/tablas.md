...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-22T04:47:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260822T044732Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:31:15` |
| `start_date` | `float64` | Pendiente de documentar | `20260822.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `162.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787363628` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260822T044732Z` |
| `entity_id` | `str` | Pendiente de documentar | `cbcdcff3-8ca5-4e27-a1ec-b2e54d367d8c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478065490722656` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06353759765624` |
| `bearing` | `float64` | Pendiente de documentar | `162.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787363628` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 19:53:48-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
