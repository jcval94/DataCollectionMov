...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T21:38:20Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T213819Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `17` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784842010` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-23 21:26:50` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T22:16:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T221632Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:10:14` |
...
| `bearing` | `float64` | Pendiente de documentar | `312.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784844975` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T22:16:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T221632Z` |
| `entity_id` | `str` | Pendiente de documentar | `4c02da56-8078-4304-a706-d40d3a55bde7` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47831344604492` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07382202148438` |
| `bearing` | `float64` | Pendiente de documentar | `312.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `48.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784844975` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-23 16:16:15-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T21:32:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T213242Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-23T21:32:42.675675` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.906709` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T213242Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-23T21:32:42.609742` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3603134416` |
| `lon` | `float64` | Pendiente de documentar | `-99.353774851` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-23T19:52:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-23T21:53:02Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24441700916051000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
