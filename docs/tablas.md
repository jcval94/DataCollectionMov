...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T21:46:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T214601Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785447950` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-30 21:45:50` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T22:28:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T222851Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:19:20` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785450518` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T222851Z` |
| `entity_id` | `str` | Pendiente de documentar | `aceccd37-1b36-42bf-98d4-71c649557ae4` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.480167388916016` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07740020751952` |
| `bearing` | `float64` | Pendiente de documentar | `197.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `41.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785450518` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-30 16:28:38-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T21:38:55Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T213851Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-30T21:38:51.608905` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.8586065573770494` |
| `confidence` | `float64` | Pendiente de documentar | `0.994545` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 7, "freeFlowSpeed": 20, "currentTravelTime": 1395, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T213851Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-30T21:38:51.518455` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-30T21:32:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-30T21:57:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441700956023000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
