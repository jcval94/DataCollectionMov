...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T06:27:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T062654Z` |
...
| `start_time` | `str` | Pendiente de documentar | `05:30:30` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784095304` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T062654Z` |
| `entity_id` | `str` | Pendiente de documentar | `cfa7ca0f-d52e-42c2-885f-e4800558678b` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4783992767334` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06486511230467` |
| `bearing` | `float64` | Pendiente de documentar | `276.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784095304` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-15 00:01:44-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
