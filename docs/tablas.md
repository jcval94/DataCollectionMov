...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-07T18:22:13Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260707T182210Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:18:27` |
...
| `bearing` | `float64` | Pendiente de documentar | `148.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783448518` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260707T182210Z` |
| `entity_id` | `str` | Pendiente de documentar | `6d012f0d-963d-47ae-a532-5bd56cc2ee1d` |
| `trip_id` | `float64` | Pendiente de documentar | `` |
| `route_id` | `float64` | Pendiente de documentar | `26841.0` |
| `direction_id` | `float64` | Pendiente de documentar | `1.0` |
| `start_time` | `str` | Pendiente de documentar | `18:18:27` |
| `start_date` | `float64` | Pendiente de documentar | `20260707.0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.513019561767575` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19664001464844` |
| `bearing` | `float64` | Pendiente de documentar | `148.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783448518` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-07 12:21:58-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-07T18:25:40Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260707T182537Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-07T18:25:37.590224` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260707T182537Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-07T18:25:37.530048` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-07-07T18:50:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-41b82937-4433-431b-afaa-fdf8681ff54e-TTL24447470880009000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
