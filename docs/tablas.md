...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-27T07:37:39Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260627T073738Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `0` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `11` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782529475` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-27 03:04:35` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-29T16:13:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T161322Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:52:24` |
| `start_date` | `float64` | Pendiente de documentar | `20260629.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782749580` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T161322Z` |
| `entity_id` | `str` | Pendiente de documentar | `27ec9755-68dc-41f8-a473-cca8758bf93c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49190139770508` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13908386230467` |
| `bearing` | `float64` | Pendiente de documentar | `112.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `2.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782749580` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-29 10:13:00-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
