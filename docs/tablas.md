...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-09T22:35:24Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260909T223520Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:57:54` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788993303` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260909T223520Z` |
| `entity_id` | `str` | Pendiente de documentar | `ddd0bda5-e463-4f92-bbd1-92f9e486bcef` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.07138061523438` |
| `bearing` | `float64` | Pendiente de documentar | `207.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `22.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788993303` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-09 16:35:03-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
