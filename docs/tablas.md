...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-25T20:34:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T203457Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782418903` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-25 20:21:43` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-25T21:03:39Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T210335Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:39:42` |
| `start_date` | `float64` | Pendiente de documentar | `20260625.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `227.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782421404` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T210335Z` |
| `entity_id` | `str` | Pendiente de documentar | `7cf1bc51-bd26-4f74-9277-6eb7b0227243` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.511474609375` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19832611083984` |
| `bearing` | `float64` | Pendiente de documentar | `227.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `19.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782421404` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-25 15:03:24-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-25T16:03:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T160304Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-25T16:03:04.323498` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `401.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `444.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.683333333333334` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-9.684684684684688` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T160304Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-25T16:03:05.794979` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T160304Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-25T16:03:04.200466` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T160304Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-25T16:03:08.791049` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `579.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `493.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `9.65` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.216666666666667` |
| `delay_seconds` | `float64` | Pendiente de documentar | `86.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `1.4333333333333331` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `17.444219066937116` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `1.4333333333333331` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `17.444219066937116` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0419630156472261` |
| `delay_score` | `float64` | Pendiente de documentar | `0.1244044467972472` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.3738197560066878` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `13.718886462162589` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-25T21:57:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T215748Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-25T21:57:49.423354` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.6672131147540985` |
| `confidence` | `float64` | Pendiente de documentar | `0.894933` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 6, "freeFlowSpeed": 16, "currentTravelTime": 1627, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T215748Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-25T21:57:49.340306` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-25T21:39:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-25T22:16:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-19ee81bd-39c4-4110-b867-271d942821dd-TTL24441700956023000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
