...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-12T21:06:13Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T210610Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:13:12` |
...
| `bearing` | `float64` | Pendiente de documentar | `995.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781298356` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T210610Z` |
| `entity_id` | `str` | Pendiente de documentar | `1a7fd77a-23bd-4da4-a946-b91a88c6edea` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.469785690307617` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08638763427734` |
| `bearing` | `float64` | Pendiente de documentar | `995.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `58.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781298356` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-12 15:05:56-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
