...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T00:17:01Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T001641Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:28:23` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785457010` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T001641Z` |
| `entity_id` | `str` | Pendiente de documentar | `ca393169-a51a-4e07-9513-8e596d793df9` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.477502822875977` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09440612792967` |
| `bearing` | `float64` | Pendiente de documentar | `106.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `31.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785457010` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-30 18:16:50-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
