...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T14:14:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T141431Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784297527` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-17 14:12:07` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T14:05:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T140506Z` |
...
| `start_time` | `str` | Pendiente de documentar | `13:33:47` |
| `start_date` | `float64` | Pendiente de documentar | `20260717.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `273.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784297095` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T140506Z` |
| `entity_id` | `str` | Pendiente de documentar | `953b8053-9e5d-49e9-9405-22661b61da01` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48516273498535` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11872863769533` |
| `bearing` | `float64` | Pendiente de documentar | `273.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `19.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784297095` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-17 08:04:55-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T14:58:16Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T145811Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-17T14:58:12.270057` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `385.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `441.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.416666666666667` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-12.698412698412698` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T145811Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-17T14:58:13.725122` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T145811Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-17T14:58:12.172160` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T145811Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-17T14:58:16.580286` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `623.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `493.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `10.383333333333333` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.216666666666667` |
| `delay_seconds` | `float64` | Pendiente de documentar | `130.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `2.1666666666666665` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `26.369168356997964` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `2.1666666666666665` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `26.369168356997964` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0733662145499383` |
| `delay_score` | `float64` | Pendiente de documentar | `0.2139917695473251` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.8491677270511221` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `27.774546129926048` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T14:10:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T141003Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-17T14:10:04.089853` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.945319` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T141003Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-17T14:10:04.035946` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2955957382` |
| `lon` | `float64` | Pendiente de documentar | `-99.3562035913` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-17T13:55:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-17T14:47:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3680522496, 19.2976181885], [-99.3671443219, 19.2975833011], [-99.366940474,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24450356352081000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
