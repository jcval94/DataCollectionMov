...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-18T22:37:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260918T223656Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:06:04` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789771002` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260918T223656Z` |
| `entity_id` | `str` | Pendiente de documentar | `0151820d-f756-486f-962a-9327a0323fab` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.486459732055664` |
| `longitude` | `float64` | Pendiente de documentar | `-99.12228393554688` |
| `bearing` | `float64` | Pendiente de documentar | `112.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789771002` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-18 16:36:42-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
