...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-18T04:39:56Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260918T043951Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:31:36` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789706378` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260918T043951Z` |
| `entity_id` | `str` | Pendiente de documentar | `cf55ef51-137e-40ae-b13c-4efe41bd75fb` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.475404739379883` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0713882446289` |
| `bearing` | `float64` | Pendiente de documentar | `299.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `22.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789706378` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-17 22:39:38-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
