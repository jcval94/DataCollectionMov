...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-09T23:48:59Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T234857Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783640449` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-09 23:40:49` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-10T04:12:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T041223Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:11:56` |
...
| `bearing` | `float64` | Pendiente de documentar | `350.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783656732` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T041223Z` |
| `entity_id` | `str` | Pendiente de documentar | `42c6073a-094e-4406-831b-6d5153a31625` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.509876251220703` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1915054321289` |
| `bearing` | `float64` | Pendiente de documentar | `350.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `18.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783656732` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-09 22:12:12-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-09T23:42:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T234237Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-09T23:42:37.711867` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.989724` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T234237Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-09T23:42:37.621124` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-09T23:32:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-10T00:02:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-41b82937-4433-431b-afaa-fdf8681ff54e-TTL24441700932019000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
