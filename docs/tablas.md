...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T23:14:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T231405Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:17:52` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784675636` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T231405Z` |
| `entity_id` | `str` | Pendiente de documentar | `10e0610d-cf2b-4971-98c3-f9f0e3cfe834` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.507301330566406` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19957733154295` |
| `bearing` | `float64` | Pendiente de documentar | `195.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `18.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784675636` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-21 17:13:56-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
