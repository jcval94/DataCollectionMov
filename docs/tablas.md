...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T17:54:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T175407Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-03T17:54:08.327235` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.0018450184501844` |
| `confidence` | `float64` | Pendiente de documentar | `0.994235` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 9, "freeFlowSpeed": 18, "currentTravelTime": 1085, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T175407Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-03T17:54:08.256031` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2976637556` |
| `lon` | `float64` | Pendiente de documentar | `-99.3690258915` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-03T15:42:03Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-03T18:26:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3745217378, 19.3001863835], [-99.3743715341, 19.3000965163], [-99.3736996407` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-0e6b35d1-b793-45b4-b4a5-22dc2fb82b8b-TTL24447470880009001", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
