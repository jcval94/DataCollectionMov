...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-14T06:35:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T063505Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `0` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `12` |
| `num_docks_available` | `int64` | Pendiente de documentar | `27` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783998807` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-14 03:13:27` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-14T14:15:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T141529Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:13:18` |
...
| `bearing` | `float64` | Pendiente de documentar | `274.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784038518` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T141529Z` |
| `entity_id` | `str` | Pendiente de documentar | `283ab225-e2f5-4706-92ca-374b088af5f5` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49093246459961` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13419342041016` |
| `bearing` | `float64` | Pendiente de documentar | `274.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784038518` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-14 08:15:18-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-14T06:29:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T062948Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-14T06:29:49.142232` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T062948Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-14T06:29:49.068019` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2991885863` |
| `lon` | `float64` | Pendiente de documentar | `-99.3626824672` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-14T06:27:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-14T06:42:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3674004728, 19.3013022035], [-99.3673736507, 19.3012887552], [-99.3667245562` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24450356344072000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
