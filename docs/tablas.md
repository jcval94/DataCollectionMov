...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T17:17:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T171718Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:36:26` |
...
| `bearing` | `float64` | Pendiente de documentar | `269.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786468627` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T171718Z` |
| `entity_id` | `str` | Pendiente de documentar | `f06182f5-c61f-4c1d-95ca-23e51fcb1fa5` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.488767623901367` |
| `longitude` | `float64` | Pendiente de documentar | `-99.12849426269533` |
| `bearing` | `float64` | Pendiente de documentar | `269.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786468627` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-11 11:17:07-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
