...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-06T14:57:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260806T145753Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786025640` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-06 14:14:00` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-06T00:11:56Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260806T001149Z` |
...
| `start_time` | `str` | Pendiente de documentar | `00:00:40` |
| `start_date` | `float64` | Pendiente de documentar | `20260806.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `200.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `46.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785975088` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260806T001149Z` |
| `entity_id` | `str` | Pendiente de documentar | `035845db-3469-4c79-95bc-67be3fbb6cd9` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4775390625` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07843780517578` |
| `bearing` | `float64` | Pendiente de documentar | `200.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `46.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `165.6` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785975088` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-05 18:11:28-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
