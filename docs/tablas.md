...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T03:57:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T035707Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:11:27` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787198214` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T035707Z` |
| `entity_id` | `str` | Pendiente de documentar | `ce737082-079f-4fcc-a7d0-2b73445613a6` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.489919662475582` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13123321533205` |
| `bearing` | `float64` | Pendiente de documentar | `289.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787198214` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 21:56:54-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T03:13:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T031318Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-20T03:13:18.501681` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T031318Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-20T03:13:18.434033` |
...
| `lat` | `float64` | Pendiente de documentar | `19.361419836` |
| `lon` | `float64` | Pendiente de documentar | `-99.3237046058` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-20T02:50:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-20T03:32:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3238896782, 19.3613568102], [-99.323732769, 19.361411849], [-99.3237046058, ` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24450357340015000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
