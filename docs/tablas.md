...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T02:42:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T024202Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:11:17` |
...
| `speed_mps` | `float64` | Pendiente de documentar | `54.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786502514` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T024202Z` |
| `entity_id` | `str` | Pendiente de documentar | `b20bd667-bf3d-40bf-9fdc-a24a8a9b42a3` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4795036315918` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09969329833984` |
| `bearing` | `float64` | Pendiente de documentar | `285.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `54.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `194.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786502514` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-11 20:41:54-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
