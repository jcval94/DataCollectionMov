...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T18:00:16Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T180015Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `24` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `1` |
| `num_docks_available` | `int64` | Pendiente de documentar | `14` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783101604` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-03 18:00:04` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T18:40:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T184005Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:11:27` |
| `start_date` | `float64` | Pendiente de documentar | `20260703.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `100.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783103990` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T184005Z` |
| `entity_id` | `str` | Pendiente de documentar | `ea1dd959-75bd-45e3-8c1b-70a8211be36e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.466419219970703` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0733871459961` |
| `bearing` | `float64` | Pendiente de documentar | `100.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `24.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783103990` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-03 12:39:50-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T19:56:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T195601Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-03T19:56:01.611645` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `3.0018450184501844` |
| `confidence` | `float64` | Pendiente de documentar | `0.995082` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 6, "freeFlowSpeed": 18, "currentTravelTime": 1627, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T195601Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-03T19:56:01.499617` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-03T19:45:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-03T20:21:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-0e6b35d1-b793-45b4-b4a5-22dc2fb82b8b-TTL24441700944011000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
