...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T17:33:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T173347Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786726602` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-14 16:56:42` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T17:33:49Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T173347Z` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T17:13:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T171327Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:52:38` |
| `start_date` | `float64` | Pendiente de documentar | `20260814.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786727593` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T171327Z` |
| `entity_id` | `str` | Pendiente de documentar | `751512bd-3535-4a1a-a9ff-76ad2a31b47a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478736877441406` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09691619873048` |
| `bearing` | `float64` | Pendiente de documentar | `294.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `8.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786727593` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-14 11:13:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T17:23:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T172322Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-14T17:23:22.841595` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.996907` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T172322Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-14T17:23:22.756675` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-14T16:46:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-14T17:42:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24441700956011000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
