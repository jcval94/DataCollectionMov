...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T04:51:24Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T045122Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:36:34` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787201468` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T045122Z` |
| `entity_id` | `str` | Pendiente de documentar | `641f3bea-4653-43fb-9547-f1931d1c733c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47941017150879` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0642547607422` |
| `bearing` | `float64` | Pendiente de documentar | `166.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787201468` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 22:51:08-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
