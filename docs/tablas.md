...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-14T06:23:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T062305Z` |
...
| `start_time` | `str` | Pendiente de documentar | `05:39:21` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784010167` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T062305Z` |
| `entity_id` | `str` | Pendiente de documentar | `3b2a4e72-cd4e-4981-aead-4b49dc07cfbd` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478126525878903` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06463623046876` |
| `bearing` | `float64` | Pendiente de documentar | `0.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784010167` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-14 00:22:47-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
