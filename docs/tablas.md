...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T14:02:31Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T140230Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786541467` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-12 13:31:07` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T13:50:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T135018Z` |
...
| `start_time` | `str` | Pendiente de documentar | `13:33:27` |
| `start_date` | `float64` | Pendiente de documentar | `20260812.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786542614` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T135018Z` |
| `entity_id` | `str` | Pendiente de documentar | `352cca02-a92b-4c75-8c07-1049f229eafb` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46878242492676` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08480834960938` |
| `bearing` | `float64` | Pendiente de documentar | `306.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `26.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786542614` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-12 07:50:14-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T13:54:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T135415Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-12T13:54:15.892011` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T135415Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-12T13:54:15.799263` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3985027536` |
| `lon` | `float64` | Pendiente de documentar | `-99.3284923489` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-12T13:25:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-12T14:13:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3274999315, 19.3963409025], [-99.3275549168, 19.396468271], [-99.3277775402,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24444586964035000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
