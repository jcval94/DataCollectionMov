...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T17:50:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T175049Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784742211` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-22 17:43:31` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T18:35:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T183541Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:14:30` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784745354` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T183541Z` |
| `entity_id` | `str` | Pendiente de documentar | `c9bc0b4d-cb63-4522-a02a-c4f7211f5b83` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49344253540039` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1474151611328` |
| `bearing` | `float64` | Pendiente de documentar | `354.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `18.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784745354` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-22 12:35:54-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
