...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T03:29:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T032921Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T03:20:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T032037Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-07T03:20:37.497911` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.2142857142857142` |
| `confidence` | `float64` | Pendiente de documentar | `0.934589` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 14, "freeFlowSpeed": 17, "currentTravelTime": 697, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T032037Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-07T03:20:37.420064` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3571162351` |
| `lon` | `float64` | Pendiente de documentar | `-99.3574548418` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-07T03:06:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-07T03:39:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3580261523, 19.3564322636], [-99.3574897105, 19.3570693402], [-99.3574548418` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ec25b321-e5cd-4e06-8756-a264821e8718-TTL24438815440011000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
