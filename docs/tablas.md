...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T21:42:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T214208Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783114919` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-03 21:41:59` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T23:31:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T233106Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:39:05` |
...
| `bearing` | `float64` | Pendiente de documentar | `155.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783121451` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T233106Z` |
| `entity_id` | `str` | Pendiente de documentar | `b61a14ea-b131-4d4a-952b-b45ec662c773` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.464672088623047` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05933380126952` |
| `bearing` | `float64` | Pendiente de documentar | `155.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `7.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783121451` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-03 17:30:51-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T21:37:57Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T213753Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-03T21:37:53.567026` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.99108` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T213753Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-03T21:37:53.441814` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-03T21:32:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-03T21:56:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-0e6b35d1-b793-45b4-b4a5-22dc2fb82b8b-TTL24441700920003000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
