...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-19T00:13:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260619T001334Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1781827836` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-19 00:10:36` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-19T05:23:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260619T052315Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:31:10` |
| `start_date` | `float64` | Pendiente de documentar | `20260619.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781682141` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260619T052315Z` |
| `entity_id` | `str` | Pendiente de documentar | `53f36e27-b0cc-4564-92be-19d121ef1cc1` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47938537597656` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06396484375` |
| `bearing` | `float64` | Pendiente de documentar | `0.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781682141` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-17 01:42:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-18T16:45:40Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260618T164536Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-18T16:45:36.375235` |
...
| `static_duration_seconds` | `float64` | Pendiente de documentar | `442.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.533333333333333` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `7.366666666666666` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-50.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.8333333333333334` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-11.31221719457014` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260618T164536Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-18T16:45:37.713417` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260618T164536Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-18T16:45:36.264541` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260618T164536Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-18T16:45:40.487625` |
...
| `distance_meters` | `int64` | Pendiente de documentar | `1884` |
| `duration_seconds` | `float64` | Pendiente de documentar | `328.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `392.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `5.466666666666667` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `6.533333333333333` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-64.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-1.0666666666666669` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-16.326530612244895` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-1.0666666666666669` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-16.326530612244895` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0129160457029309` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0236898779612347` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0125315249677745` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `1.6609982846306` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-18T22:28:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260618T222846Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-18T22:28:47.513011` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `3.2016393442622952` |
| `confidence` | `float64` | Pendiente de documentar | `0.878551` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 5, "freeFlowSpeed": 16, "currentTravelTime": 1953, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260618T222846Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-18T22:28:47.384251` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3611838649` |
| `lon` | `float64` | Pendiente de documentar | `-99.3514440114` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-18T22:21:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-18T22:47:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3502128775, 19.3613903396], [-99.3502718861, 19.3613621876], [-99.3504086787` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2854a05b-83f3-499c-b803-c30b2f24b6df-TTL24441701004011000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
