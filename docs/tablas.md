...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T17:03:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T170345Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:44:00` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787677409` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T170345Z` |
| `entity_id` | `str` | Pendiente de documentar | `3fc00362-634c-4554-9d30-fe4dd893a305` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.464998245239254` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05947875976562` |
| `bearing` | `float64` | Pendiente de documentar | `323.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787677409` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-25 11:03:29-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
