...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-26T21:50:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T215021Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782510577` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-26 21:49:37` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-26T22:38:01Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T223756Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:33:38` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782513475` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T223756Z` |
| `entity_id` | `str` | Pendiente de documentar | `5b1557e1-705e-4ff0-959e-b1b79195bb46` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46756935119629` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06251525878906` |
| `bearing` | `float64` | Pendiente de documentar | `135.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782513475` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-26 16:37:55-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-26T21:45:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T214546Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-26T21:45:47.319652` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T214546Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-26T21:45:47.228851` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4205813378` |
| `lon` | `float64` | Pendiente de documentar | `-99.3652278835` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-26T21:12:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-26T22:07:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3630807752, 19.4208857591], [-99.3631907458, 19.4208764312], [-99.3634026403` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-19ee81bd-39c4-4110-b867-271d942821dd-TTL24427274664018000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
