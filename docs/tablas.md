...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-26T04:50:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T045017Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782444483` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-26 03:28:03` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-26T04:38:42Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T043838Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:23:31` |
| `start_date` | `float64` | Pendiente de documentar | `20260626.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782448708` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T043838Z` |
| `entity_id` | `str` | Pendiente de documentar | `d46e93ae-1a2f-4b3b-9579-7462a07806ac` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.507057189941406` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1994857788086` |
| `bearing` | `float64` | Pendiente de documentar | `155.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782448708` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-25 22:38:28-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-26T04:44:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T044430Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-26T04:44:30.319048` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T044430Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-26T04:44:30.281426` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2989927917` |
| `lon` | `float64` | Pendiente de documentar | `-99.3621875996` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-26T04:34:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-26T04:59:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-19ee81bd-39c4-4110-b867-271d942821dd-TTL24450356344112000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
