...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-05T18:25:29Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260605T182527Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1780683422` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-05 18:17:02` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-05T18:14:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260605T181404Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:26:40` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1780683233` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260605T181404Z` |
| `entity_id` | `str` | Pendiente de documentar | `ee66aad8-42dd-4c56-9881-9942d820b770` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.506879806518555` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1997528076172` |
| `bearing` | `float64` | Pendiente de documentar | `201.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `13.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1780683233` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-05 12:13:53-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-05T18:20:13Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260605T182009Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-05T18:20:09.762810` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.987356` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260605T182009Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-05T18:20:09.668832` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-05T18:08:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-05T18:38:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-13f3ec6a-4ca6-44e3-a453-bf78cdebb43e-TTL24441700956023000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
