...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-23T05:01:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T050117Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1790136801` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-23 04:13:21` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-23T17:08:13Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T170808Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:06:01` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790183278` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T170808Z` |
| `entity_id` | `str` | Pendiente de documentar | `f5d4761c-015c-4648-bd80-1dc1f2b0f532` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.06348419189452` |
| `bearing` | `float64` | Pendiente de documentar | `308.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `42.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790183278` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-23 11:07:58-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-23T04:53:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T045322Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-23T04:53:22.594102` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T045322Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-23T04:53:22.532922` |
...
| `lat` | `float64` | Pendiente de documentar | `19.381992374` |
| `lon` | `float64` | Pendiente de documentar | `-99.3922766204` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-23T04:47:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-23T05:21:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-54cec490-cc44-44e3-a958-ad290dd1e9c9-TTL24427274204034000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
