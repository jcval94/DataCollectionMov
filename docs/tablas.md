...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-06T15:56:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T155600Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:06:31` |
| `start_date` | `float64` | Pendiente de documentar | `20260706.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `280.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783353357` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T155600Z` |
| `entity_id` | `str` | Pendiente de documentar | `a6816358-57ae-49e7-9dbd-722c1fd2c503` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49614524841309` |
| `longitude` | `float64` | Pendiente de documentar | `-99.15841674804688` |
| `bearing` | `float64` | Pendiente de documentar | `280.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783353357` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-06 09:55:57-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-06T15:58:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T155803Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-06T15:58:03.722331` |
...
| `current_travel_time_seconds` | `int64` | Pendiente de documentar | `751` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.461089494163424` |
| `confidence` | `float64` | Pendiente de documentar | `0.991003` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 13, "freeFlowSpeed": 19, "currentTravelTime": 751, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T155803Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-06T15:58:03.640093` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-06T15:47:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-06T16:16:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-d78aba7a-98dd-4e36-8e61-64835b4cc286-TTL24441700960015000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
