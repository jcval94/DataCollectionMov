...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T23:30:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T233006Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `16` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `2` |
| `num_docks_available` | `int64` | Pendiente de documentar | `21` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783982774` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-13 22:46:14` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-14T03:31:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T033107Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:59:26` |
| `start_date` | `float64` | Pendiente de documentar | `20260714.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `195.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `32.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783999850` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T033107Z` |
| `entity_id` | `str` | Pendiente de documentar | `be1a3aee-f679-4932-9374-7a2d40c99799` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48624992370605` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11832427978516` |
| `bearing` | `float64` | Pendiente de documentar | `195.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `32.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `115.2` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783999850` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-13 21:30:50-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T23:24:06Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T232402Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-13T23:24:03.195077` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.989989` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T232402Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-13T23:24:03.130626` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3612991618` |
| `lon` | `float64` | Pendiente de documentar | `-99.3504086787` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-13T23:22:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-13T23:42:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24441700920011000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
