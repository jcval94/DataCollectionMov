...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T17:50:40Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T175039Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `24` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `0` |
| `num_docks_available` | `int64` | Pendiente de documentar | `15` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784137782` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-15 17:49:42` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T19:38:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T193805Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:13:52` |
...
| `bearing` | `float64` | Pendiente de documentar | `153.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `53.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784144279` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T193805Z` |
| `entity_id` | `str` | Pendiente de documentar | `8c6df0cf-3c2b-407c-86bd-a4719bdb8aed` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46932411193848` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0854034423828` |
| `bearing` | `float64` | Pendiente de documentar | `153.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `53.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `190.8` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784144279` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-15 13:37:59-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T19:43:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T194334Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-15T19:43:34.815728` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.946086` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T194334Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-15T19:43:34.746271` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4971691193` |
| `lon` | `float64` | Pendiente de documentar | `-99.362282818` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-15T19:38:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-15T20:02:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3606560583, 19.496290733], [-99.3610811884, 19.4965334611], [-99.3616457934,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24418619400019000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
