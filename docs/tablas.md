...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T23:27:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T232703Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:41:11` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784762813` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T232703Z` |
| `entity_id` | `str` | Pendiente de documentar | `0cf0018a-9e96-4974-bebc-26ba08f6c7c2` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.477006912231445` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09294891357422` |
| `bearing` | `float64` | Pendiente de documentar | `111.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784762813` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-22 17:26:53-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
