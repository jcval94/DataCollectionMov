...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T23:40:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T234002Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785195167` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-27 23:32:47` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T03:32:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T033222Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:33:26` |
| `start_date` | `float64` | Pendiente de documentar | `20260728.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `208.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `15.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785209531` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T033222Z` |
| `entity_id` | `str` | Pendiente de documentar | `1f6bb8c6-d80c-49fa-a31f-951c5efff145` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.511049270629883` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19854736328124` |
| `bearing` | `float64` | Pendiente de documentar | `208.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `15.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `54.0` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785209531` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-27 21:32:11-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T23:31:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T233142Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-27T23:31:43.025630` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.999211` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T233142Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-27T23:31:42.955926` |
...
| `lat` | `float64` | Pendiente de documentar | `19.361156978` |
| `lon` | `float64` | Pendiente de documentar | `-99.3514104838` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-27T23:25:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-27T23:50:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3495208675, 19.3617832815], [-99.3498668725, 19.3615847941], [-99.3502128775` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441701008011000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
