...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T14:30:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T143022Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-21T14:30:22.328619` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.3625192012288787` |
| `confidence` | `float64` | Pendiente de documentar | `0.842748` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 11, "freeFlowSpeed": 15, "currentTravelTime": 887, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T143022Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-21T14:30:22.267217` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-21T14:18:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-21T14:48:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24441700980014000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
