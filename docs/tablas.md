...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-08T04:20:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260808T042007Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:05:34` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786162793` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260808T042007Z` |
| `entity_id` | `str` | Pendiente de documentar | `53f6b722-5a22-4067-973a-37e9fa618bda` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48185157775879` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10489654541016` |
| `bearing` | `float64` | Pendiente de documentar | `136.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786162793` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-07 22:19:53-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
