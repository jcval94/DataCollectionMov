...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T18:00:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T180050Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785261516` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-28 17:58:36` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T18:48:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T184833Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:46:12` |
...
| `bearing` | `float64` | Pendiente de documentar | `343.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785264494` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T184833Z` |
| `entity_id` | `str` | Pendiente de documentar | `a199f112-e8d7-47e2-9359-35920f850786` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.50946807861328` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19147491455078` |
| `bearing` | `float64` | Pendiente de documentar | `343.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `50.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785264494` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-28 12:48:14-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T17:49:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T174928Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-28T17:49:29.237613` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.995474` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T174928Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-28T17:49:29.164399` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3585405537` |
| `lon` | `float64` | Pendiente de documentar | `-99.3533389921` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-28T17:16:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-28T18:08:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3527287895, 19.3594162847], [-99.3527784104, 19.3593800662], [-99.3529205675` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441700972023000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
