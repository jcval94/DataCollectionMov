...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-14T16:01:28Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T160127Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784044869` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-14 16:01:09` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-14T17:35:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T173530Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:19:21` |
...
| `bearing` | `float64` | Pendiente de documentar | `126.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784050525` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T173530Z` |
| `entity_id` | `str` | Pendiente de documentar | `07b957e2-c334-4b18-b26a-fd91464d4399` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478708267211918` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10001373291016` |
| `bearing` | `float64` | Pendiente de documentar | `126.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `19.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784050525` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-14 11:35:25-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-14T15:55:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T155509Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-14T15:55:10.409601` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T155509Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-14T15:55:10.335034` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2959874144` |
| `lon` | `float64` | Pendiente de documentar | `-99.3610744829` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-07-14T16:30:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3685900325, 19.2976476964], [-99.3680522496, 19.2976181885], [-99.3671443219` |
