...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T05:05:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T050507Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787282742` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-21 03:25:42` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T13:13:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T131257Z` |
...
| `start_time` | `str` | Pendiente de documentar | `13:06:08` |
| `start_date` | `float64` | Pendiente de documentar | `20260821.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `150.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787317961` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T131257Z` |
| `entity_id` | `str` | Pendiente de documentar | `7a164ce5-d0c4-4e49-92f2-d0031d69c6d3` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.470632553100582` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08615112304688` |
| `bearing` | `float64` | Pendiente de documentar | `150.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `8.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787317961` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 07:12:41-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T13:24:06Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T132403Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-21T13:24:03.297907` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.1254612546125462` |
| `confidence` | `float64` | Pendiente de documentar | `0.971725` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 16, "freeFlowSpeed": 18, "currentTravelTime": 610, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T132403Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-21T13:24:03.256241` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4336705426` |
| `lon` | `float64` | Pendiente de documentar | `-99.341287827` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-21T13:16:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-21T13:42:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3613802547, 19.4186836523], [-99.3613158817, 19.4186836523], [-99.3611455614` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24430159896082000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
