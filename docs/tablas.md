...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T15:08:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T150828Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:30:38` |
...
| `bearing` | `float64` | Pendiente de documentar | `313.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786720097` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T150828Z` |
| `entity_id` | `str` | Pendiente de documentar | `7c8c64aa-e7e6-4dd1-bc7a-f719fc2550ce` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48750877380371` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1242218017578` |
| `bearing` | `float64` | Pendiente de documentar | `313.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786720097` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-14 09:08:17-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
