...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T21:43:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T214303Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:49:09` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787002973` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T214303Z` |
| `entity_id` | `str` | Pendiente de documentar | `95ab6370-53f1-42f1-9689-0b5aeb6c9a92` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49054527282715` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1329116821289` |
| `bearing` | `float64` | Pendiente de documentar | `108.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `2.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787002973` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 15:42:53-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
