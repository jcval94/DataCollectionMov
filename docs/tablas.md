...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-09T23:54:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260609T235437Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1781047871` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-09 23:31:11` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-10T04:46:45Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260610T044641Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:40:24` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781066785` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260610T044641Z` |
| `entity_id` | `str` | Pendiente de documentar | `3a511f63-faff-4e7a-a409-1b3e29494cac` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.504396438598636` |
| `longitude` | `float64` | Pendiente de documentar | `-99.18671417236328` |
| `bearing` | `float64` | Pendiente de documentar | `104.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `51.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781066785` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-09 22:46:25-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-09T23:48:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260609T234818Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-09T23:48:18.854900` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.993111` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260609T234818Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-09T23:48:18.758715` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-09T23:43:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-10T00:06:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-208c1abc-26cd-42ed-a876-d2f71f564b3d-TTL24441701000019000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
