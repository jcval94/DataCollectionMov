...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-08T22:43:27Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T224322Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:04:56` |
...
| `bearing` | `float64` | Pendiente de documentar | `144.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788907386` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T224322Z` |
| `entity_id` | `str` | Pendiente de documentar | `ce14e95d-a184-470c-9a6e-017ede36c0fe` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46693420410156` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06216430664062` |
| `bearing` | `float64` | Pendiente de documentar | `144.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `7.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788907386` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-08 16:43:06-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
