...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-25T06:38:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260725T063834Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `0` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `17` |
| `num_docks_available` | `int64` | Pendiente de documentar | `22` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784952206` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-25 04:03:26` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-25T06:28:06Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260725T062803Z` |
...
| `start_time` | `str` | Pendiente de documentar | `05:16:05` |
| `start_date` | `float64` | Pendiente de documentar | `20260725.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784954422` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260725T062803Z` |
| `entity_id` | `str` | Pendiente de documentar | `ea040e24-58f0-4022-a5be-5d4d912a4a53` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.479427337646484` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0639877319336` |
| `bearing` | `float64` | Pendiente de documentar | `0.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784954422` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-24 22:40:22-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-24T15:13:42Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T151338Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-24T15:13:38.446809` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T151338Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-24T15:13:39.869709` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T151338Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-24T15:13:38.336547` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T151338Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-24T15:13:42.814834` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `727.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `492.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `12.116666666666667` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.2` |
| `delay_seconds` | `float64` | Pendiente de documentar | `235.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `3.9166666666666665` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `47.76422764227641` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `3.9166666666666665` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `47.76422764227641` |
| `duration_score` | `float64` | Pendiente de documentar | `0.106312292358804` |
| `delay_score` | `float64` | Pendiente de documentar | `0.3405875952121871` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `1.0` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `36.704618988572726` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T15:20:13Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T152009Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-27T15:20:09.807302` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.994073` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T152009Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-27T15:20:09.736594` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-27T15:12:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-27T15:38:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3455860669, 19.4249412823], [-99.3456437344, 19.4249238127], [-99.3460380191` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24435931060146002", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
