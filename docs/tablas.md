...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T19:59:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T195918Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-30T19:59:19.170746` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.7140077821011674` |
| `confidence` | `float64` | Pendiente de documentar | `0.987419` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 7, "freeFlowSpeed": 19, "currentTravelTime": 1395, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T195918Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-30T19:59:19.090700` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-30T19:58:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-30T20:20:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24435931060146000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
