...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T14:37:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T143717Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784644114` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-21 14:28:34` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T16:44:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T164356Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:38:41` |
...
| `bearing` | `float64` | Pendiente de documentar | `134.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784652222` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T164356Z` |
| `entity_id` | `str` | Pendiente de documentar | `7de61877-6086-4f7b-8b0e-26031ebf507c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.505617141723636` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1906967163086` |
| `bearing` | `float64` | Pendiente de documentar | `134.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784652222` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-21 10:43:42-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T17:49:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T174937Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-21T17:49:38.122030` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.987648` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T174937Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-21T17:49:38.049504` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3591989736` |
| `lon` | `float64` | Pendiente de documentar | `-99.3630941863` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-21T17:39:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-21T18:08:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.362410223, 19.3592606558], [-99.3626945371, 19.3592338477], [-99.3629533703,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24438815528011000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
