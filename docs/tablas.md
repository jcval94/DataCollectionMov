...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T06:36:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T063613Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784087505` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-15 03:51:45` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T14:12:39Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T141234Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:02:03` |
...
| `bearing` | `float64` | Pendiente de documentar | `198.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784124741` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T141234Z` |
| `entity_id` | `str` | Pendiente de documentar | `76e12639-e6d9-442a-a9a9-7215c7dd422e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478254318237305` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07813262939452` |
| `bearing` | `float64` | Pendiente de documentar | `198.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `6.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784124741` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-15 08:12:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T14:17:20Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T141716Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-15T14:17:16.647342` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.982031` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T141716Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-15T14:17:16.544687` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-15T13:46:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-15T14:38:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24441700920019000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
