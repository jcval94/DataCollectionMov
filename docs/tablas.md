...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T01:50:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T014957Z` |
...
| `start_time` | `str` | Pendiente de documentar | `01:39:18` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787190576` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T014957Z` |
| `entity_id` | `str` | Pendiente de documentar | `e9ba7c04-9d52-4249-9f8d-27c57499aaa9` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.473865509033203` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07913208007812` |
| `bearing` | `float64` | Pendiente de documentar | `183.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787190576` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 19:49:36-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
