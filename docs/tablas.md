...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-11T01:08:49Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T010844Z` |
...
| `start_time` | `str` | Pendiente de documentar | `00:59:28` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789088910` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T010844Z` |
| `entity_id` | `str` | Pendiente de documentar | `12bccf63-b6ef-440c-ae1a-279c4853c2b0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.493207931518555` |
| `longitude` | `float64` | Pendiente de documentar | `-99.14519500732422` |
| `bearing` | `float64` | Pendiente de documentar | `282.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `15.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789088910` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-10 19:08:30-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
