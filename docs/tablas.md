...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-25T17:30:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T173037Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1790357400` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-25 17:30:00` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-25T17:30:39Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T173037Z` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-25T17:15:45Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T171542Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:04:35` |
| `start_date` | `float64` | Pendiente de documentar | `20260925.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `207.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790356532` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T171542Z` |
| `entity_id` | `str` | Pendiente de documentar | `51301341-ea0f-415a-a51e-7efaa1a05e7e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47816276550293` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07816314697266` |
| `bearing` | `float64` | Pendiente de documentar | `207.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790356532` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-25 11:15:32-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-24T17:55:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260924T175507Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-24T17:55:07.528726` |
...
| `delay_seconds` | `float64` | Pendiente de documentar | `8.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `0.1333333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `1.941747572815533` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260924T175507Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-24T17:55:08.818971` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260924T175507Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-24T17:55:07.448664` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260924T175507Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-24T17:55:11.430727` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `519.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `526.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `8.65` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-1.3307984790874472` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.1166666666666666` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-1.3307984790874472` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0575268817204301` |
| `delay_score` | `float64` | Pendiente de documentar | `0.036697247706422` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.2013676136730709` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `7.900465620605544` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-25T17:22:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T172247Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-25T17:22:48.283056` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.907342` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T172247Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-25T17:22:48.196872` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3608847884` |
| `lon` | `float64` | Pendiente de documentar | `-99.3492177779` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-25T17:04:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-25T17:41:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3472490365, 19.3615754629], [-99.3478377814, 19.3613514329], [-99.347935682,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-54cec490-cc44-44e3-a958-ad290dd1e9c9-TTL24441700996014001", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
