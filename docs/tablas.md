...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T23:35:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T233459Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784676578` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-21 23:29:38` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T00:10:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T001006Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:17:57` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784678995` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T001006Z` |
| `entity_id` | `str` | Pendiente de documentar | `f4198134-3550-4563-b82d-2e56291a8c5e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.472944259643555` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08750915527344` |
| `bearing` | `float64` | Pendiente de documentar | `141.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784678995` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-21 18:09:55-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T23:26:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T232629Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-21T23:26:29.437141` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.99272` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T232629Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-21T23:26:29.376035` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-21T22:21:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-21T23:46:30Z` |
