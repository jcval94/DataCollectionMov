...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-11T16:44:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T164414Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `5` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `0` |
| `num_docks_available` | `int64` | Pendiente de documentar | `34` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1789144791` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-11 16:39:51` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-11T16:32:01Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T163156Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:10:18` |
| `start_date` | `float64` | Pendiente de documentar | `20260911.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `550.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `24.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789144306` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T163156Z` |
| `entity_id` | `str` | Pendiente de documentar | `682b0483-558f-49ce-8e62-739c7514ec07` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.34141540527344` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1897964477539` |
| `bearing` | `float64` | Pendiente de documentar | `550.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `24.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `86.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789144306` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-11 10:31:46-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-10T17:05:49Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260910T170544Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-10T17:05:44.916147` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `431.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `421.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `7.183333333333334` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `2.375296912114022` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260910T170544Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-10T17:05:46.242932` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260910T170544Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-10T17:05:44.798882` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260910T170544Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-10T17:05:49.038641` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `541.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `482.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `9.016666666666667` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `12.24066390041494` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `0.9833333333333332` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `12.24066390041494` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0309859154929577` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0825791855203619` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.429496939149533` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `12.874576473386428` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-11T16:38:35Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T163831Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-11T16:38:31.850859` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.223360655737705` |
| `confidence` | `float64` | Pendiente de documentar | `0.978363` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 9, "freeFlowSpeed": 20, "currentTravelTime": 1085, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T163831Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-11T16:38:31.772648` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4220619376` |
| `lon` | `float64` | Pendiente de documentar | `-99.3520636017` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-11T16:11:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-11T16:57:00Z` |
...
| `event_codes` | `str` | Pendiente de documentar | `122` |
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3435060138, 19.4259753043], [-99.3435677046, 19.4259202873], [-99.3436857218` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ad320136-f8e8-4f16-a113-574c85e74a9b-TTL24433045720362001", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
