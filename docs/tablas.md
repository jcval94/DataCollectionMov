...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T21:42:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T214218Z` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787348529` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T214218Z` |
| `entity_id` | `str` | Pendiente de documentar | `e2a598dc-f7a1-4760-9e05-329804a8fdf5` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48735618591309` |
| `longitude` | `float64` | Pendiente de documentar | `-99.12430572509766` |
| `bearing` | `float64` | Pendiente de documentar | `288.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787348529` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 15:42:09-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
