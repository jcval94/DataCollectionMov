...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T18:10:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T181013Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785520887` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-31 18:01:27` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T18:46:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T184627Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:40:11` |
...
| `bearing` | `float64` | Pendiente de documentar | `284.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `8.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785523573` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T184627Z` |
| `entity_id` | `str` | Pendiente de documentar | `46b6b63a-a730-4dba-a8ef-a26c3d16649e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.504980087280277` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1888656616211` |
| `bearing` | `float64` | Pendiente de documentar | `284.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `8.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `28.8` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785523573` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-31 12:46:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T15:38:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T153803Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-31T15:38:03.399628` |
...
| `delay_seconds` | `float64` | Pendiente de documentar | `-52.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.8666666666666667` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-11.926605504587153` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T153803Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-31T15:38:04.683290` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T153803Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-31T15:38:03.314905` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T153803Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-31T15:38:07.253660` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `275.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `327.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `4.583333333333333` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `5.45` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-52.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.8666666666666667` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-15.902140672782872` |
...
| `delay_score` | `float64` | Pendiente de documentar | `0.0602409638554216` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0236059868768568` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `2.580553472476895` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T19:59:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T195937Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-31T19:59:38.025523` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.1254355400696863` |
| `confidence` | `float64` | Pendiente de documentar | `0.994246` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 8, "freeFlowSpeed": 17, "currentTravelTime": 1220, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T195937Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-31T19:59:37.941773` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3618061352` |
| `lon` | `float64` | Pendiente de documentar | `-99.3516371305` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-31T17:50:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-31T20:18:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3507600481, 19.3621158856], [-99.350977307, 19.3620233638], [-99.3511959071,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTR24441700996014000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
