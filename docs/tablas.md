...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T14:55:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T145517Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:22:07` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787324108` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T145517Z` |
| `entity_id` | `str` | Pendiente de documentar | `c5868494-f655-407f-ad35-0cc98dfb4e02` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.472131729125977` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06761932373048` |
| `bearing` | `float64` | Pendiente de documentar | `136.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `22.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787324108` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 08:55:08-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
