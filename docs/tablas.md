...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T20:47:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T204728Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:19:12` |
...
| `bearing` | `float64` | Pendiente de documentar | `869.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787172435` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T204728Z` |
| `entity_id` | `str` | Pendiente de documentar | `3c138fd8-e098-4fe8-bf0e-985c02a68009` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.467435836791992` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08102416992188` |
| `bearing` | `float64` | Pendiente de documentar | `869.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787172435` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 14:47:15-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
