...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-02T16:50:04Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T165003Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788367788` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-02 16:49:48` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-02T19:49:24Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T194919Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:41:10` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788378553` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T194919Z` |
| `entity_id` | `str` | Pendiente de documentar | `2eb6ded2-adf7-41d1-884c-291b8d5fa127` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47160148620605` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06861114501952` |
| `bearing` | `float64` | Pendiente de documentar | `339.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `17.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788378553` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-02 13:49:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-02T21:10:34Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T211031Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-02T21:10:31.658044` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.998161` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T211031Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-02T21:10:31.569135` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-02T19:00:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-02T21:42:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4f54caf4-b222-4646-895c-ec863c842a32-TTL24441700920035000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
