...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-05T00:21:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260905T002117Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788567337` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-05 00:15:37` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-05T04:23:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260905T042303Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:04:38` |
| `start_date` | `float64` | Pendiente de documentar | `20260905.0` |
...
| `speed_mps` | `float64` | Pendiente de documentar | `26.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788582178` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260905T042303Z` |
| `entity_id` | `str` | Pendiente de documentar | `4e88bac5-447b-4ee5-b688-18639f76f9c1` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.493881225585938` |
| `longitude` | `float64` | Pendiente de documentar | `-99.14862060546876` |
| `bearing` | `float64` | Pendiente de documentar | `102.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `26.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `93.6` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788582178` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-04 22:22:58-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-05T04:39:13Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260905T043909Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-05T04:39:10.264813` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260905T043909Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-05T04:39:10.213228` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3567340371` |
| `lon` | `float64` | Pendiente de documentar | `-99.3018083925` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-02T14:15:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-10-29T00:00:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3014664108, 19.3575964132], [-99.3016957397, 19.3571537985], [-99.3017735237` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4f54caf4-b222-4646-895c-ec863c842a32-TTR24456128336023000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
