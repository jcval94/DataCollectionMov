...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-09T00:31:16Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260909T003115Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788913299` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-09 00:21:39` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-09T00:23:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260909T002334Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-09T00:23:34.817351` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.416376306620209` |
| `confidence` | `float64` | Pendiente de documentar | `0.997925` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 12, "freeFlowSpeed": 17, "currentTravelTime": 813, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260909T002334Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-09T00:23:34.695277` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3611878188` |
| `lon` | `float64` | Pendiente de documentar | `-99.3515083844` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-08T23:42:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-09T00:43:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3504086787, 19.3612991618], [-99.3505883867, 19.3612294143], [-99.3509612138` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ad320136-f8e8-4f16-a113-574c85e74a9b-TTL24441700992019000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
