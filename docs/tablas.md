...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T19:38:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T193805Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-17T19:38:05.883044` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `3.799610894941634` |
| `confidence` | `float64` | Pendiente de documentar | `0.970523` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 5, "freeFlowSpeed": 19, "currentTravelTime": 1953, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T193805Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-17T19:38:05.788594` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-17T17:43:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-17T19:58:30Z` |
