...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-28T00:12:24Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T001220Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:17:03` |
...
| `bearing` | `float64` | Pendiente de documentar | `281.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785197537` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-28` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260728T001220Z` |
| `entity_id` | `str` | Pendiente de documentar | `0d60fe7a-e2a7-476f-99c3-0fe05fd42951` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47407341003418` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07015991210938` |
| `bearing` | `float64` | Pendiente de documentar | `281.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `24.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785197537` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-27 18:12:17-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
