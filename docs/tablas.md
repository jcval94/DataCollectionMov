...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T13:58:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T135832Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786715504` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-14 13:51:44` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T13:45:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T134549Z` |
...
| `start_time` | `str` | Pendiente de documentar | `13:25:06` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786715142` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T134549Z` |
| `entity_id` | `str` | Pendiente de documentar | `bd994449-9da6-41e0-9f92-58219651f34d` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.493488311767575` |
| `longitude` | `float64` | Pendiente de documentar | `-99.14688873291016` |
| `bearing` | `float64` | Pendiente de documentar | `102.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `12.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786715142` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-14 07:45:42-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T13:50:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T135020Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-14T13:50:21.296405` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T135020Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-14T13:50:21.213041` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-14T13:45:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-14T14:08:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24427274340194000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
