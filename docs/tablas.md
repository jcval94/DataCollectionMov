...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-24T00:14:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T001406Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:16:16` |
| `start_date` | `float64` | Pendiente de documentar | `20260723.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `884.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `19.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784852024` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T001406Z` |
| `entity_id` | `str` | Pendiente de documentar | `e954e2a8-4fe7-4da6-b843-cb68b3ba2798` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46695327758789` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07588958740234` |
| `bearing` | `float64` | Pendiente de documentar | `884.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `19.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `68.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784852024` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-23 18:13:44-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
