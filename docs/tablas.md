...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T16:53:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T165326Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:36:04` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787331203` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T165326Z` |
| `entity_id` | `str` | Pendiente de documentar | `582cdfb1-f50f-451e-a833-441a8b32c2a9` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47469139099121` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787331203` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 10:53:23-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
