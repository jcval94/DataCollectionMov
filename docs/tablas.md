...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-15T20:16:31Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T201626Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:20:46` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789503375` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T201626Z` |
| `entity_id` | `str` | Pendiente de documentar | `58d4e7cb-4faf-4921-900e-5f4607f5c45f` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.501026153564453` |
| `longitude` | `float64` | Pendiente de documentar | `-99.17507934570312` |
| `bearing` | `float64` | Pendiente de documentar | `300.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `40.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789503375` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-15 14:16:15-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
