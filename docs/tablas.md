...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T07:04:31Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T070430Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `0` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `21` |
| `num_docks_available` | `int64` | Pendiente de documentar | `18` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783490236` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-08 05:57:16` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T14:42:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T144243Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:37:18` |
...
| `bearing` | `float64` | Pendiente de documentar | `161.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `60.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783521754` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T144243Z` |
| `entity_id` | `str` | Pendiente de documentar | `1557d820-d2e4-4f11-90f7-d5d935bd636d` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.50457572937012` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19053649902344` |
| `bearing` | `float64` | Pendiente de documentar | `161.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `60.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `216.0` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783521754` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-08 08:42:34-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T14:45:27Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T144523Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-08T14:45:24.231037` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T144523Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-08T14:45:24.115244` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2984295349` |
| `lon` | `float64` | Pendiente de documentar | `-99.3654236848` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-07-08T15:10:30Z` |
