...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T15:43:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T154258Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:07:28` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786981372` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T154258Z` |
| `entity_id` | `str` | Pendiente de documentar | `0c44efd7-8b03-4b6a-91eb-f9b9ca95c21a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48531913757324` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1186294555664` |
| `bearing` | `float64` | Pendiente de documentar | `198.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `10.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786981372` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 09:42:52-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
