...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-10T15:17:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T151706Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `23` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `5` |
| `num_docks_available` | `int64` | Pendiente de documentar | `11` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783696115` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-10 15:08:35` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-10T15:03:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T150333Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:41:07` |
| `start_date` | `float64` | Pendiente de documentar | `20260710.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783695803` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T150333Z` |
| `entity_id` | `str` | Pendiente de documentar | `faf564af-5b67-4ba5-a052-7bf15b69407c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.465274810791016` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05982208251952` |
| `bearing` | `float64` | Pendiente de documentar | `315.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783695803` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-10 09:03:23-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-10T15:08:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T150819Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-10T15:08:19.857100` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.980792` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T150819Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-10T15:08:19.769759` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-10T15:02:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-10T15:26:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-41b82937-4433-431b-afaa-fdf8681ff54e-TTL24441700916003000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
