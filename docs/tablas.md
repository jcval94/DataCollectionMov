...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-20T20:10:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T201008Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784576724` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-20 19:45:24` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-20T20:42:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T204213Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:00:24` |
| `start_date` | `float64` | Pendiente de documentar | `20260720.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `306.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784580140` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T204213Z` |
| `entity_id` | `str` | Pendiente de documentar | `0420b68b-937f-47c8-bb4e-d3fb3f5afded` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.491491317749023` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13664245605467` |
| `bearing` | `float64` | Pendiente de documentar | `306.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `42.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784580140` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-20 14:42:20-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-20T18:27:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T182700Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-20T18:27:00.602122` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.4303135888501743` |
| `confidence` | `float64` | Pendiente de documentar | `0.903661` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 7, "freeFlowSpeed": 17, "currentTravelTime": 1395, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T182700Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-20T18:27:00.545873` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3623720203` |
| `lon` | `float64` | Pendiente de documentar | `-99.3489951546` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-20T18:25:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-20T18:45:30Z` |
...
| `event_codes` | `str` | Pendiente de documentar | `108` |
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3491198773, 19.3625986585], [-99.3491265828, 19.3625652084], [-99.3491239006` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24441700956011000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
