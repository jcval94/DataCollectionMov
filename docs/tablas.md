...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-30T22:02:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T220225Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782853650` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-30 21:07:30` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-30T22:42:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T224202Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:17:18` |
...
| `bearing` | `float64` | Pendiente de documentar | `309.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782859308` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T224202Z` |
| `entity_id` | `str` | Pendiente de documentar | `de55d89b-6a9e-4bc1-a937-c82bd0d716b6` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.464704513549805` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05901336669922` |
| `bearing` | `float64` | Pendiente de documentar | `309.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782859308` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-30 16:41:48-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
