...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T13:59:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T135926Z` |
...
| `start_time` | `str` | Pendiente de documentar | `13:34:53` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787147953` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T135926Z` |
| `entity_id` | `str` | Pendiente de documentar | `7e1bc7fe-d472-49b7-9ec7-64f02ada823d` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48043441772461` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10123443603516` |
| `bearing` | `float64` | Pendiente de documentar | `288.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787147953` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 07:59:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
