...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-30T23:42:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T234211Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-30T23:42:11.684761` |
...
| `current_travel_time_seconds` | `int64` | Pendiente de documentar | `2441` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.0008196721311475` |
| `confidence` | `float64` | Pendiente de documentar | `0.735331` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 4, "freeFlowSpeed": 8, "currentTravelTime": 2441, "freeFlowTravelTim` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T234211Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-30T23:42:11.558276` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-30T20:45:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-01T00:08:30Z` |
