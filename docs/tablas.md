...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T23:39:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T233946Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:32:58` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787096370` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T233946Z` |
| `entity_id` | `str` | Pendiente de documentar | `d2b47ce8-54c0-4d3c-bd1c-e9894e72835c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48491668701172` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11878204345705` |
| `bearing` | `float64` | Pendiente de documentar | `197.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `23.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787096370` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-18 17:39:30-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
