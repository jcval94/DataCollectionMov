...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T19:42:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T194229Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:41:30` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787082134` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T194229Z` |
| `entity_id` | `str` | Pendiente de documentar | `0144006a-0199-4892-86d8-b9e8b791c6c0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4648494720459` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05923461914062` |
| `bearing` | `float64` | Pendiente de documentar | `317.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `28.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787082134` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-18 13:42:14-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
