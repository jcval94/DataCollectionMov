...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T00:11:01Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T001044Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:24:58` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785283840` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T001044Z` |
| `entity_id` | `str` | Pendiente de documentar | `7197d83c-93ff-4080-a56d-a82cf18911e9` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.476890563964844` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0924301147461` |
| `bearing` | `float64` | Pendiente de documentar | `111.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `7.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785283840` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-28 18:10:40-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
