...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T19:16:37Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T191635Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787250369` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-20 18:26:09` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T19:01:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T190148Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:48:50` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787252498` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T190148Z` |
| `entity_id` | `str` | Pendiente de documentar | `5b5d0fda-1c28-4f64-a343-f72e75bf1fc8` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.481800079345703` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10479736328124` |
| `bearing` | `float64` | Pendiente de documentar | `119.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `15.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787252498` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-20 13:01:38-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T19:11:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T191116Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-20T19:11:17.374409` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.984139` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T191116Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-20T19:11:17.278036` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-20T19:09:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-20T19:29:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441700956015000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
