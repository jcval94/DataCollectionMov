...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-14T15:50:55Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T155052Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:43:12` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784044244` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260714T155052Z` |
| `entity_id` | `str` | Pendiente de documentar | `ebaf388a-d834-49fb-a03c-8cfceab10295` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49131202697754` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13549041748048` |
| `bearing` | `float64` | Pendiente de documentar | `292.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784044244` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-14 09:50:44-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
