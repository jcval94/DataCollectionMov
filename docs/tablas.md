...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T02:08:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T020820Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787277367` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-21 01:56:07` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T03:14:45Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T031441Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:58:56` |
...
| `bearing` | `float64` | Pendiente de documentar | `294.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787282070` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T031441Z` |
| `entity_id` | `str` | Pendiente de documentar | `95e3b48b-6b37-47e8-8618-b119e5bbf13f` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.468412399291992` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0842056274414` |
| `bearing` | `float64` | Pendiente de documentar | `294.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787282070` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-20 21:14:30-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T02:01:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T020111Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-21T02:01:11.668520` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.94871` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T020111Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-21T02:01:11.573705` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3760177502` |
| `lon` | `float64` | Pendiente de documentar | `-99.3420991952` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-21T00:28:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-21T02:19:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.341930216, 19.3780898097], [-99.3419530148, 19.3779047052], [-99.3419986124,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441701124019000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
