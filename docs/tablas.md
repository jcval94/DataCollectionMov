...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T05:03:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T050314Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787113601` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-19 04:26:41` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T04:50:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T045018Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:46:35` |
...
| `bearing` | `float64` | Pendiente de documentar | `295.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787115006` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T045018Z` |
| `entity_id` | `str` | Pendiente de documentar | `d72251c8-3c84-4172-8236-6d792a0ed22c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47056579589844` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06592559814452` |
| `bearing` | `float64` | Pendiente de documentar | `295.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `40.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787115006` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-18 22:50:06-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T14:12:34Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T141229Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-18T14:12:30.305649` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `376.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `429.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.266666666666667` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-12.354312354312356` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T141229Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-18T14:12:31.715230` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T141229Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-18T14:12:30.168062` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T141229Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-18T14:12:34.553547` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-14.860681114551088` |
...
| `delay_score` | `float64` | Pendiente de documentar | `0.0111019736842105` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0377252581078849` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `1.1430742411050678` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T04:55:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T045527Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-19T04:55:27.429892` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T045527Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-19T04:55:27.396217` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4251759753` |
| `lon` | `float64` | Pendiente de documentar | `-99.3446365649` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-19T04:36:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-19T05:14:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24433045636066000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
