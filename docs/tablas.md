...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T23:41:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T234144Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:24:31` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787355695` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T234144Z` |
| `entity_id` | `str` | Pendiente de documentar | `0cd36d31-119b-44b7-a209-291e26399e94` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.483747482299805` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11215209960938` |
| `bearing` | `float64` | Pendiente de documentar | `107.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `22.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787355695` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 17:41:35-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
