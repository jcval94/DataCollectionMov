...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-12T04:53:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260912T045314Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1789180461` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-12 02:34:21` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-12T04:31:24Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260912T043120Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:26:29` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789187466` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260912T043120Z` |
| `entity_id` | `str` | Pendiente de documentar | `bcdedc4e-fe00-4306-ab21-98845627d82a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.32402610778809` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11402893066406` |
| `bearing` | `float64` | Pendiente de documentar | `180.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789187466` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-11 22:31:06-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-12T04:43:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260912T044354Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-12T04:43:54.819979` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260912T044354Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-12T04:43:54.781099` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4310191603` |
| `lon` | `float64` | Pendiente de documentar | `-99.3424478824` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-12T04:27:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-12T05:02:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ad320136-f8e8-4f16-a113-574c85e74a9b-TTL24435930984050000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
