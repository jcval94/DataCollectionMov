...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T15:50:13Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T155009Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:49:37` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787327400` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T155009Z` |
| `entity_id` | `str` | Pendiente de documentar | `013c35a5-ca0e-43c0-9322-bd6ce0bcc8b8` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.13330078125` |
| `bearing` | `float64` | Pendiente de documentar | `287.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787327400` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 09:50:00-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
