...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-10T07:50:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T075031Z` |
...
| `start_time` | `str` | Pendiente de documentar | `06:52:59` |
...
| `bearing` | `float64` | Pendiente de documentar | `338.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783668029` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T075031Z` |
| `entity_id` | `str` | Pendiente de documentar | `43353838-adb6-47c2-9dc7-14a5635a12bf` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.479061126708984` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783668029` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-10 01:20:29-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
