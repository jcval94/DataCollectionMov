...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-06T23:41:29Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T234128Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `15` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783381103` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-06 23:38:23` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-07T04:15:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260707T041532Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:46:22` |
| `start_date` | `float64` | Pendiente de documentar | `20260707.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `116.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783397714` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260707T041532Z` |
| `entity_id` | `str` | Pendiente de documentar | `5f35d963-20bf-4000-bc5e-3c1600306c96` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48596572875977` |
| `longitude` | `float64` | Pendiente de documentar | `-99.12105560302734` |
| `bearing` | `float64` | Pendiente de documentar | `116.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `42.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783397714` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-06 22:15:14-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-06T23:35:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T233456Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-06T23:34:57.031240` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.990416` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T233456Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-06T23:34:56.964975` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4184503729` |
| `lon` | `float64` | Pendiente de documentar | `-99.3667071218` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-06T23:32:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-06T23:53:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3687469418, 19.415525379], [-99.3687295074, 19.4156809542], [-99.3687080497,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-d78aba7a-98dd-4e36-8e61-64835b4cc286-TTL24430159888202000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
