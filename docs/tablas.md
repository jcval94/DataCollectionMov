...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-30T20:31:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T203152Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782851461` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-30 20:31:01` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-30T19:12:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T191216Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:40:34` |
| `start_date` | `float64` | Pendiente de documentar | `20260630.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `192.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782846726` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T191216Z` |
| `entity_id` | `str` | Pendiente de documentar | `d6858303-f922-4926-aeff-5e305f0c2487` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.5076847076416` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19947814941406` |
| `bearing` | `float64` | Pendiente de documentar | `192.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `35.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782846726` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-30 13:12:06-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-30T20:26:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T202556Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-30T20:25:56.781072` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.8740399385560675` |
| `confidence` | `float64` | Pendiente de documentar | `0.897742` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 8, "freeFlowSpeed": 15, "currentTravelTime": 1220, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T202556Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-30T20:25:56.659311` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-30T19:05:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-30T20:44:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-0e6b35d1-b793-45b4-b4a5-22dc2fb82b8b-TTL24441700924011000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
