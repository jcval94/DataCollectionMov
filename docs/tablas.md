...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T20:58:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T205854Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787690989` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-25 20:49:49` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T22:47:27Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T224723Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:45:25` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787698030` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T22:47:28Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T224723Z` |
| `entity_id` | `str` | Pendiente de documentar | `228cdd37-46b9-43ba-ab36-200886ac3986` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.504119873046875` |
| `longitude` | `float64` | Pendiente de documentar | `-99.18428802490234` |
| `bearing` | `float64` | Pendiente de documentar | `278.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `16.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787698030` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-25 16:47:10-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T20:52:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T205222Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-25T20:52:22.714409` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T205222Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-25T20:52:22.604815` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4192121069` |
| `lon` | `float64` | Pendiente de documentar | `-99.3728641326` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-25T20:43:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-25T21:12:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3833301122, 19.4143854385], [-99.3832013661, 19.4146093955], [-99.3830793256` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-8bdb8a22-bc89-4292-91ed-a170049c774c-TTL24424388956034000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
