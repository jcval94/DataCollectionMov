...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T04:25:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T042549Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T07:34:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T073444Z` |
...
| `start_time` | `str` | Pendiente de documentar | `06:26:02` |
...
| `bearing` | `float64` | Pendiente de documentar | `337.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783061779` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T073444Z` |
| `entity_id` | `str` | Pendiente de documentar | `5e1e664e-0f10-45d6-990a-23ed81cb6a36` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478904724121094` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06375885009766` |
| `bearing` | `float64` | Pendiente de documentar | `337.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783061779` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-03 00:56:19-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T04:13:20Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T041316Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-03T04:13:17.006041` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.990026` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T041316Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-03T04:13:16.946538` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-07-03T04:44:00Z` |
