...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T05:35:39Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T053538Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786420303` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-11 03:51:43` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T04:38:42Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T043823Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:16:22` |
| `start_date` | `float64` | Pendiente de documentar | `20260811.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `665.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786422837` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T043823Z` |
| `entity_id` | `str` | Pendiente de documentar | `0d3f22f0-9abf-4164-a7bd-35de2616de31` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47812843322754` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06383514404295` |
| `bearing` | `float64` | Pendiente de documentar | `665.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786422837` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-10 22:33:57-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-10T14:37:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T143722Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-10T14:37:22.425152` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-11.89931350114416` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T143722Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-10T14:37:23.772070` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T143722Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-10T14:37:22.193684` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T143722Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-10T14:37:26.705549` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `487.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `540.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `8.116666666666667` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-9.81481481481481` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.8833333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-9.81481481481481` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0400996828273674` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0260223048327137` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0754986104134426` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `4.22523860464537` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T13:49:43Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T134940Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-11T13:49:40.543001` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.916535` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T134940Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-11T13:49:40.477262` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4189720298` |
| `lon` | `float64` | Pendiente de documentar | `-99.3649542982` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-11T12:54:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-11T14:09:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3446928913, 19.4252497268], [-99.3451019282, 19.4250914732], [-99.3456437344` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24430159956042000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
