...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T22:39:40Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T223935Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:52:12` |
...
| `bearing` | `float64` | Pendiente de documentar | `303.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782254362` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T223935Z` |
| `entity_id` | `str` | Pendiente de documentar | `18961d3f-e03c-4e8c-a08f-beee7e5edbd0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.464893341064453` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05938720703124` |
| `bearing` | `float64` | Pendiente de documentar | `303.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `22.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782254362` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-23 16:39:22-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
