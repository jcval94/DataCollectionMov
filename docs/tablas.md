...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T23:52:55Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T235254Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `8` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `7` |
| `num_docks_available` | `int64` | Pendiente de documentar | `24` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782949427` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-01 23:43:47` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T23:45:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T234550Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:16:11` |
| `start_date` | `float64` | Pendiente de documentar | `20260701.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `286.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782949534` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T23:45:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T234550Z` |
| `entity_id` | `str` | Pendiente de documentar | `afc2a105-8069-4d7f-ac97-c25108e771b6` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48331642150879` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10920715332033` |
| `bearing` | `float64` | Pendiente de documentar | `286.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `48.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782949534` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-01 17:45:34-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T16:06:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T160640Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-01T16:06:40.445489` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `393.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `444.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.55` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-11.486486486486491` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T160640Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-01T16:06:41.789086` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T160640Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-01T16:06:40.335639` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T160640Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-01T16:06:44.697414` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `552.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `493.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `9.2` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `11.967545638945245` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `0.9833333333333332` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `11.967545638945245` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0413201663201663` |
| `delay_score` | `float64` | Pendiente de documentar | `0.1924072476272648` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.5336508360850127` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `19.26667787306201` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T23:49:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T234926Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-01T23:49:26.927341` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.999941` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T234926Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-01T23:49:26.812817` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-01T23:06:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-02T00:07:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-0e6b35d1-b793-45b4-b4a5-22dc2fb82b8b-TTL24441700928019000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
