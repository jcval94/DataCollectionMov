...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T15:31:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T153107Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `25` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `5` |
| `num_docks_available` | `int64` | Pendiente de documentar | `9` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783956584` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-13 15:29:44` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T17:24:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T172406Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:20:39` |
| `start_date` | `float64` | Pendiente de documentar | `20260713.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `122.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `7.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783963433` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T172406Z` |
| `entity_id` | `str` | Pendiente de documentar | `a0a898ac-baee-4b2a-85cc-45f94f7506a3` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.486629486083984` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1230239868164` |
| `bearing` | `float64` | Pendiente de documentar | `122.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `7.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `25.2` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783963433` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-13 11:23:53-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T16:05:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T160502Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-13T16:05:03.140658` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `395.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `444.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.583333333333333` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `7.4` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-49.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.8166666666666667` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-11.036036036036034` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T160502Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-13T16:05:04.484901` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T160502Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-13T16:05:03.036654` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T160502Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-13T16:05:07.228055` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `604.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `493.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `10.066666666666666` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.216666666666667` |
| `delay_seconds` | `float64` | Pendiente de documentar | `111.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `1.85` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `22.515212981744416` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `1.85` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `22.515212981744416` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0633717404487568` |
| `delay_score` | `float64` | Pendiente de documentar | `0.2058047493403694` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.7100427329396103` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `24.255749205899196` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T15:18:27Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T151823Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-13T15:18:24.105216` |
...
| `current_travel_time_seconds` | `int64` | Pendiente de documentar | `697` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.2859778597785978` |
| `confidence` | `float64` | Pendiente de documentar | `0.987622` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 14, "freeFlowSpeed": 18, "currentTravelTime": 697, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T151823Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-13T15:18:24.042473` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3613621876` |
| `lon` | `float64` | Pendiente de documentar | `-99.3502718861` |
| `icon_category` | `int64` | Pendiente de documentar | `6` |
| `icon_category_desc` | `str` | Categoria legible del incidente. | `Jam` |
| `magnitude_of_delay` | `int64` | Pendiente de documentar | `1` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-13T15:14:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-13T15:37:00Z` |
| `last_report_time` | `float64` | Ultimo reporte del incidente segun TomTom. | `2026-06-04T13:30:00Z` |
| `event_descriptions` | `str` | Pendiente de documentar | `Tráfico lento` |
| `event_codes` | `int64` | Pendiente de documentar | `115` |
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3513259942, 19.3609732777], [-99.3512321169, 19.3609906751], [-99.3511221463` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24441700920019000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
