...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-07T17:46:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T174558Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:14:18` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788800557` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T174558Z` |
| `entity_id` | `str` | Pendiente de documentar | `9392303f-2a80-408b-b994-a22ac021c3e9` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46473693847656` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05921173095705` |
| `bearing` | `float64` | Pendiente de documentar | `316.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788800557` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-07 11:02:37-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
