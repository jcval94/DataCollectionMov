...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T16:48:55Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T164837Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:43:32` |
...
| `bearing` | `float64` | Pendiente de documentar | `141.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784825314` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T164837Z` |
| `entity_id` | `str` | Pendiente de documentar | `68029adb-c240-4d68-85d0-800b5c7d701a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.505659103393555` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19078063964844` |
| `bearing` | `float64` | Pendiente de documentar | `141.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784825314` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-23 10:48:34-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
