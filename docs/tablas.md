...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T18:41:49Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T184146Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:42:43` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784659289` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T184146Z` |
| `entity_id` | `str` | Pendiente de documentar | `d7db2c0b-0511-475b-9e95-bb5c35afe59a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.50500869750977` |
| `longitude` | `float64` | Pendiente de documentar | `-99.18890380859376` |
| `bearing` | `float64` | Pendiente de documentar | `305.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784659289` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-21 12:41:29-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
