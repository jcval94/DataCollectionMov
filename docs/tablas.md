...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-10T04:58:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260610T045852Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1781061206` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-10 03:13:26` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-10T16:10:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260610T161039Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:47:32` |
| `start_date` | `float64` | Pendiente de documentar | `20260610.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `283.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781107838` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260610T161039Z` |
| `entity_id` | `str` | Pendiente de documentar | `296c4c40-96e0-4713-b1e1-ed8ec06a3c67` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48293876647949` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10742950439452` |
| `bearing` | `float64` | Pendiente de documentar | `283.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `26.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781107838` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-10 10:10:38-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-10T16:13:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260610T161321Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-10T16:13:22.221418` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.99551` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260610T161321Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-10T16:13:22.115349` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-10T16:11:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-10T16:31:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-208c1abc-26cd-42ed-a876-d2f71f564b3d-TTL24441700956011000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
