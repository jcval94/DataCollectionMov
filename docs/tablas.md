...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-24T23:45:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T234556Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782344375` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-24 23:39:35` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-25T04:32:42Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T043238Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:59:27` |
...
| `bearing` | `float64` | Pendiente de documentar | `146.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `43.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782361941` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260625T043238Z` |
| `entity_id` | `str` | Pendiente de documentar | `522deac3-8f26-4ebd-bfce-299256d8712a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.470752716064453` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0664291381836` |
| `bearing` | `float64` | Pendiente de documentar | `146.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `43.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `154.8` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782361941` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-24 22:32:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-24T23:39:01Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T233856Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-24T23:38:57.581027` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.6670081967213115` |
| `confidence` | `float64` | Pendiente de documentar | `0.703221` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 6, "freeFlowSpeed": 10, "currentTravelTime": 1627, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T233856Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-24T23:38:57.455768` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3624095825` |
| `lon` | `float64` | Pendiente de documentar | `-99.3482642526` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-24T23:20:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-24T23:57:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3474180157, 19.3626590742], [-99.3474877531, 19.3626550412], [-99.3477720673` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-19ee81bd-39c4-4110-b867-271d942821dd-TTL24444586464012000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
