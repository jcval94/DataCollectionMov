...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-16T17:11:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T171110Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-16T17:11:10.793492` |
...
| `free_flow_travel_time_seconds` | `int64` | Pendiente de documentar | `751` |
| `delay_seconds` | `int64` | Diferencia entre tiempo actual y tiempo libre. | `120` |
| `delay_ratio` | `float64` | Pendiente de documentar | `1.181091877496671` |
| `confidence` | `float64` | Pendiente de documentar | `0.584834` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 11, "freeFlowSpeed": 13, "currentTravelTime": 887, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T171110Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-16T17:11:10.722685` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-09-16T17:30:00Z` |
