...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T20:55:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T205509Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787345273` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-21 20:47:53` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T22:44:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T224404Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:39:46` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787352235` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T224404Z` |
| `entity_id` | `str` | Pendiente de documentar | `4a5bcf04-f689-42bc-ac8c-d7d8f06ec61a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4732723236084` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06880950927734` |
| `bearing` | `float64` | Pendiente de documentar | `324.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `12.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787352235` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 16:43:55-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T20:45:56Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T204551Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-21T20:45:52.735895` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `3.334016393442623` |
| `confidence` | `float64` | Pendiente de documentar | `0.987095` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 6, "freeFlowSpeed": 20, "currentTravelTime": 1627, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T204551Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-21T20:45:52.255548` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3352629997` |
| `lon` | `float64` | Pendiente de documentar | `-99.3652024025` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-21T20:36:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-21T21:04:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3668197746, 19.3319638261], [-99.3668237979, 19.3320201403], [-99.3668425734` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441700480035000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
