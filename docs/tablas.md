...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-09T08:01:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T080153Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `0` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `30` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783566499` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-09 03:08:19` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-09T15:35:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T153520Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:24:27` |
...
| `bearing` | `float64` | Pendiente de documentar | `315.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783611300` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T153520Z` |
| `entity_id` | `str` | Pendiente de documentar | `ad717832-97f6-4b80-a2db-a4cb7b7b4de3` |
| `trip_id` | `float64` | Pendiente de documentar | `` |
| `route_id` | `float64` | Pendiente de documentar | `19475.0` |
| `direction_id` | `float64` | Pendiente de documentar | `1.0` |
| `start_time` | `str` | Pendiente de documentar | `15:24:27` |
| `start_date` | `float64` | Pendiente de documentar | `20260709.0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46525382995605` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05979919433594` |
| `bearing` | `float64` | Pendiente de documentar | `315.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783611300` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-09 09:35:00-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-09T08:01:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T080112Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-09T08:01:12.522377` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T080112Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-09T08:01:12.484009` |
...
| `lat` | `float64` | Pendiente de documentar | `19.347778183` |
| `lon` | `float64` | Pendiente de documentar | `-99.306345349` |
...
| `road_numbers` | `str` | Pendiente de documentar | `MEX-15,MEX-57D` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-22T03:02:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-09T08:56:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3055554385, 19.3492010805], [-99.3055648262, 19.3491970471], [-99.3057150299` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-41b82937-4433-431b-afaa-fdf8681ff54e-TTR24456128044052000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
