...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-05T07:15:29Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T071528Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `0` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `14` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785910277` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-05 06:11:17` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-05T06:40:29Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T064025Z` |
...
| `start_time` | `str` | Pendiente de documentar | `05:58:41` |
...
| `bearing` | `float64` | Pendiente de documentar | `639.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785911017` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T064025Z` |
| `entity_id` | `str` | Pendiente de documentar | `6d01a855-a6db-440f-844f-01a182de021f` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47826766967773` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06388854980467` |
| `bearing` | `float64` | Pendiente de documentar | `639.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785911017` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-05 00:23:37-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-05T14:42:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T144242Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-05T14:42:43.208725` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.3327868852459015` |
| `confidence` | `float64` | Pendiente de documentar | `0.925706` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 12, "freeFlowSpeed": 16, "currentTravelTime": 813, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T144242Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-05T14:42:43.110080` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-05T13:59:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-05T15:01:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ec25b321-e5cd-4e06-8756-a264821e8718-TTL24433045572266000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
