...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-11T21:14:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T211408Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1789160751` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-11 21:05:51` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-11T21:14:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T211408Z` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-11T22:37:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T223742Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:25:35` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789166243` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T223742Z` |
| `entity_id` | `str` | Pendiente de documentar | `b591d21a-35c9-49cf-817d-4a3e8b041752` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4760684967041` |
| `longitude` | `float64` | Pendiente de documentar | `-99.099365234375` |
| `bearing` | `float64` | Pendiente de documentar | `200.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789166243` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-11 16:37:23-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
