...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T16:47:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T164742Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:34:21` |
...
| `bearing` | `float64` | Pendiente de documentar | `332.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786985255` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T164742Z` |
| `entity_id` | `str` | Pendiente de documentar | `a93982d2-79e1-436e-992d-bfe73c82f904` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.470802307128903` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0860824584961` |
| `bearing` | `float64` | Pendiente de documentar | `332.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `58.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786985255` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 10:47:35-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
