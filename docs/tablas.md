...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-05T16:54:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T165418Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:32:28` |
...
| `bearing` | `float64` | Pendiente de documentar | `288.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785948844` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260805T165418Z` |
| `entity_id` | `str` | Pendiente de documentar | `d0c5de90-02a9-4cfa-82b9-3f93fa92f8e1` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47883033752441` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09719848632812` |
| `bearing` | `float64` | Pendiente de documentar | `288.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785948844` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-05 10:54:04-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
