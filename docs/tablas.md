...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-29T23:37:57Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T233755Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782775827` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-29 23:30:27` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-30T01:26:34Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T012631Z` |
...
| `start_time` | `str` | Pendiente de documentar | `01:05:21` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782782770` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260630T012631Z` |
| `entity_id` | `str` | Pendiente de documentar | `e643b9a8-03c6-49d2-8a72-075db60d1e23` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.491947174072266` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1393814086914` |
| `bearing` | `float64` | Pendiente de documentar | `100.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `5.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782782770` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-29 19:26:10-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-29T23:31:57Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T233153Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-29T23:31:53.725099` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.988599` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260629T233153Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-29T23:31:53.624412` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-29T23:21:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-29T23:50:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-d78aba7a-98dd-4e36-8e61-64835b4cc286-TTL24441700956011000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
