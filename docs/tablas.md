...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-25T00:45:43Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T004542Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1790296600` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-25 00:36:40` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-24T23:54:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260924T235402Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:53:32` |
| `start_date` | `float64` | Pendiente de documentar | `20260924.0` |
...
| `speed_mps` | `float64` | Pendiente de documentar | `59.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790294027` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260924T235402Z` |
| `entity_id` | `str` | Pendiente de documentar | `3b86e634-ccd4-461a-aed2-5f98bc232b06` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46585464477539` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06124114990234` |
| `bearing` | `float64` | Pendiente de documentar | `292.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `59.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `212.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790294027` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-24 17:53:47-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-25T00:38:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T003848Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-25T00:38:49.334578` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.98886` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T003848Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-25T00:38:49.212065` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-24T23:59:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-25T00:57:02Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-54cec490-cc44-44e3-a958-ad290dd1e9c9-TTL24441700944011000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
