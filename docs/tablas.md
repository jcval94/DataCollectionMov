...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T07:08:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T070856Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `0` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `16` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784607108` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-21 04:11:48` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T14:25:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T142522Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:24:05` |
| `start_date` | `float64` | Pendiente de documentar | `20260721.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `798.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `12.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784643905` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T142522Z` |
| `entity_id` | `str` | Pendiente de documentar | `5ffbd9ae-56e9-4128-8bf7-97fd26a0aadf` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.51154136657715` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19756317138672` |
| `bearing` | `float64` | Pendiente de documentar | `798.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `12.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `43.2` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784643905` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-21 08:25:05-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-20T15:29:31Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T152926Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-20T15:29:26.730445` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `377.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `441.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.283333333333333` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `7.35` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-64.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-1.0666666666666669` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-14.512471655328795` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T152926Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-20T15:29:28.132956` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T152926Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-20T15:29:26.622764` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T152926Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-20T15:29:30.995097` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `766.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `493.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `12.766666666666667` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.216666666666667` |
| `delay_seconds` | `float64` | Pendiente de documentar | `273.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `4.55` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `55.37525354969575` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `4.55` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `55.37525354969575` |
| `duration_score` | `float64` | Pendiente de documentar | `0.1135766423357664` |
| `delay_score` | `float64` | Pendiente de documentar | `0.343144848954299` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `1.0` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `37.12101861850996` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-21T06:44:27Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T064423Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-21T06:44:24.216423` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260721T064423Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-21T06:44:24.153416` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3036758965` |
| `lon` | `float64` | Pendiente de documentar | `-99.346818542` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-21T06:41:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-21T06:56:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3451260681, 19.3068033502], [-99.3455190117, 19.3063072017], [-99.3457993025` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24453242148008000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
