...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-09T18:23:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260609T182250Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:38:35` |
...
| `bearing` | `float64` | Pendiente de documentar | `156.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781029232` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260609T182250Z` |
| `entity_id` | `str` | Pendiente de documentar | `b8d55352-8a84-4b43-9f3a-8e90bd360045` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.06356048583984` |
| `bearing` | `float64` | Pendiente de documentar | `156.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781029232` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-09 12:20:32-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
