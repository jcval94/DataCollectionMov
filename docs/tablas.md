...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-03T21:17:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T211746Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788470008` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-03 21:13:28` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-03T22:37:20Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T223717Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:20:26` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788475020` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T223717Z` |
| `entity_id` | `str` | Pendiente de documentar | `9f70b595-f9e8-4312-8565-f2bbda3a64b7` |
| `trip_id` | `float64` | Pendiente de documentar | `` |
| `route_id` | `float64` | Pendiente de documentar | `19494.0` |
| `direction_id` | `float64` | Pendiente de documentar | `0.0` |
| `start_time` | `str` | Pendiente de documentar | `22:20:26` |
| `start_date` | `float64` | Pendiente de documentar | `20260903.0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.482833862304688` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10723876953124` |
| `bearing` | `float64` | Pendiente de documentar | `100.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `10.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788475020` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-03 16:37:00-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `route_color` | `str` | Pendiente de documentar | `D40D0D` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-03T21:10:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T211038Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-03T21:10:38.631376` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.987357` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T211038Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-03T21:10:38.538094` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2891517356` |
| `lon` | `float64` | Pendiente de documentar | `-99.3643025214` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-03T20:25:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-03T21:30:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3678188974, 19.2850694165], [-99.3677732999, 19.2850761413], [-99.3676526005` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4f54caf4-b222-4646-895c-ec863c842a32-TTL24450356156063000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
