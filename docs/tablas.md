...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T22:06:45Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T220635Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:04:18` |
...
| `bearing` | `float64` | Pendiente de documentar | `223.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786485989` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T220635Z` |
| `entity_id` | `str` | Pendiente de documentar | `209057d0-1ec3-4f21-82d9-db2611d8e0da` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49052619934082` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13573455810548` |
| `bearing` | `float64` | Pendiente de documentar | `223.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786485989` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-11 16:06:29-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
