...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T20:01:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T200142Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783970810` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-13 19:26:50` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T19:51:42Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T195139Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:25:55` |
...
| `bearing` | `float64` | Pendiente de documentar | `289.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783972292` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T195139Z` |
| `entity_id` | `str` | Pendiente de documentar | `5d83d240-a654-4755-9ad8-24056e3a0002` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48205947875977` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10525512695312` |
| `bearing` | `float64` | Pendiente de documentar | `289.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783972292` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-13 13:51:32-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T19:55:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T195555Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-13T19:55:55.415544` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `3.1653696498054478` |
| `confidence` | `float64` | Pendiente de documentar | `0.958637` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 6, "freeFlowSpeed": 19, "currentTravelTime": 1627, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T195555Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-13T19:55:55.353504` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-13T18:51:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-13T20:14:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24441700924019000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
