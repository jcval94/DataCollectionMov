...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-12T00:34:56Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260912T003455Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1789173021` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-12 00:30:21` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-12T01:10:04Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260912T011002Z` |
...
| `start_time` | `str` | Pendiente de documentar | `00:54:22` |
| `start_date` | `float64` | Pendiente de documentar | `20260912.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `203.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789175381` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260912T011002Z` |
| `entity_id` | `str` | Pendiente de documentar | `3cc6f2a6-de68-4ca8-bf58-f0a9dd4bf80d` |
| `trip_id` | `float64` | Pendiente de documentar | `` |
| `route_id` | `float64` | Pendiente de documentar | `20211.0` |
| `direction_id` | `float64` | Pendiente de documentar | `0.0` |
| `start_time` | `str` | Pendiente de documentar | `00:54:22` |
| `start_date` | `float64` | Pendiente de documentar | `20260912.0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47240829467773` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10090637207033` |
| `bearing` | `float64` | Pendiente de documentar | `203.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `50.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789175381` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-11 19:09:41-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `route_color` | `str` | Pendiente de documentar | `141982` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-11T17:06:12Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T170608Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-11T17:06:08.588826` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `441.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `421.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `7.35` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `4.750593824228022` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T170608Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-11T17:06:09.830123` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T170608Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-11T17:06:08.502172` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T170608Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-11T17:06:12.287204` |
...
| `delay_seconds` | `float64` | Pendiente de documentar | `40.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `0.6666666666666666` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `8.298755186721984` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `0.6666666666666666` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `8.298755186721984` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0195244055068835` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0490848585690515` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.2464932996714926` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `7.52643429115642` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-12T00:25:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260912T002517Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-12T00:25:18.402000` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.982347` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260912T002517Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-12T00:25:18.312544` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-11T23:59:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-12T00:43:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ad320136-f8e8-4f16-a113-574c85e74a9b-TTL24441700916027000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
