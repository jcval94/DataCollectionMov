...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-09T01:04:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T010400Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:50:21` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783559021` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T010400Z` |
| `entity_id` | `str` | Pendiente de documentar | `dd5690fb-3b55-4c5a-84fd-080fc46992ee` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.466812133789062` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06159973144533` |
| `bearing` | `float64` | Pendiente de documentar | `132.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783559021` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-08 19:03:41-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
