...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-09T16:52:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260909T165246Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788967831` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-09 15:30:31` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-09T19:48:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260909T194759Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:45:34` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788983277` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260909T194759Z` |
| `entity_id` | `str` | Pendiente de documentar | `27ef32e8-9d1e-4c41-9b72-f0936ec1c18c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.468965530395508` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06401824951172` |
| `bearing` | `float64` | Pendiente de documentar | `304.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `6.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788983277` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-09 13:47:57-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-09T21:02:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260909T210213Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-09T21:02:14.439874` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.995872` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260909T210213Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-09T21:02:14.332818` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-09T19:10:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-09T21:27:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ad320136-f8e8-4f16-a113-574c85e74a9b-TTL24441700944011000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
