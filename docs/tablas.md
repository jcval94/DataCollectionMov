...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-15T21:33:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T213305Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-15T21:33:05.996855` |
...
| `free_flow_travel_time_seconds` | `int64` | Pendiente de documentar | `1085` |
| `delay_seconds` | `int64` | Diferencia entre tiempo actual y tiempo libre. | `120` |
| `delay_ratio` | `float64` | Pendiente de documentar | `1.8` |
| `confidence` | `float64` | Pendiente de documentar | `0.697222` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 5, "freeFlowSpeed": 9, "currentTravelTime": 1953, "freeFlowTravelTim` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T213305Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-15T21:33:05.899261` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-15T19:53:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-15T21:51:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3e4a0d0f-4280-4c32-855f-d24afaed7dea-TTL24441700980014000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
