...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T15:07:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T150747Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:47:40` |
...
| `bearing` | `float64` | Pendiente de documentar | `330.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787670465` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T150747Z` |
| `entity_id` | `str` | Pendiente de documentar | `2bc36cb2-0542-44e9-9b32-480438c249cc` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.474454879760746` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787670465` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-25 09:07:45-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
