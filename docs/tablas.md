...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-06T22:00:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T220013Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783375183` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-06 21:59:43` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-06T21:02:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T210215Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:56:32` |
...
| `bearing` | `float64` | Pendiente de documentar | `145.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783371723` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T210215Z` |
| `entity_id` | `str` | Pendiente de documentar | `51768455-5ada-408f-b2db-e68f19f55e4e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.505565643310547` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19068145751952` |
| `bearing` | `float64` | Pendiente de documentar | `145.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `47.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783371723` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-06 15:02:03-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-06T21:54:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T215404Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-06T21:54:04.603889` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.986347` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260706T215404Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-06T21:54:04.520537` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2977361409` |
| `lon` | `float64` | Pendiente de documentar | `-99.366414761` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-06T21:24:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-06T22:50:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-d78aba7a-98dd-4e36-8e61-64835b4cc286-TTL24447470880009001", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
