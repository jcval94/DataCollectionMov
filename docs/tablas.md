...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-25T21:48:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T214805Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1790372883` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-25 21:48:03` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-25T23:58:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T235800Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:25:16` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790380675` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T235800Z` |
| `entity_id` | `str` | Pendiente de documentar | `0f34f7ff-9e4e-42da-abd6-e2b760e3eaf9` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.485315322875977` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11936950683594` |
| `bearing` | `float64` | Pendiente de documentar | `112.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `15.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790380675` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-25 17:57:55-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-26T00:43:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260926T004313Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-26T00:43:14.023889` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.984253` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260926T004313Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-26T00:43:13.924948` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4187024664` |
| `lon` | `float64` | Pendiente de documentar | `-99.3663691635` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-26T00:22:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-26T01:02:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3425605351, 19.4306610864], [-99.3425551707, 19.4304760417], [-99.3425122554` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-54cec490-cc44-44e3-a958-ad290dd1e9c9-TTL24435931204442000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
