...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T15:34:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T153440Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786462095` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-11 15:28:15` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T16:14:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T161357Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:54:06` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786464831` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T16:14:01Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T161357Z` |
| `entity_id` | `str` | Pendiente de documentar | `462d4464-0080-499e-a3c0-a9cbc2f11717` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47865104675293` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09709167480467` |
| `bearing` | `float64` | Pendiente de documentar | `114.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786464831` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-11 10:13:51-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-11T15:27:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T152717Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-11T15:27:18.319228` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.938223` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260811T152717Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-11T15:27:18.227387` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-11T14:58:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-11T15:54:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24441700920003000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
