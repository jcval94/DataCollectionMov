...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-23T21:44:06Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T214405Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1790196863` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-23 20:54:23` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-23T20:26:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T202600Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:35:06` |
...
| `bearing` | `float64` | Pendiente de documentar | `255.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790195146` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T202600Z` |
| `entity_id` | `str` | Pendiente de documentar | `56b00c24-2987-4ae1-a763-3c41cf85d5dd` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.490379333496094` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13558959960938` |
| `bearing` | `float64` | Pendiente de documentar | `255.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `7.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790195146` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-23 14:25:46-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-23T21:37:29Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T213724Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-23T21:37:25.533220` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.965728` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T213724Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-23T21:37:25.416507` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-23T21:14:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-23T21:55:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-54cec490-cc44-44e3-a958-ad290dd1e9c9-TTL24441700956015000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
