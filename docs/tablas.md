...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T00:00:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T000050Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:54:33` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786665632` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T000050Z` |
| `entity_id` | `str` | Pendiente de documentar | `0ce0ee45-8895-41b0-af3f-de584608ed25` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.473989486694336` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0694808959961` |
| `bearing` | `float64` | Pendiente de documentar | `316.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786665632` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-13 18:00:32-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
