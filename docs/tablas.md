...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-25T04:54:13Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T045409Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:45:40` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790312039` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260925T045409Z` |
| `entity_id` | `str` | Pendiente de documentar | `ba0472ae-e946-4e9b-bdc9-04341bd95be4` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.479400634765625` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790312039` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-24 22:53:59-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
