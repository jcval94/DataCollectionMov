...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-26T14:48:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T144846Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:40:16` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782485313` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260626T144846Z` |
| `entity_id` | `str` | Pendiente de documentar | `0e7b4bc5-ba33-4788-9bb8-bdf233b1a785` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.504796981811523` |
| `longitude` | `float64` | Pendiente de documentar | `-99.18873596191406` |
| `bearing` | `float64` | Pendiente de documentar | `105.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782485313` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-26 08:48:33-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
