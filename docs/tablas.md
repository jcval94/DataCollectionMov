...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T21:45:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T214530Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `35` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `3` |
| `num_docks_available` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783547092` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-08 21:44:52` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T22:18:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T221804Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:30:29` |
| `start_date` | `float64` | Pendiente de documentar | `20260708.0` |
...
| `speed_mps` | `float64` | Pendiente de documentar | `39.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783549077` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T221804Z` |
| `entity_id` | `str` | Pendiente de documentar | `f4485eec-ca72-4e0a-bcf3-3825c0fd5ec8` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478042602539062` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09564971923828` |
| `bearing` | `float64` | Pendiente de documentar | `111.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `39.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `140.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783549077` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-08 16:17:57-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
