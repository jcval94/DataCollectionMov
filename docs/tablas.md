...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T19:14:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T191412Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786993963` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-17 19:12:43` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T20:51:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T205123Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:16:59` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786999873` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T205123Z` |
| `entity_id` | `str` | Pendiente de documentar | `cf95a3d6-2c64-441c-b27d-f701f8756047` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.470233917236328` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06539154052734` |
| `bearing` | `float64` | Pendiente de documentar | `135.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786999873` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 14:51:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T20:50:12Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T205008Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-17T20:50:09.302402` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.996985` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T205008Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-17T20:50:09.034253` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-17T19:42:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-17T21:08:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441700924011001", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
