...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T14:23:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T142346Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784125217` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-15 14:20:17` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T15:53:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T155259Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:30:54` |
...
| `bearing` | `float64` | Pendiente de documentar | `297.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `29.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784130764` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T155259Z` |
| `entity_id` | `str` | Pendiente de documentar | `bd45d217-d8d3-4810-81ca-b20994eb197f` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47964859008789` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09922790527344` |
| `bearing` | `float64` | Pendiente de documentar | `297.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `29.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `104.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784130764` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-15 09:52:44-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
