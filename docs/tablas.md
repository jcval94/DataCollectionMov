...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T02:00:20Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T020020Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787190774` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-20 01:52:54` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T03:09:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T030908Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:02:56` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787195342` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T030908Z` |
| `entity_id` | `str` | Pendiente de documentar | `bb23eac2-7f8b-4069-9264-919fc00fb177` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.464984893798828` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0595932006836` |
| `bearing` | `float64` | Pendiente de documentar | `130.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787195342` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 21:09:02-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
