...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-17T05:15:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260617T051520Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:36:25` |
...
| `bearing` | `float64` | Pendiente de documentar | `348.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781673313` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260617T051520Z` |
| `entity_id` | `str` | Pendiente de documentar | `73b5486e-4c7c-4b32-ae8d-441cfc5260fc` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47945785522461` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781673313` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-16 23:15:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
