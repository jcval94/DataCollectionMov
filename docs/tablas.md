...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T03:11:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T031138Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:05:22` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787627483` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T031138Z` |
| `entity_id` | `str` | Pendiente de documentar | `11bae216-0a5c-415a-8e53-d4d3095f35e0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47980690002441` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0752410888672` |
| `bearing` | `float64` | Pendiente de documentar | `312.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787627483` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-24 21:11:23-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-25T03:15:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T031514Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-25T03:15:14.255220` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-25` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260825T031514Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-25T03:15:14.219311` |
...
| `lat` | `float64` | Pendiente de documentar | `19.397716888` |
| `lon` | `float64` | Pendiente de documentar | `-99.3113396222` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-22T02:51:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-25T04:00:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3114670271, 19.3972367491], [-99.3114536161, 19.3972461574], [-99.3114415461` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-8bdb8a22-bc89-4292-91ed-a170049c774c-TTR24450357896020000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
