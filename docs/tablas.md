...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-02T04:20:13Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260702T042010Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:50:26` |
...
| `bearing` | `float64` | Pendiente de documentar | `282.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `4.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782966004` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260702T042010Z` |
| `entity_id` | `str` | Pendiente de documentar | `377c01ec-4e4e-4baf-86ec-58e4829a09dd` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.484113693237305` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11311340332033` |
| `bearing` | `float64` | Pendiente de documentar | `282.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `4.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `14.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782966004` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-01 22:20:04-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
