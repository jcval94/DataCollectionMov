...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-24T21:41:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T214116Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784928980` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-24 21:36:20` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-24T23:18:06Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T231802Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:10:14` |
...
| `bearing` | `float64` | Pendiente de documentar | `340.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784904973` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T231802Z` |
| `entity_id` | `str` | Pendiente de documentar | `d6d3e3df-14a5-42c0-915f-5ec9ad1c2341` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47907829284668` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784904973` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-24 08:56:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-24T21:34:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T213401Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-24T21:34:01.533827` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.994342` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T213401Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-24T21:34:01.420795` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-24T20:06:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-24T22:11:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24441700920011001", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
