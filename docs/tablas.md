...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T13:54:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T135449Z` |
...
| `start_time` | `str` | Pendiente de documentar | `13:36:09` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786974883` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T135449Z` |
| `entity_id` | `str` | Pendiente de documentar | `1e750bc7-3c6a-49dc-83d5-b753dc85f0e3` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47708511352539` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09288787841795` |
| `bearing` | `float64` | Pendiente de documentar | `292.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `3.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786974883` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 07:54:43-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
