...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-13T19:39:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T193914Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786649153` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-13 19:25:53` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-13T21:05:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T210529Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:53:14` |
...
| `bearing` | `float64` | Pendiente de documentar | `323.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786654951` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T210529Z` |
| `entity_id` | `str` | Pendiente de documentar | `3dcf1d8e-838d-45af-8626-9b1a012252dd` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47994041442871` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0753402709961` |
| `bearing` | `float64` | Pendiente de documentar | `323.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `2.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786654951` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-13 15:02:31-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-13T19:31:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T193150Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-13T19:31:50.682614` |
...
| `current_travel_time_seconds` | `int64` | Pendiente de documentar | `3255` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `5.336065573770492` |
| `confidence` | `float64` | Pendiente de documentar | `0.891267` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 3, "freeFlowSpeed": 16, "currentTravelTime": 3255, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T193150Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-13T19:31:50.618313` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3613179035` |
| `lon` | `float64` | Pendiente de documentar | `-99.347935682` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-13T18:53:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-13T19:57:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3456236178, 19.3616585745], [-99.3457094485, 19.3616505085], [-99.3458636755` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24441700996022000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
