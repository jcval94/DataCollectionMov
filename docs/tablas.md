...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-03T04:54:28Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T045427Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788406626` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-03 03:37:06` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-03T04:20:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T042023Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:14:20` |
| `start_date` | `float64` | Pendiente de documentar | `20260903.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `478.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788409207` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T042023Z` |
| `entity_id` | `str` | Pendiente de documentar | `ef226f29-e0a6-4d15-ab4c-098c8c216dc5` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.476226806640625` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06983947753906` |
| `bearing` | `float64` | Pendiente de documentar | `478.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `22.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788409207` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-02 22:20:07-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-02T17:15:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T171540Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-02T17:15:40.614971` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `429.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `429.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `7.15` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T171540Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-02T17:15:41.979797` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T171540Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-02T17:15:40.498913` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T171540Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-02T17:15:44.801677` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `571.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `484.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `9.516666666666667` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `17.975206611570236` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `1.45` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `17.975206611570236` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0397759103641456` |
| `delay_score` | `float64` | Pendiente de documentar | `0.2338624338624338` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.6759382693765087` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `23.49386653910192` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-03T04:41:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T044103Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-03T04:41:04.037909` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T044103Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-03T04:41:03.983915` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3324801445` |
| `lon` | `float64` | Pendiente de documentar | `-99.3142659122` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-03T04:38:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-03T05:08:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3146870191, 19.3319262569], [-99.3146360571, 19.3319879494], [-99.3146320338` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4f54caf4-b222-4646-895c-ec863c842a32-TTL24459013308000001", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
