...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-01T01:51:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T015105Z` |
...
| `start_time` | `str` | Pendiente de documentar | `01:29:29` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788227454` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T015105Z` |
| `entity_id` | `str` | Pendiente de documentar | `98191c25-fbf1-4087-a9e1-f88a1c6b4d32` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.480514526367188` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10189056396484` |
| `bearing` | `float64` | Pendiente de documentar | `101.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788227454` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-31 19:50:54-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
