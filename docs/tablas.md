...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T01:33:49Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T013344Z` |
...
| `start_time` | `str` | Pendiente de documentar | `01:09:38` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782869610` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T013344Z` |
| `entity_id` | `str` | Pendiente de documentar | `b21550a7-caa4-4976-8b4f-2afcca6fca08` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.09879302978516` |
| `bearing` | `float64` | Pendiente de documentar | `289.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `11.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782869610` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-30 19:33:30-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
