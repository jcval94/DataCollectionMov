...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-08T02:19:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260808T021944Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:19:16` |
| `start_date` | `float64` | Pendiente de documentar | `20260808.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `299.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786155577` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260808T021944Z` |
| `entity_id` | `str` | Pendiente de documentar | `a98887c3-88b2-49d3-8611-9575e4210ca4` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.490589141845703` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13319396972656` |
| `bearing` | `float64` | Pendiente de documentar | `299.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786155577` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-07 20:19:37-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
