...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T17:42:31Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T174230Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784309987` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-17 17:39:47` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T19:34:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T193444Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:25:00` |
...
| `bearing` | `float64` | Pendiente de documentar | `298.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784316842` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T193444Z` |
| `entity_id` | `str` | Pendiente de documentar | `f430c627-b375-42a0-9c12-16a37bc3e2c0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.480897903442383` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07634735107422` |
| `bearing` | `float64` | Pendiente de documentar | `298.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784316842` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-17 13:34:02-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T17:35:28Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T173524Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-17T17:35:25.220728` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.98219` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T173524Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-17T17:35:25.135360` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-17T17:22:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-17T17:53:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24441700956023001", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
