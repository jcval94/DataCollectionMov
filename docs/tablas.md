...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T16:58:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T165853Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:36:54` |
...
| `bearing` | `float64` | Pendiente de documentar | `954.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785517125` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T165853Z` |
| `entity_id` | `str` | Pendiente de documentar | `24854be5-7fef-463e-b080-efad8c6c5e4f` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49275779724121` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1434555053711` |
| `bearing` | `float64` | Pendiente de documentar | `954.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `43.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785517125` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-31 10:58:45-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
