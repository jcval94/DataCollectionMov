...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T05:56:29Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T055628Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `16` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `0` |
| `num_docks_available` | `int64` | Pendiente de documentar | `23` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786071714` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-07 03:01:54` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T13:41:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T134119Z` |
...
| `start_time` | `str` | Pendiente de documentar | `13:33:36` |
...
| `bearing` | `float64` | Pendiente de documentar | `316.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `35.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786110068` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T134119Z` |
| `entity_id` | `str` | Pendiente de documentar | `e3cc74a6-15fd-416e-894d-55b3d227d22f` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47468376159668` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07013702392578` |
| `bearing` | `float64` | Pendiente de documentar | `316.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `35.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `126.0` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786110068` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-07 07:41:08-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T05:53:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T055343Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-07T05:53:43.381254` |
...
| `current_travel_time_seconds` | `int64` | Pendiente de documentar | `574` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.91467` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 17, "freeFlowSpeed": 17, "currentTravelTime": 574, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T055343Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-07T05:53:43.274157` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2964124741` |
| `lon` | `float64` | Pendiente de documentar | `-99.3520944471` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-07T05:49:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-07T06:11:00Z` |
| `last_report_time` | `float64` | Ultimo reporte del incidente segun TomTom. | `2026-06-04T13:30:00Z` |
| `event_descriptions` | `str` | Pendiente de documentar | `Tráfico pesado` |
| `event_codes` | `int64` | Pendiente de documentar | `122` |
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3633074219, 19.2994661791], [-99.3632819409, 19.2994554994], [-99.3626824672` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ec25b321-e5cd-4e06-8756-a264821e8718-TTL24450356344112000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
