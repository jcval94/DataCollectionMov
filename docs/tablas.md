...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-03T16:28:42Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T162838Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:23:09` |
...
| `bearing` | `float64` | Pendiente de documentar | `409.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788452916` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T162838Z` |
| `entity_id` | `str` | Pendiente de documentar | `6548aefc-b6a4-4aae-8d79-721c55395c3c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.497453689575195` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1197280883789` |
| `bearing` | `float64` | Pendiente de documentar | `409.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788452916` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-03 10:28:36-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
