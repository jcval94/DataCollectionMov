...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-07T07:53:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260707T075258Z` |
...
| `start_time` | `str` | Pendiente de documentar | `06:28:19` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783409631` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260707T075258Z` |
| `entity_id` | `str` | Pendiente de documentar | `598a03e0-5de6-43b6-8c5a-b94bc312fce3` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47898292541504` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06366729736328` |
| `bearing` | `float64` | Pendiente de documentar | `0.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783409631` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-07 01:33:51-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
