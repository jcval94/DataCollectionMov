...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-04T07:13:27Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260704T071323Z` |
...
| `start_time` | `str` | Pendiente de documentar | `06:43:03` |
...
| `bearing` | `float64` | Pendiente de documentar | `331.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783142296` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260704T071323Z` |
| `entity_id` | `str` | Pendiente de documentar | `8ac30225-8039-4146-81ba-984d087d7d9d` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.479511260986328` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06377410888672` |
| `bearing` | `float64` | Pendiente de documentar | `331.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783142296` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-03 23:18:16-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
