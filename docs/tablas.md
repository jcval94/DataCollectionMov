...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-16T22:58:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T225833Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:23:41` |
...
| `bearing` | `float64` | Pendiente de documentar | `111.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `5.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789599501` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T225833Z` |
| `entity_id` | `str` | Pendiente de documentar | `ddfb4aea-5d45-428b-8a66-a3cf629b5294` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48189163208008` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1050262451172` |
| `bearing` | `float64` | Pendiente de documentar | `111.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `5.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `18.0` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789599501` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-16 16:58:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
