...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-15T21:43:06Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T214305Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1789508499` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-15 21:41:39` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-15T22:57:42Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T225737Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:47:11` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789513048` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T225737Z` |
| `entity_id` | `str` | Pendiente de documentar | `3d9b05f9-bf83-499c-a7e8-a19fafec4c1c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.50689125061035` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1997299194336` |
| `bearing` | `float64` | Pendiente de documentar | `202.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789513048` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-15 16:57:28-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-16T00:34:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T003448Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-16T00:34:49.768296` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.2003687768899816` |
| `confidence` | `float64` | Pendiente de documentar | `0.66038` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 5, "freeFlowSpeed": 6, "currentTravelTime": 1953, "freeFlowTravelTim` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T003448Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-16T00:34:49.663296` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-09-16T00:53:00Z` |
