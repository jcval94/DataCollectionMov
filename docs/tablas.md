...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T23:36:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T233649Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785368187` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-29 23:36:27` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T03:25:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T032537Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:35:58` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785381926` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T032537Z` |
| `entity_id` | `str` | Pendiente de documentar | `ebac34bc-87ee-45af-807a-20824e139a60` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4975643157959` |
| `longitude` | `float64` | Pendiente de documentar | `-99.16505432128906` |
| `bearing` | `float64` | Pendiente de documentar | `281.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `29.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785381926` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-29 21:25:26-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T23:28:29Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T232825Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-29T23:28:25.820767` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.9636` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T232825Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-29T23:28:25.760191` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-29T16:33:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-29T23:46:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTR24415734680060000", "iconCategory": 9, "magnitudeOfDelay": 0, "start` |
