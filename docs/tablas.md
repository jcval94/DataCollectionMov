...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T14:51:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T145157Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784818038` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-23 14:47:18` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T14:34:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T143441Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:26:49` |
...
| `bearing` | `float64` | Pendiente de documentar | `181.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784817261` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T143441Z` |
| `entity_id` | `str` | Pendiente de documentar | `552ef73e-2f89-4545-abaf-331bf247bda4` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.507192611694336` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19110107421876` |
| `bearing` | `float64` | Pendiente de documentar | `181.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `50.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784817261` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-23 08:34:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T15:20:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T152031Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-22T15:20:32.225788` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T152031Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-22T15:20:33.577661` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T152031Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-22T15:20:32.107348` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T152031Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-22T15:20:36.320617` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `702.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `492.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `11.7` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.2` |
| `delay_seconds` | `float64` | Pendiente de documentar | `210.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `3.5` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `42.68292682926828` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `3.5` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `42.68292682926828` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0860557768924302` |
| `delay_score` | `float64` | Pendiente de documentar | `0.1872146118721461` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.8300451514338306` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `27.02592440436109` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T14:38:45Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T143841Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-23T14:38:42.182444` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.984747` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T143841Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-23T14:38:42.121455` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-23T14:37:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-23T14:57:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24441700920019000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
