...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-15T04:51:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T045101Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:34:17` |
...
| `bearing` | `float64` | Pendiente de documentar | `334.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789447849` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260915T045101Z` |
| `entity_id` | `str` | Pendiente de documentar | `35a99267-13c6-449b-8525-3e69ea255a01` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47942924499512` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06395721435548` |
| `bearing` | `float64` | Pendiente de documentar | `334.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789447849` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-14 22:50:49-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
