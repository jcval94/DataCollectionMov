...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-17T00:51:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T005132Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1789605744` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-17 00:42:24` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-17T01:28:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T012814Z` |
...
| `start_time` | `str` | Pendiente de documentar | `00:28:44` |
| `start_date` | `float64` | Pendiente de documentar | `20260917.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `139.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `3.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789608478` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T012814Z` |
| `entity_id` | `str` | Pendiente de documentar | `93ea1f8e-8c7b-4a1b-9b94-924d173ec5c6` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46990776062012` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06524658203124` |
| `bearing` | `float64` | Pendiente de documentar | `139.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `3.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `10.8` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789608478` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-16 19:27:58-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-17T00:42:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T004243Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-17T00:42:43.531929` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.988927` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260917T004243Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-17T00:42:43.469711` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3565087351` |
| `lon` | `float64` | Pendiente de documentar | `-99.3305482621` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-17T00:01:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-17T01:08:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3303980584, 19.3567823555], [-99.3304248805, 19.3567058842], [-99.3304490203` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3e4a0d0f-4280-4c32-855f-d24afaed7dea-TTR24447471924012000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
