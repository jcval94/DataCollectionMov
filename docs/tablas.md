...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T14:56:39Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T145638Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786978538` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-17 14:55:38` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T14:46:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T144645Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:22:21` |
| `start_date` | `float64` | Pendiente de documentar | `20260817.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786977998` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T144645Z` |
| `entity_id` | `str` | Pendiente de documentar | `a1cae719-ac48-4eef-be40-731a914b4b45` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46851348876953` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08453369140624` |
| `bearing` | `float64` | Pendiente de documentar | `119.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `45.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786977998` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 08:46:38-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T14:02:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T140217Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-17T14:02:17.834913` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T140217Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-17T14:02:19.079934` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T140217Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-17T14:02:17.745611` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T140217Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-17T14:02:21.595877` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `285.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `328.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `4.75` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-13.109756097560975` |
...
| `delay_score` | `float64` | Pendiente de documentar | `0.05703238279362` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `1.996133397776703` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T14:50:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T145047Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-17T14:50:47.796216` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.981493` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T145047Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-17T14:50:47.690256` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-17T14:43:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-17T15:09:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441700936011000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
