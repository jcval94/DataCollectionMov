...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T12:21:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T122135Z` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-04T04:12:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260704T041221Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `4` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783135696` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-04 03:28:16` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-04T04:12:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260704T041221Z` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-04T03:59:57Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260704T035952Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:35:33` |
| `start_date` | `float64` | Pendiente de documentar | `20260704.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `113.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `1.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783137579` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260704T035952Z` |
| `entity_id` | `str` | Pendiente de documentar | `b1c2eb2c-0940-42f8-8594-08e090c9eba0` |
| `trip_id` | `float64` | Pendiente de documentar | `` |
| `route_id` | `float64` | Pendiente de documentar | `19472.0` |
| `direction_id` | `float64` | Pendiente de documentar | `1.0` |
| `start_time` | `str` | Pendiente de documentar | `03:35:33` |
| `start_date` | `float64` | Pendiente de documentar | `20260704.0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47683906555176` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0926742553711` |
| `bearing` | `float64` | Pendiente de documentar | `113.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `1.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `3.6` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783137579` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-03 21:59:39-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T15:34:43Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T153438Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-03T15:34:38.699731` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `391.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `444.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.516666666666667` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `7.4` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-53.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.8833333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-11.936936936936938` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T153438Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-03T15:34:40.232716` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T153438Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-03T15:34:38.589039` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T153438Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-03T15:34:43.248928` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `587.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `493.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `9.783333333333331` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.216666666666667` |
| `delay_seconds` | `float64` | Pendiente de documentar | `94.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `1.5666666666666669` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `19.066937119675465` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `1.5666666666666669` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `19.066937119675465` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0569199653279398` |
| `delay_score` | `float64` | Pendiente de documentar | `0.2423178226514486` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.6604803267661739` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `24.25212876788148` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-04T04:06:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260704T040632Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-04T04:06:32.848995` |
...
| `current_travel_time_seconds` | `int64` | Pendiente de documentar | `610` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.1867704280155642` |
| `confidence` | `float64` | Pendiente de documentar | `0.986837` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 16, "freeFlowSpeed": 19, "currentTravelTime": 610, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260704T040632Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-04T04:06:32.797096` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3563223408` |
| `lon` | `float64` | Pendiente de documentar | `-99.3501230235` |
| `icon_category` | `int64` | Pendiente de documentar | `11` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-04T01:34:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-04T09:26:00Z` |
| `last_report_time` | `float64` | Ultimo reporte del incidente segun TomTom. | `2026-06-04T13:30:00Z` |
| `event_descriptions` | `str` | Pendiente de documentar | `Inundación` |
| `event_codes` | `int64` | Pendiente de documentar | `907` |
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3509692604, 19.3556813072], [-99.350772118, 19.3557456796], [-99.3506634886,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-0e6b35d1-b793-45b4-b4a5-22dc2fb82b8b-TTR24441700776023001", "iconCategory": 11, "magnitudeOfDelay": 0, "star` |
