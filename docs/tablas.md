...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-26T03:33:42Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T033341Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787714687` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-26 03:24:47` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-26T04:54:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T045420Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:37:24` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787720053` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T045420Z` |
| `entity_id` | `str` | Pendiente de documentar | `c9781007-f5c2-4a3f-b84f-1fac605819e6` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46855735778809` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08438873291016` |
| `bearing` | `float64` | Pendiente de documentar | `295.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787720053` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-25 22:54:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
