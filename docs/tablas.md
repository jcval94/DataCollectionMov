...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T22:43:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T224342Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:29:50` |
...
| `bearing` | `float64` | Pendiente de documentar | `238.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787006611` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T224342Z` |
| `entity_id` | `str` | Pendiente de documentar | `bff652c1-b1e6-440a-af33-e848fd1c6b00` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46721649169922` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0807113647461` |
| `bearing` | `float64` | Pendiente de documentar | `238.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `18.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787006611` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 16:43:31-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
