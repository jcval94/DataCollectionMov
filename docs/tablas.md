...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-16T17:36:12Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T173612Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1781631045` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-16 17:30:45` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-16T21:21:06Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T212102Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:52:52` |
| `start_date` | `float64` | Pendiente de documentar | `20260616.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781644844` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T212102Z` |
| `entity_id` | `str` | Pendiente de documentar | `f4ba976c-3681-4a08-bcd2-b4a34d494050` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48451042175293` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11650848388672` |
| `bearing` | `float64` | Pendiente de documentar | `132.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `16.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781644844` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-16 15:20:44-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-16T18:17:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T181739Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-16T18:17:39.792579` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-12.669683257918551` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T181739Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-16T18:17:41.171235` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T181739Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-16T18:17:39.685171` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T181739Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-06-16T18:17:43.995251` |
...
| `distance_meters` | `int64` | Pendiente de documentar | `1715` |
| `duration_seconds` | `float64` | Pendiente de documentar | `270.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `333.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `4.5` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `5.55` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-63.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-1.05` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-18.91891891891892` |
...
| `delay_score` | `float64` | Pendiente de documentar | `0.000593471810089` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `0.0207715133531156` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-16T17:28:27Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T172823Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-16T17:28:23.811009` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.991341` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260616T172823Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-16T17:28:23.694452` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-16T17:20:08Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-16T17:47:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2854a05b-83f3-499c-b803-c30b2f24b6df-TTL24441700956014001", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
