...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T22:17:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T221707Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:14:10` |
...
| `bearing` | `float64` | Pendiente de documentar | `779.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `27.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784153815` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T221707Z` |
| `entity_id` | `str` | Pendiente de documentar | `bb8971fa-51ed-48c3-99e3-5841f08a11ec` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.488643646240234` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1273956298828` |
| `bearing` | `float64` | Pendiente de documentar | `779.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `27.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `97.2` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784153815` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-15 16:16:55-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
