...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-10T23:32:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260710T233250Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783726339` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-10 23:32:19` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-11T03:40:01Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260711T033958Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:36:49` |
| `start_date` | `float64` | Pendiente de documentar | `20260711.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783741189` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260711T033958Z` |
| `entity_id` | `str` | Pendiente de documentar | `fe285ba6-d221-48eb-92d4-c2c1a8c6b37c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.488679885864254` |
| `longitude` | `float64` | Pendiente de documentar | `-99.12813568115234` |
| `bearing` | `float64` | Pendiente de documentar | `105.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `36.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783741189` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-10 21:39:49-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-11T03:47:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260711T034730Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-11T03:47:30.348673` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260711T034730Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-11T03:47:30.295737` |
...
| `lat` | `float64` | Pendiente de documentar | `19.415790916` |
| `lon` | `float64` | Pendiente de documentar | `-99.3688247258` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-11T03:30:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-11T04:10:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-41b82937-4433-431b-afaa-fdf8681ff54e-TTL24441702016106000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
