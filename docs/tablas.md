...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-04T03:49:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260804T034920Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785813855` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-04 03:24:15` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-04T03:34:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260804T033433Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:17:43` |
| `start_date` | `float64` | Pendiente de documentar | `20260804.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `327.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785814457` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260804T033433Z` |
| `entity_id` | `str` | Pendiente de documentar | `3a85139f-365a-47ff-ae33-38f542f4479b` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.472360610961918` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0871810913086` |
| `bearing` | `float64` | Pendiente de documentar | `327.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `24.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785814457` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-03 21:34:17-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-04T06:45:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260804T064514Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-04T06:45:15.055710` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260804T064514Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-04T06:45:14.991227` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-08-04T07:02:00Z` |
