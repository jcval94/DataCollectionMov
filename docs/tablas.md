...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-15T23:17:31Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T231727Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:56:21` |
| `start_date` | `float64` | Pendiente de documentar | `20260715.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784157432` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260715T231727Z` |
| `entity_id` | `str` | Pendiente de documentar | `f24346fb-9a8e-488c-8fe2-0f9efbbfa4ec` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.476131439208984` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09040832519533` |
| `bearing` | `float64` | Pendiente de documentar | `300.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `6.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784157432` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-15 17:17:12-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
