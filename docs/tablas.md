...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-09T15:29:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260609T152922Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:06:50` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781018961` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260609T152922Z` |
| `entity_id` | `str` | Pendiente de documentar | `0e11eafd-ea95-422d-81d1-573325376ffd` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478763580322266` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06462097167967` |
| `bearing` | `float64` | Pendiente de documentar | `0.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781018961` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-09 09:29:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
