...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T21:18:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T211857Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `0` |
| `num_docks_available` | `int64` | Pendiente de documentar | `38` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786137482` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-07 21:18:02` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T22:56:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T225649Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:30:09` |
| `start_date` | `float64` | Pendiente de documentar | `20260807.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `300.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `16.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786143406` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T22:56:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T225649Z` |
| `entity_id` | `str` | Pendiente de documentar | `0d5c8725-3f34-4dd1-98f2-f52de51fb1c1` |
| `trip_id` | `float64` | Pendiente de documentar | `` |
| `route_id` | `float64` | Pendiente de documentar | `19473.0` |
| `direction_id` | `float64` | Pendiente de documentar | `0.0` |
| `start_time` | `str` | Pendiente de documentar | `22:30:09` |
| `start_date` | `float64` | Pendiente de documentar | `20260807.0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.482023239135746` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1051788330078` |
| `bearing` | `float64` | Pendiente de documentar | `300.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `16.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `57.6` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786143406` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-07 16:56:46-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T14:33:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T143306Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-07T14:33:07.076232` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `381.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `437.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.35` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `7.283333333333333` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-56.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.9333333333333332` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-12.814645308924488` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T143306Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-07T14:33:08.440228` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T143306Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-07T14:33:06.942238` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T143306Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-07T14:33:11.205330` |
...
| `distance_meters` | `int64` | Pendiente de documentar | `2697` |
| `duration_seconds` | `float64` | Pendiente de documentar | `483.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `540.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `8.05` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `9.0` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-57.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.95` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-10.555555555555552` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.95` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-10.555555555555552` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0515717092337917` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0146310432569974` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0914811389549155` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `4.66243620861385` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T23:01:56Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T230152Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-07T23:01:53.310172` |
...
| `current_travel_time_seconds` | `int64` | Pendiente de documentar | `1085` |
| `free_flow_travel_time_seconds` | `int64` | Pendiente de documentar | `574` |
| `delay_seconds` | `int64` | Diferencia entre tiempo actual y tiempo libre. | `120` |
| `delay_ratio` | `float64` | Pendiente de documentar | `1.8902439024390243` |
| `confidence` | `float64` | Pendiente de documentar | `0.988923` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 9, "freeFlowSpeed": 17, "currentTravelTime": 1085, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T230152Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-07T23:01:53.198301` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3016910973` |
| `lon` | `float64` | Pendiente de documentar | `-99.3684532399` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-07T22:58:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-07T23:11:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3752271587, 19.3012887552], [-99.375012582, 19.3013115383], [-99.3746089096,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ec25b321-e5cd-4e06-8756-a264821e8718-TTL24444585404056000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
