...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-22T03:06:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260822T030615Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:53:10` |
...
| `route_id` | `float64` | Pendiente de documentar | `19564.0` |
| `direction_id` | `float64` | Pendiente de documentar | `0.0` |
| `start_time` | `str` | Pendiente de documentar | `02:53:10` |
| `start_date` | `float64` | Pendiente de documentar | `20260822.0` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-22T03:11:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260822T031105Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-22T03:11:05.999836` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260822T031105Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-22T03:11:05.954689` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3607734451` |
| `lon` | `float64` | Pendiente de documentar | `-99.3496066982` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-22T03:02:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-22T03:29:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441700996014000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
