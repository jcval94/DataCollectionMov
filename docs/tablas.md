...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T18:26:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T182621Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782238884` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-23 18:21:24` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T20:26:40Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T202636Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:24:13` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782246389` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T202636Z` |
| `entity_id` | `str` | Pendiente de documentar | `e46ef13f-d578-4cf6-b8f5-28e8eee5e1bf` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49115753173828` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13526153564452` |
| `bearing` | `float64` | Pendiente de documentar | `223.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782246389` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-23 14:26:29-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T20:29:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T202912Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-23T20:29:12.577731` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.2868852459016398` |
| `confidence` | `float64` | Pendiente de documentar | `0.905286` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 7, "freeFlowSpeed": 16, "currentTravelTime": 1395, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T202912Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-23T20:29:12.494701` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-23T19:51:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-23T20:47:30Z` |
