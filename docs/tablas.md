...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T19:14:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T191417Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787597739` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-24 18:55:39` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T20:50:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T205018Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:14:45` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787604593` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T205018Z` |
| `entity_id` | `str` | Pendiente de documentar | `09ab1cd4-bd2e-4ca4-a68c-db10a49c7c4d` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.0719985961914` |
| `bearing` | `float64` | Pendiente de documentar | `116.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `39.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787604593` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-24 14:49:53-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T19:14:01Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T191358Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-24T19:13:58.465694` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.946281` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T191358Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-24T19:13:58.403668` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-24T19:04:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-24T19:33:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-8bdb8a22-bc89-4292-91ed-a170049c774c-TTL24441700956022000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
