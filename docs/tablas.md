...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-22T23:53:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260622T235259Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782171675` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-22 23:41:15` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T01:25:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T012506Z` |
...
| `start_time` | `str` | Pendiente de documentar | `01:00:22` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782177899` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T012506Z` |
| `entity_id` | `str` | Pendiente de documentar | `697afca4-bd12-4266-b90d-dedb02ef26a5` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.477792739868164` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09461975097656` |
| `bearing` | `float64` | Pendiente de documentar | `293.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `44.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782177899` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-22 19:24:59-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-22T23:47:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260622T234749Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-22T23:47:50.032346` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260622T234749Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-22T23:47:49.910108` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-22T23:41:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-23T00:06:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2854a05b-83f3-499c-b803-c30b2f24b6df-TTL24441700956014001", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
