...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T15:05:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T150502Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787150714` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-19 14:45:14` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T16:51:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T165129Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:34:53` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787158272` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T165129Z` |
| `entity_id` | `str` | Pendiente de documentar | `44540ef4-6b27-4963-9c72-8b27f4c074c3` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47714614868164` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0931396484375` |
| `bearing` | `float64` | Pendiente de documentar | `285.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `12.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787158272` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 10:51:12-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T16:57:39Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T165735Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-19T16:57:36.117086` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.996199` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T165735Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-19T16:57:36.019907` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-19T16:55:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-19T17:16:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441700920019000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
