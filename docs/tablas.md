...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-11T06:25:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260711T062505Z` |
...
| `start_time` | `str` | Pendiente de documentar | `06:20:34` |
...
| `bearing` | `float64` | Pendiente de documentar | `469.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783751090` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260711T062505Z` |
| `entity_id` | `str` | Pendiente de documentar | `73e262c4-d5a0-4ce7-adbb-16e21a98b564` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47698402404785` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06902313232422` |
| `bearing` | `float64` | Pendiente de documentar | `469.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `36.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783751090` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-11 00:24:50-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
