...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T21:31:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T213110Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785359142` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-29 21:05:42` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T22:16:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T221545Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:11:48` |
...
| `bearing` | `float64` | Pendiente de documentar | `319.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785363349` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T221545Z` |
| `entity_id` | `str` | Pendiente de documentar | `92469649-5e5b-4853-919e-ef48a3b104bd` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47676658630371` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07233428955078` |
| `bearing` | `float64` | Pendiente de documentar | `319.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `16.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785363349` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-29 16:15:49-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T21:24:39Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T212436Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-29T21:24:36.368153` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.951358` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T212436Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-29T21:24:36.299467` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3615847941` |
| `lon` | `float64` | Pendiente de documentar | `-99.3498668725` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-29T21:11:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-29T21:43:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3509612138, 19.3610952965], [-99.3505883867, 19.3612294143], [-99.3504086787` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441700924011000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
