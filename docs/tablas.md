...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-01T05:04:16Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T050411Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:49:11` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788239035` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260901T050411Z` |
| `entity_id` | `str` | Pendiente de documentar | `8673b23c-b215-4d5a-82a9-b98f64dc9bd3` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.0639419555664` |
| `bearing` | `float64` | Pendiente de documentar | `336.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788239035` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-31 23:03:55-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
