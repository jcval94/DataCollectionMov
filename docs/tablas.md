...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-16T00:14:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260716T001414Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:45:19` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784160837` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260716T001414Z` |
| `entity_id` | `str` | Pendiente de documentar | `62f14a35-b57a-4125-b395-4cd2d24b538f` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46683120727539` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0751495361328` |
| `bearing` | `float64` | Pendiente de documentar | `103.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784160837` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-15 18:13:57-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
