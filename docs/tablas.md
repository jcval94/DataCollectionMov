...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-03T18:22:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T182243Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785781133` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-03 18:18:53` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-03T18:10:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T181015Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:08:08` |
| `start_date` | `float64` | Pendiente de documentar | `20260803.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785780609` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T181015Z` |
| `entity_id` | `str` | Pendiente de documentar | `445bd968-62f4-49ef-88e4-f29e847d65bf` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.468429565429688` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06332397460938` |
| `bearing` | `float64` | Pendiente de documentar | `331.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `29.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785780609` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-03 12:10:09-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-03T16:03:24Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T160319Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-03T16:03:20.242325` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-9.86238532110092` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T160319Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-03T16:03:21.697247` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T160319Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-03T16:03:20.117890` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T160319Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-03T16:03:24.640517` |
...
| `distance_meters` | `int64` | Pendiente de documentar | `2330` |
| `duration_seconds` | `float64` | Pendiente de documentar | `396.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `437.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.6` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-9.382151029748286` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.6833333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-9.382151029748286` |
| `duration_score` | `float64` | Pendiente de documentar | `0.029936672423719` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0900621118012422` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.1926025928608024` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `8.351376029326884` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-03T18:14:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T181419Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-03T18:14:20.340204` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.8007380073800738` |
| `confidence` | `float64` | Pendiente de documentar | `0.995186` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 10, "freeFlowSpeed": 18, "currentTravelTime": 976, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260803T181419Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-03T18:14:20.257802` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-31T17:51:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-03T18:32:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ec25b321-e5cd-4e06-8756-a264821e8718-TTR24441700996014000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
