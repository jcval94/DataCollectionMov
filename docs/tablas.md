...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T15:13:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T151322Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:02:38` |
...
| `bearing` | `float64` | Pendiente de documentar | `202.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783955591` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T151322Z` |
| `entity_id` | `str` | Pendiente de documentar | `1ea2903f-36bf-4ffa-980b-8b3add2cb305` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47850799560547` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07801818847656` |
| `bearing` | `float64` | Pendiente de documentar | `202.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `11.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783955591` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-13 09:13:11-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
