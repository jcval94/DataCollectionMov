...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-13T21:13:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T211354Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:00:05` |
...
| `bearing` | `float64` | Pendiente de documentar | `190.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783977219` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260713T211354Z` |
| `entity_id` | `str` | Pendiente de documentar | `0514eda3-7951-4359-88c1-4a207790392a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47072029113769` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07969665527344` |
| `bearing` | `float64` | Pendiente de documentar | `190.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783977219` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-13 15:13:39-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
