...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T17:48:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T174838Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:19:28` |
...
| `bearing` | `float64` | Pendiente de documentar | `933.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787593705` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T174838Z` |
| `entity_id` | `str` | Pendiente de documentar | `4a7fd3e3-3aaf-4cd6-8d94-19d370110900` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4669132232666` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07587432861328` |
| `bearing` | `float64` | Pendiente de documentar | `933.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787593705` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-24 11:48:25-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
