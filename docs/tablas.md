...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T23:15:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T231523Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:25:36` |
...
| `bearing` | `float64` | Pendiente de documentar | `166.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784848516` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T231523Z` |
| `entity_id` | `str` | Pendiente de documentar | `759b8bed-fd81-41f7-a0b9-330f98ece5a9` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.50687789916992` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19972229003906` |
| `bearing` | `float64` | Pendiente de documentar | `166.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784848516` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-23 17:15:16-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
