...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-03T19:52:31Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T195227Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:30:35` |
...
| `bearing` | `float64` | Pendiente de documentar | `373.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788465147` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260903T195227Z` |
| `entity_id` | `str` | Pendiente de documentar | `7831078e-271e-4325-9c8d-c510857a1667` |
| `trip_id` | `float64` | Pendiente de documentar | `` |
| `route_id` | `float64` | Pendiente de documentar | `19493.0` |
| `direction_id` | `float64` | Pendiente de documentar | `1.0` |
| `start_time` | `str` | Pendiente de documentar | `19:30:35` |
| `start_date` | `float64` | Pendiente de documentar | `20260903.0` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.12481689453124` |
| `bearing` | `float64` | Pendiente de documentar | `373.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `38.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788465147` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-03 13:52:27-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
