...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T23:38:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T233801Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782257603` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-23 23:33:23` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-24T04:34:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T043401Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:59:02` |
...
| `bearing` | `float64` | Pendiente de documentar | `149.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782275636` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T043401Z` |
| `entity_id` | `str` | Pendiente de documentar | `bce3b386-32ab-4482-9a23-d9a6644132a6` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.471908569335938` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06756591796876` |
| `bearing` | `float64` | Pendiente de documentar | `149.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782275636` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-23 22:33:56-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-23T23:34:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T233413Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-23T23:34:14.123311` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.987485` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260623T233413Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-23T23:34:14.019729` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-23T22:28:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-23T23:54:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-19ee81bd-39c4-4110-b867-271d942821dd-TTL24441700920027000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
