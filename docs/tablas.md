...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T07:22:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T072237Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785465544` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-31 02:39:04` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T14:37:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T143750Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:24:04` |
| `start_date` | `float64` | Pendiente de documentar | `20260731.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `103.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `56.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785508657` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T14:37:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T143750Z` |
| `entity_id` | `str` | Pendiente de documentar | `2bcebd32-1588-4c90-a49a-8a83e3529551` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49877548217773` |
| `longitude` | `float64` | Pendiente de documentar | `-99.17084503173828` |
| `bearing` | `float64` | Pendiente de documentar | `103.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `56.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `201.6` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785508657` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-31 08:37:37-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-31T07:18:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T071842Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-31T07:18:42.536795` |
...
| `current_travel_time_seconds` | `int64` | Pendiente de documentar | `514` |
...
| `confidence` | `int64` | Pendiente de documentar | `1` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 19, "freeFlowSpeed": 19, "currentTravelTime": 514, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-31` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260731T071842Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-31T07:18:42.471005` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2987460506` |
| `lon` | `float64` | Pendiente de documentar | `-99.361370867` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-31T07:13:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-31T07:31:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3660365696, 19.3006892747], [-99.3657200689, 19.3005403931], [-99.3648765142` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24444585408008000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
