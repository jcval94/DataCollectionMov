...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-18T06:28:01Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260718T062800Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-20T14:34:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T143430Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:24:39` |
...
| `bearing` | `float64` | Pendiente de documentar | `118.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `49.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784558067` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T143430Z` |
| `entity_id` | `str` | Pendiente de documentar | `539c7780-86e0-4ff0-88f0-889edc1ae615` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.501781463623047` |
| `longitude` | `float64` | Pendiente de documentar | `-99.17733001708984` |
| `bearing` | `float64` | Pendiente de documentar | `118.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `49.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `176.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784558067` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-20 08:34:27-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-20T14:36:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T143654Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-20T14:36:55.061089` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.2011070110701108` |
| `confidence` | `float64` | Pendiente de documentar | `0.822893` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 15, "freeFlowSpeed": 18, "currentTravelTime": 651, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260720T143654Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-20T14:36:54.978450` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2939851173` |
| `lon` | `float64` | Pendiente de documentar | `-99.3529245908` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-20T14:26:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-20T15:08:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3635716195, 19.298080821], [-99.3634348268, 19.2980433231], [-99.3630593175,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4d8c8d74-366a-433e-b79e-5e1803f72772-TTL24450356348073000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
