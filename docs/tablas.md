...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-18T06:16:55Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260718T061648Z` |
...
| `start_time` | `str` | Pendiente de documentar | `05:59:07` |
...
| `bearing` | `float64` | Pendiente de documentar | `355.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784351911` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260718T061648Z` |
| `entity_id` | `str` | Pendiente de documentar | `f75d62ec-62f5-4d2f-a975-2eb6f01e149b` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.479549407958984` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06382751464844` |
| `bearing` | `float64` | Pendiente de documentar | `355.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784351911` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-17 23:18:31-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
