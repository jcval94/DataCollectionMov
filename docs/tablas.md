...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-09T07:51:49Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T075146Z` |
...
| `start_time` | `str` | Pendiente de documentar | `06:17:55` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783583443` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T075146Z` |
| `entity_id` | `str` | Pendiente de documentar | `e2253304-5468-449c-b3d6-d731b87e840d` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47927665710449` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06380462646484` |
| `bearing` | `float64` | Pendiente de documentar | `335.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783583443` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-09 01:50:43-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
