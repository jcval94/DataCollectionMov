...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T14:36:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T143646Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784730989` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-22 14:36:29` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T16:49:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T164918Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:00:15` |
| `start_date` | `float64` | Pendiente de documentar | `20260722.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `518.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `41.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784738938` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T164918Z` |
| `entity_id` | `str` | Pendiente de documentar | `0d8e8681-e296-4560-a35d-4061f040e8cb` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4753475189209` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08716583251952` |
| `bearing` | `float64` | Pendiente de documentar | `518.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `41.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `147.6` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784738938` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-22 10:48:58-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T14:31:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T143104Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-22T14:31:04.827454` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.97153` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T143104Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-22T14:31:04.734346` |
...
| `lat` | `float64` | Pendiente de documentar | `19.294529561` |
| `lon` | `float64` | Pendiente de documentar | `-99.3499352688` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-22T14:18:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-22T14:58:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3556054587, 19.2951491582], [-99.3555947299, 19.2951371333], [-99.3554874415` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24453241796041000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
