...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T17:57:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T175747Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `11` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784828846` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-23 17:47:26` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T18:38:45Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T183841Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:44:49` |
...
| `bearing` | `float64` | Pendiente de documentar | `321.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784831912` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T183841Z` |
| `entity_id` | `str` | Pendiente de documentar | `516ea15f-995a-4904-9cbb-f6dcf04c8f69` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.502582550048828` |
| `longitude` | `float64` | Pendiente de documentar | `-99.17903900146484` |
| `bearing` | `float64` | Pendiente de documentar | `321.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `5.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784831912` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-23 12:38:32-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T19:53:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T195328Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-23T19:53:28.684447` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.950819` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T195328Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-23T19:53:28.612255` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3609799994` |
| `lon` | `float64` | Pendiente de documentar | `-99.3489723558` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-23T19:33:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-23T20:12:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24441700996022000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
