...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T21:09:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T210950Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:03:14` |
...
| `bearing` | `float64` | Pendiente de documentar | `253.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784322570` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T210950Z` |
| `entity_id` | `str` | Pendiente de documentar | `348a3363-3231-421d-acd0-e296081ccf7c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47396278381348` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07212829589844` |
| `bearing` | `float64` | Pendiente de documentar | `253.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `18.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784322570` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-17 15:09:30-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
