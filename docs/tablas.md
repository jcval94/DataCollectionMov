...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T23:49:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T234943Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:17:23` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786146569` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T234943Z` |
| `entity_id` | `str` | Pendiente de documentar | `6a58e931-fc16-4695-9836-3bd5217479e6` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4672794342041` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0807876586914` |
| `bearing` | `float64` | Pendiente de documentar | `102.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `12.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786146569` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-07 17:49:29-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
