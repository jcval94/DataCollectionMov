...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-24T04:47:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T044710Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782275868` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-24 04:37:48` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-24T15:10:27Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T151022Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:33:53` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782313817` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260624T151022Z` |
| `entity_id` | `str` | Pendiente de documentar | `f738f84c-566f-4b40-9861-8487a7891f5d` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.466890335083008` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06175231933594` |
| `bearing` | `float64` | Pendiente de documentar | `136.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782313817` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-24 09:10:17-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
