...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-26T04:04:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T040421Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:35:38` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787717055` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T040421Z` |
| `entity_id` | `str` | Pendiente de documentar | `24e1e3fa-727a-48df-8c54-efd69ba29a81` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.488977432250977` |
| `longitude` | `float64` | Pendiente de documentar | `-99.12838745117188` |
| `bearing` | `float64` | Pendiente de documentar | `115.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787717055` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-25 22:04:15-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
