...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T17:06:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T170640Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787331323` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-21 16:55:23` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T18:58:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T185843Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:49:01` |
...
| `bearing` | `float64` | Pendiente de documentar | `769.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `44.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787338710` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T185843Z` |
| `entity_id` | `str` | Pendiente de documentar | `35b977d3-6745-4b7d-b1d4-bfd175c3df6a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.484235763549805` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1130828857422` |
| `bearing` | `float64` | Pendiente de documentar | `769.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `44.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `158.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787338710` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 12:58:30-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T19:07:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T190720Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-21T19:07:20.556729` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T190720Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-21T19:07:20.492091` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-21T18:38:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-21T19:25:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441700956014000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
