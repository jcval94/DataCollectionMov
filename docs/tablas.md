...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T17:15:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T171533Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:13:28` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786554929` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T171533Z` |
| `entity_id` | `str` | Pendiente de documentar | `7b37038c-92f9-44ec-a49a-9a0dbf4fe8e3` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49096298217773` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13504028320312` |
| `bearing` | `float64` | Pendiente de documentar | `269.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `17.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786554929` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-12 11:15:29-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T17:25:07Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T172504Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-12T17:25:04.292124` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T172504Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-12T17:25:04.222098` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4670237662` |
| `lon` | `float64` | Pendiente de documentar | `-99.3104196245` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-12T17:12:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-12T18:18:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3124420101, 19.4723198581], [-99.3115890676, 19.4701016166], [-99.3112108762` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24438817076008000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
