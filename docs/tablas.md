...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T13:26:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T132617Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787058652` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-18 13:10:52` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T14:54:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T145419Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:35:37` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787064856` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T145419Z` |
| `entity_id` | `str` | Pendiente de documentar | `dabbedb5-95e0-4bae-9d44-d30ceff5c012` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478317260742188` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0964126586914` |
| `bearing` | `float64` | Pendiente de documentar | `122.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `25.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787064856` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-18 08:54:16-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T13:19:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T131934Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-18T13:19:35.191564` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T131934Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-18T13:19:35.073162` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3565945381` |
| `lon` | `float64` | Pendiente de documentar | `-99.3304825479` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-14T03:24:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-18T13:30:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3315312917, 19.3557952637], [-99.3314977641, 19.3558220723], [-99.3313851113` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTR24447471700044000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
