...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T19:43:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T194354Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:29:35` |
...
| `bearing` | `float64` | Pendiente de documentar | `186.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786995818` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T194354Z` |
| `entity_id` | `str` | Pendiente de documentar | `9ce88314-a40b-47a8-a6fd-2ee1818443ca` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46748924255371` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08031463623048` |
| `bearing` | `float64` | Pendiente de documentar | `186.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786995818` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 13:43:38-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
