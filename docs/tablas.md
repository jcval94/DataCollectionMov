...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-23T23:44:45Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T234442Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:13:06` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790207069` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260923T234442Z` |
| `entity_id` | `str` | Pendiente de documentar | `c3a3d3ab-1cb7-425f-90e4-bd3a39eca1df` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.485218048095703` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11917114257812` |
| `bearing` | `float64` | Pendiente de documentar | `138.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790207069` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-23 17:44:29-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
