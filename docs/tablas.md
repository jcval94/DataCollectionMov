...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-04T04:28:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260904T042830Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:31:39` |
...
| `bearing` | `float64` | Pendiente de documentar | `167.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788496104` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260904T042830Z` |
| `entity_id` | `str` | Pendiente de documentar | `b775e394-fef5-4817-a78d-a0788882286e` |
| `trip_id` | `float64` | Pendiente de documentar | `` |
| `route_id` | `float64` | Pendiente de documentar | `19558.0` |
| `direction_id` | `float64` | Pendiente de documentar | `1.0` |
| `start_time` | `str` | Pendiente de documentar | `03:31:39` |
| `start_date` | `float64` | Pendiente de documentar | `20260904.0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.45003318786621` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1102294921875` |
| `bearing` | `float64` | Pendiente de documentar | `167.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788496104` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-03 22:28:24-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-04T04:43:12Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260904T044309Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-04T04:43:09.524935` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.993454` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-04` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260904T044309Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-04T04:43:09.469196` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4204686915` |
| `lon` | `float64` | Pendiente de documentar | `-99.3571343178` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-04T04:21:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-04T05:11:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-4f54caf4-b222-4646-895c-ec863c842a32-TTL24435931204442000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
