...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T14:00:16Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T140012Z` |
...
| `start_time` | `str` | Pendiente de documentar | `13:34:32` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787320794` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T140012Z` |
| `entity_id` | `str` | Pendiente de documentar | `4c1827a5-2cca-430f-9fcc-25218c00f21a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48202514648437` |
| `longitude` | `float64` | Pendiente de documentar | `-99.10521697998048` |
| `bearing` | `float64` | Pendiente de documentar | `294.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787320794` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 07:59:54-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
