...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T21:43:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T214352Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `5` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785184723` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-27 20:38:43` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T21:43:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T214352Z` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T20:45:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T204506Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:52:38` |
| `start_date` | `float64` | Pendiente de documentar | `20260727.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `292.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `6.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785185092` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T204506Z` |
| `entity_id` | `str` | Pendiente de documentar | `bd316b1c-6cf4-4af4-a6b2-4232ad3a5246` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.496660232543945` |
| `longitude` | `float64` | Pendiente de documentar | `-99.16092681884766` |
| `bearing` | `float64` | Pendiente de documentar | `292.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `6.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `21.6` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785185092` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-27 14:44:52-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T15:59:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T155916Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-27T15:59:16.898150` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `379.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `437.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.316666666666666` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-13.272311212814646` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T155916Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-27T15:59:18.294753` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T155916Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-27T15:59:16.784555` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T155916Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-27T15:59:21.157213` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `495.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `546.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `8.25` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `9.1` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-51.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.85` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-9.34065934065934` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.85` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-9.34065934065934` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0661654135338346` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0540166204986149` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.1873872726877198` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `8.615770780228479` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T21:34:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T213450Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-27T21:34:51.354095` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.1108949416342413` |
| `confidence` | `float64` | Pendiente de documentar | `0.995466` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 9, "freeFlowSpeed": 19, "currentTravelTime": 1085, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T213450Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-27T21:34:51.282501` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3593934307` |
| `lon` | `float64` | Pendiente de documentar | `-99.3548852856` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-27T20:00:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-27T21:55:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3574535007, 19.3571175795], [-99.3571946675, 19.3574663256], [-99.3571302945` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441700924011000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
