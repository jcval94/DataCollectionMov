...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-10T14:01:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T140118Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786370247` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-10 13:57:27` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-10T15:23:43Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T152324Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:05:41` |
| `start_date` | `float64` | Pendiente de documentar | `20260810.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `324.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786375401` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T152324Z` |
| `entity_id` | `str` | Pendiente de documentar | `d0bd3f7e-bef3-4f96-b06a-763b40b791e3` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47433280944824` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0884017944336` |
| `bearing` | `float64` | Pendiente de documentar | `324.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `6.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786375401` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-10 09:23:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-10T15:32:43Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T153240Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-10T15:32:40.483936` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.987903` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-10` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260810T153240Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-10T15:32:40.422051` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-10T15:15:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-10T15:52:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24441700996003000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
