...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T05:02:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T050239Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787022615` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-18 03:10:15` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T13:10:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T131014Z` |
...
| `start_time` | `str` | Pendiente de documentar | `13:04:38` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787058604` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T131014Z` |
| `entity_id` | `str` | Pendiente de documentar | `b2fd61be-5971-4750-84b8-81a2459d86b4` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.482696533203125` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11485290527344` |
| `bearing` | `float64` | Pendiente de documentar | `113.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `25.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787058604` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-18 07:10:04-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T04:56:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T045619Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-18T04:56:20.062320` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T045619Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-18T04:56:20.012519` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3529427702` |
| `lon` | `float64` | Pendiente de documentar | `-99.3313797469` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-14T03:24:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-18T05:15:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3313341493, 19.3533893505], [-99.3313475604, 19.3532753133], [-99.3313623125` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTR24450357244012000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
