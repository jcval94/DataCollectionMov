...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T07:13:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T071337Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785384532` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-30 04:08:52` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T14:34:24Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T143421Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:23:55` |
...
| `bearing` | `float64` | Pendiente de documentar | `121.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785422053` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T143421Z` |
| `entity_id` | `str` | Pendiente de documentar | `d7b16670-2418-4d64-b519-9713a671ff16` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49978446960449` |
| `longitude` | `float64` | Pendiente de documentar | `-99.17355346679688` |
| `bearing` | `float64` | Pendiente de documentar | `121.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `50.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785422053` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-30 08:34:13-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T15:30:45Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T153041Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-29T15:30:41.457314` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-13.53211009174312` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T153041Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-29T15:30:42.858693` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T153041Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-29T15:30:41.328749` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T15:30:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T153041Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-29T15:30:45.720054` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `293.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `327.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `4.883333333333334` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-10.397553516819569` |
...
| `delay_score` | `float64` | Pendiente de documentar | `0.0457796852646638` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.092852836130511` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `3.459345706873453` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T14:38:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T143854Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-30T14:38:55.390492` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.992617` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T143854Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-30T14:38:55.313182` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-30T14:37:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-30T14:57:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441700956011000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
