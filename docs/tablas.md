...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T16:12:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T161248Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:02:29` |
...
| `bearing` | `float64` | Pendiente de documentar | `112.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786119151` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T161248Z` |
| `entity_id` | `str` | Pendiente de documentar | `a9d1e3f2-16cb-4531-b61b-0ebf101567fa` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4774227142334` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0942611694336` |
| `bearing` | `float64` | Pendiente de documentar | `112.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `42.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786119151` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-07 10:12:31-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
