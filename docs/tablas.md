...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-14T21:52:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260914T215159Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:04:58` |
...
| `bearing` | `float64` | Pendiente de documentar | `201.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789422703` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260914T215159Z` |
| `entity_id` | `str` | Pendiente de documentar | `d39b6f45-f569-4db9-8ccf-b084ef590557` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.486412048339844` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11830139160156` |
| `bearing` | `float64` | Pendiente de documentar | `201.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789422703` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-14 15:51:43-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
