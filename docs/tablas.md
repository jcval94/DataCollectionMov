...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-16T06:30:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260716T063023Z` |
...
| `start_time` | `str` | Pendiente de documentar | `05:53:45` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784180832` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260716T063023Z` |
| `entity_id` | `str` | Pendiente de documentar | `3d4b6697-5645-4d93-871f-4c15b1889ece` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.479415893554688` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784180832` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-15 23:47:12-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
