...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-09T20:26:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T202610Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783628151` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-09 20:15:51` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-09T21:47:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T214747Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:34:01` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783633655` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T214747Z` |
| `entity_id` | `str` | Pendiente de documentar | `9144c720-5da8-4a82-a98b-97cba318e106` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49720573425293` |
| `longitude` | `float64` | Pendiente de documentar | `-99.16342163085938` |
| `bearing` | `float64` | Pendiente de documentar | `101.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `40.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783633655` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-09 15:47:35-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
