...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-08T13:35:56Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T133446Z` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-16T21:40:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T214008Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `18` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1789594360` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-16 21:32:40` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-16T20:10:37Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T201033Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:09:51` |
| `start_date` | `float64` | Pendiente de documentar | `20260916.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `183.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `47.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789589421` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T201033Z` |
| `entity_id` | `str` | Pendiente de documentar | `e932c888-c209-4f62-bc48-866ed7922c48` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.50964736938477` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1988525390625` |
| `bearing` | `float64` | Pendiente de documentar | `183.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `47.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `169.20000000000002` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789589421` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-16 14:10:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-16T17:41:47Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T174142Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-16T17:41:42.685931` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `386.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `412.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.433333333333334` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T174142Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-16T17:41:44.162708` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T174142Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-16T17:41:42.570135` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T174142Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-16T17:41:47.138685` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `461.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `526.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `7.683333333333334` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.766666666666667` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-65.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-1.0833333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-12.357414448669202` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-1.0833333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-12.357414448669202` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0299231702385766` |
| `delay_score` | `float64` | Pendiente de documentar | `0.5822416302765648` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0817914469973452` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `23.36082866036262` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-16T21:29:13Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T212910Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-16T21:29:10.221992` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `1.3856088560885609` |
| `confidence` | `float64` | Pendiente de documentar | `0.938225` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 13, "freeFlowSpeed": 18, "currentTravelTime": 751, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-16` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260916T212910Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-16T21:29:10.182294` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3535730593` |
| `lon` | `float64` | Pendiente de documentar | `-99.3119189794` |
| `icon_category` | `int64` | Pendiente de documentar | `8` |
| `icon_category_desc` | `str` | Categoria legible del incidente. | `Jam` |
| `magnitude_of_delay` | `int64` | Pendiente de documentar | `4` |
...
| `road_numbers` | `float64` | Pendiente de documentar | `` |
| `time_validity` | `str` | Pendiente de documentar | `present` |
| `probability` | `str` | Pendiente de documentar | `probable` |
| `number_of_reports` | `float64` | Pendiente de documentar | `3.0` |
| `start_time` | `str` | Pendiente de documentar | `2026-09-13T15:54:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-16T22:56:00Z` |
| `last_report_time` | `str` | Ultimo reporte del incidente segun TomTom. | `2026-06-04T13:30:00Z` |
| `event_descriptions` | `str` | Pendiente de documentar | `Cerrado` |
| `event_codes` | `int64` | Pendiente de documentar | `401` |
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3109989817, 19.3537487806], [-99.3110794479, 19.3537916433], [-99.3112806136` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3e4a0d0f-4280-4c32-855f-d24afaed7dea-TTR24456128208023000", "iconCategory": 8, "magnitudeOfDelay": 4, "start` |
