...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T20:48:36Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T204833Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:16:58` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787258901` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T204833Z` |
| `entity_id` | `str` | Pendiente de documentar | `f461eae4-0aa9-4a3f-808d-c082fc0b63f5` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47264289855957` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0682144165039` |
| `bearing` | `float64` | Pendiente de documentar | `130.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `29.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787258901` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-20 14:48:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
