...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-22T20:13:16Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260922T201311Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:03:56` |
...
| `bearing` | `float64` | Pendiente de documentar | `988.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790107978` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260922T201311Z` |
| `entity_id` | `str` | Pendiente de documentar | `a34ee0e0-7e0f-4124-9642-3cc560f74ee2` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.504148483276367` |
| `longitude` | `float64` | Pendiente de documentar | `-99.18453216552734` |
| `bearing` | `float64` | Pendiente de documentar | `988.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `38.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790107978` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-22 14:12:58-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
