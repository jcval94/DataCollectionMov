...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T23:20:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T232002Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786576793` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-12 23:19:53` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-13T02:45:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T024504Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:15:01` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786589098` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T024504Z` |
| `entity_id` | `str` | Pendiente de documentar | `83a63ea5-da27-4434-91d7-3c712ddce168` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46925163269043` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07189178466795` |
| `bearing` | `float64` | Pendiente de documentar | `331.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `26.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786589098` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-12 20:44:58-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T14:36:59Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T143655Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-12T14:36:55.563304` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-9.153318077803208` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T143655Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-12T14:36:56.896658` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T143655Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-12T14:36:55.461076` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T143655Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-12T14:36:59.674587` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-10.068649885583524` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.7333333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-10.068649885583524` |
| `duration_score` | `float64` | Pendiente de documentar | `0.022010582010582` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0132835201328352` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0628538223029256` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `2.712475841183935` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-13T03:05:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T030459Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-13T03:05:00.374237` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.997106` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T030459Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-13T03:05:00.283962` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4429522923` |
| `lon` | `float64` | Pendiente de documentar | `-99.3331942613` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-13T00:51:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-13T03:37:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3319912905, 19.4415816692], [-99.3318276758, 19.4419062852], [-99.3318008537` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24433045884018000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
