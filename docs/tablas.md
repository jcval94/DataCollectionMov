...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-15T04:57:34Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-15` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260815T045733Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786764801` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-15 03:33:21` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T13:07:59Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T130756Z` |
...
| `start_time` | `str` | Pendiente de documentar | `12:50:57` |
...
| `speed_mps` | `float64` | Pendiente de documentar | `51.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786972066` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T130756Z` |
| `entity_id` | `str` | Pendiente de documentar | `7dbb90e6-930c-49ca-883a-8d4d056e0aab` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47968864440918` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09992980957033` |
| `bearing` | `float64` | Pendiente de documentar | `112.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `51.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `183.6` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786972066` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 07:07:46-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-14T14:31:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T143126Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-14T14:31:26.763003` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `10.526315789473696` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T143126Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-14T14:31:28.118301` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T143126Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-14T14:31:26.652593` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-14` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260814T143126Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-14T14:31:30.912620` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `266.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `328.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `4.433333333333334` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-18.90243902439024` |
...
| `delay_score` | `float64` | Pendiente de documentar | `0.0159932659932659` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0136637784066261` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `0.833039877896833` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T13:13:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T131310Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-17T13:13:10.547071` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T131310Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-17T13:13:10.478030` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4128659534` |
| `lon` | `float64` | Pendiente de documentar | `-99.3694255406` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-17T12:10:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-17T13:34:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24438816672818000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
