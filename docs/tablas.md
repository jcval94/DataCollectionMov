...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T07:19:53Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T071952Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785290241` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-29 01:57:21` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T03:36:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T033620Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:39:20` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785296167` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T033620Z` |
| `entity_id` | `str` | Pendiente de documentar | `b94f7f06-14d1-4f39-afac-f5db44ff3d2c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.50481414794922` |
| `longitude` | `float64` | Pendiente de documentar | `-99.18801879882812` |
| `bearing` | `float64` | Pendiente de documentar | `287.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `31.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785296167` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-28 21:36:07-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-29T07:08:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T070830Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-29T07:08:30.599281` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-29` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260729T070830Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-29T07:08:30.569162` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2995735296` |
| `lon` | `float64` | Pendiente de documentar | `-99.3635675962` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-29T07:02:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-29T07:50:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24444585396024000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
