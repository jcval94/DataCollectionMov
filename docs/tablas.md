...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T18:04:34Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T180433Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `32` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `4` |
| `num_docks_available` | `int64` | Pendiente de documentar | `3` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783533702` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-08 18:01:42` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T18:48:41Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T184838Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:00:57` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783536505` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T184838Z` |
| `entity_id` | `str` | Pendiente de documentar | `a2a2fde2-2a29-41a0-940e-8020858d047f` |
| `trip_id` | `float64` | Pendiente de documentar | `` |
| `route_id` | `float64` | Pendiente de documentar | `26842.0` |
| `direction_id` | `float64` | Pendiente de documentar | `0.0` |
| `start_time` | `str` | Pendiente de documentar | `18:00:57` |
| `start_date` | `float64` | Pendiente de documentar | `20260708.0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49398803710937` |
| `longitude` | `float64` | Pendiente de documentar | `-99.14932250976562` |
| `bearing` | `float64` | Pendiente de documentar | `280.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `47.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783536505` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-08 12:48:25-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T17:56:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T175607Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-08T17:56:07.705173` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.995477` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T175607Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-08T17:56:07.625621` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2984523183` |
| `lon` | `float64` | Pendiente de documentar | `-99.3649891669` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-08T14:26:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-08T18:44:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3737143929, 19.2995627708], [-99.3736996407, 19.2995506672], [-99.3736486787` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-41b82937-4433-431b-afaa-fdf8681ff54e-TTL24447470872017000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
