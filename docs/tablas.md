...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T15:08:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T150759Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787237950` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-20 14:59:10` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T16:53:04Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T165300Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:33:30` |
...
| `bearing` | `float64` | Pendiente de documentar | `301.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787244770` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T165300Z` |
| `entity_id` | `str` | Pendiente de documentar | `282cc00e-fe42-4c73-902d-03f4e9883299` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.09312438964844` |
| `bearing` | `float64` | Pendiente de documentar | `301.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787244770` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-20 10:52:50-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T15:01:20Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T150116Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-20T15:01:17.165009` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.980261` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T150116Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-20T15:01:17.082414` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3641329259` |
| `lon` | `float64` | Pendiente de documentar | `-99.3473938758` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-20T14:59:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-20T15:19:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3456826264, 19.364296537], [-99.3456879909, 19.3642844381], [-99.3457590694,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441700984019000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
