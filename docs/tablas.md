...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T17:35:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T173513Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786555799` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-12 17:29:59` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T19:28:48Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T192843Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:32:43` |
...
| `bearing` | `float64` | Pendiente de documentar | `296.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786562913` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T192843Z` |
| `entity_id` | `str` | Pendiente de documentar | `f79973aa-79c7-4433-9a2e-455d49b93605` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.465229034423828` |
| `longitude` | `float64` | Pendiente de documentar | `-99.05980682373048` |
| `bearing` | `float64` | Pendiente de documentar | `296.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786562913` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-12 13:28:33-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-12T19:35:31Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T193527Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-12T19:35:28.118226` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.995455` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260812T193527Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-12T19:35:28.055100` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-12T19:15:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-12T19:53:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-2b48e4ea-67d4-4314-a748-f2915001794c-TTL24441700920011000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
