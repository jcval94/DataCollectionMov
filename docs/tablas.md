...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-07T17:53:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T175320Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788803494` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-07 17:51:34` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-07T21:33:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T213319Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:55:30` |
| `start_date` | `float64` | Pendiente de documentar | `20260907.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `450.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `14.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788816788` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T213319Z` |
| `entity_id` | `str` | Pendiente de documentar | `d1006d5b-86ea-4c45-9a7e-611d65e1772a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48618507385254` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11371612548828` |
| `bearing` | `float64` | Pendiente de documentar | `450.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `14.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `50.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788816788` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-07 15:33:08-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-07T18:20:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T182014Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-07T18:20:14.740451` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `407.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `429.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.783333333333333` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `7.15` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-22.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.3666666666666666` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-5.128205128205132` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T182014Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-07T18:20:16.133517` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T182014Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-07T18:20:14.633725` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T182014Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-09-07T18:20:18.703652` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `511.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `484.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `8.516666666666667` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.066666666666666` |
| `delay_seconds` | `float64` | Pendiente de documentar | `27.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `0.45` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `5.578512396694224` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `0.45` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `5.578512396694224` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0317363442172719` |
| `delay_score` | `float64` | Pendiente de documentar | `0.077037037037037` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.3212551308080198` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `10.54953440223393` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-07T17:48:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T174759Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-07T17:48:00.208157` |
...
| `current_travel_time_seconds` | `int64` | Pendiente de documentar | `1627` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.834494773519164` |
| `confidence` | `float64` | Pendiente de documentar | `0.994943` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 6, "freeFlowSpeed": 17, "currentTravelTime": 1627, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T174759Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-07T17:48:00.119084` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4211888359` |
| `lon` | `float64` | Pendiente de documentar | `-99.354993915` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-07T17:45:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-07T18:06:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3425149376, 19.4274866832], [-99.3425216431, 19.4274612302], [-99.3425739462` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ad320136-f8e8-4f16-a113-574c85e74a9b-TTL24435931112026000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
