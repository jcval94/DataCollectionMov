...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T17:43:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T174320Z` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787161391` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T174320Z` |
| `entity_id` | `str` | Pendiente de documentar | `3c00bdf4-0e1c-4af7-895e-6e31c0cf9598` |
...
| `longitude` | `float64` | Pendiente de documentar | `-99.07557678222656` |
| `bearing` | `float64` | Pendiente de documentar | `105.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787161391` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 11:43:11-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
