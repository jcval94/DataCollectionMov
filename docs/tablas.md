...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-21T18:13:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T181330Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:12:53` |
...
| `bearing` | `float64` | Pendiente de documentar | `353.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790014357` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260921T181330Z` |
| `entity_id` | `str` | Pendiente de documentar | `e8b8e937-c4bb-4b41-b44d-50bc0624310a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.50712776184082` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19102478027344` |
| `bearing` | `float64` | Pendiente de documentar | `353.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `48.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1790014357` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-21 12:12:37-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
