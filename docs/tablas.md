...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-12T20:38:51Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T203850Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `26` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `5` |
| `num_docks_available` | `int64` | Pendiente de documentar | `8` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1781296355` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-12 20:32:35` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-12T22:49:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T224915Z` |
...
| `start_time` | `str` | Pendiente de documentar | `22:31:19` |
| `start_date` | `float64` | Pendiente de documentar | `20260612.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `967.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781304549` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T224915Z` |
| `entity_id` | `str` | Pendiente de documentar | `fc7eb567-a1d4-423a-8f9a-ef5ce79afc02` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49366569519043` |
| `longitude` | `float64` | Pendiente de documentar | `-99.14574432373048` |
| `bearing` | `float64` | Pendiente de documentar | `967.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `4.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781304549` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-12 16:49:09-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-12T20:37:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T203729Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-12T20:37:30.010621` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.993081` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T203729Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-12T20:37:29.906575` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4945472994` |
| `lon` | `float64` | Pendiente de documentar | `-99.3554498906` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-12T20:28:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-12T20:55:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-208c1abc-26cd-42ed-a876-d2f71f564b3d-TTL24421504856011000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
