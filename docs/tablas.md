...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T07:46:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T074618Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783050441` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-03 03:47:21` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T14:33:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T143327Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:24:26` |
...
| `bearing` | `float64` | Pendiente de documentar | `180.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783089179` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T143327Z` |
| `entity_id` | `str` | Pendiente de documentar | `f3c8d262-dcc3-4774-a800-e35b54b7a01d` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4741153717041` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07908630371094` |
| `bearing` | `float64` | Pendiente de documentar | `180.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `8.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783089179` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-03 08:32:59-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-02T15:41:55Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260702T154151Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-02T15:41:51.244757` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `390.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `444.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.5` |
...
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-12.16216216216216` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260702T154151Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-02T15:41:52.696842` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260702T154151Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-02T15:41:51.147682` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260702T154151Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-02T15:41:55.353878` |
...
| `delay_seconds` | `float64` | Pendiente de documentar | `48.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `0.8` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `9.73630831643002` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `0.8` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `9.73630831643002` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0367933723196881` |
| `delay_score` | `float64` | Pendiente de documentar | `0.1342567927543953` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.3189064969177103` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `12.732819439144007` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T14:37:12Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T143707Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-03T14:37:08.258918` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.981352` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T143707Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-03T14:37:08.161979` |
...
| `lat` | `float64` | Pendiente de documentar | `19.2976972981` |
| `lon` | `float64` | Pendiente de documentar | `-99.3664925451` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-03T14:04:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-03T15:07:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3722338135, 19.2982713163], [-99.3720836098, 19.2981854827], [-99.3715243692` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-0e6b35d1-b793-45b4-b4a5-22dc2fb82b8b-TTL24447470880009000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
