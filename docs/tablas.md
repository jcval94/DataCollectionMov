...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-22T01:48:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260822T014847Z` |
...
| `start_time` | `str` | Pendiente de documentar | `00:59:08` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787363327` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260822T014847Z` |
| `entity_id` | `str` | Pendiente de documentar | `5b8d348d-7e1a-41bc-8e5c-befd51ca3fe3` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48006820678711` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06444549560548` |
| `bearing` | `float64` | Pendiente de documentar | `120.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787363327` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 19:48:47-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
