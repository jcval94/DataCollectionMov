...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-17T06:26:23Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T062618Z` |
...
| `start_time` | `str` | Pendiente de documentar | `06:25:48` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784269575` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260717T062618Z` |
| `entity_id` | `str` | Pendiente de documentar | `ca56d92e-66bb-4896-bb2e-53db8d381abf` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47914123535156` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06378173828124` |
| `bearing` | `float64` | Pendiente de documentar | `0.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784269575` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-17 00:26:15-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
