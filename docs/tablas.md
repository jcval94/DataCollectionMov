...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-02T01:03:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T010308Z` |
...
| `start_time` | `str` | Pendiente de documentar | `00:50:33` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788310971` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T010308Z` |
| `entity_id` | `str` | Pendiente de documentar | `e0315b6a-a1d4-4f7e-b60b-be6be93ad833` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.485471725463867` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11974334716795` |
| `bearing` | `float64` | Pendiente de documentar | `290.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `24.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788310971` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-01 19:02:51-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-02T00:21:37Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T002133Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-02T00:21:33.761890` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260902T002133Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-02T00:21:33.667724` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-09-02T01:38:00Z` |
