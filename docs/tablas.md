...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-13T22:05:03Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T220500Z` |
...
| `start_time` | `str` | Pendiente de documentar | `21:45:12` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786658687` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T220500Z` |
| `entity_id` | `str` | Pendiente de documentar | `fbf88c5f-752f-495b-83e7-d5c5444fd98e` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47528839111328` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0890121459961` |
| `bearing` | `float64` | Pendiente de documentar | `138.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786658687` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-13 16:04:47-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-13T21:10:40Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T211036Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-13T21:10:36.776004` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.166444740346205` |
| `confidence` | `float64` | Pendiente de documentar | `0.863512` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 6, "freeFlowSpeed": 13, "currentTravelTime": 1627, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-13` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260813T211036Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-13T21:10:36.683922` |
...
| `end_time` | `str` | Pendiente de documentar | `2026-08-13T21:46:00Z` |
