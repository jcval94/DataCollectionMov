...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-08T05:01:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T050145Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788839983` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-08 03:59:43` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-08T16:41:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T164112Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:05:32` |
...
| `bearing` | `float64` | Pendiente de documentar | `138.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788885657` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T164112Z` |
| `entity_id` | `str` | Pendiente de documentar | `11e2c957-8728-42f3-8aa0-cb3b71078cf7` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.470497131347656` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0651626586914` |
| `bearing` | `float64` | Pendiente de documentar | `138.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788885657` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-08 10:40:57-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
