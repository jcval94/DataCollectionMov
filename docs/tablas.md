...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T15:22:54Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T152252Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `24` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `2` |
| `num_docks_available` | `int64` | Pendiente de documentar | `13` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1782919314` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-01 15:21:54` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T17:24:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T172414Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:04:58` |
...
| `bearing` | `float64` | Pendiente de documentar | `325.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782926632` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T172414Z` |
| `entity_id` | `str` | Pendiente de documentar | `d0ecf830-97e4-4f9c-be68-bfa0181b74d7` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.474231719970703` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0882568359375` |
| `bearing` | `float64` | Pendiente de documentar | `325.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `5.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1782926632` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-01 11:23:52-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-01T15:17:15Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T151711Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-01T15:17:12.287932` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.975462` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-01` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260701T151711Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-01T15:17:12.193767` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3615700855` |
| `lon` | `float64` | Pendiente de documentar | `-99.352991646` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-01T15:04:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-01T15:35:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3523452336, 19.3610738661], [-99.352657711, 19.3613407572], [-99.352722084, ` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-0e6b35d1-b793-45b4-b4a5-22dc2fb82b8b-TTL24441701020003000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
