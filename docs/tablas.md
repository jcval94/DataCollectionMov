...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-11T04:36:18Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T043614Z` |
...
| `start_time` | `str` | Pendiente de documentar | `04:29:38` |
...
| `speed_mps` | `float64` | Pendiente de documentar | `50.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789101358` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T043614Z` |
| `entity_id` | `str` | Pendiente de documentar | `3dee9c5e-0aac-4a5c-afd1-617e3ec99bd9` |
| `trip_id` | `float64` | Pendiente de documentar | `` |
| `route_id` | `float64` | Pendiente de documentar | `19474.0` |
| `direction_id` | `float64` | Pendiente de documentar | `0.0` |
| `start_time` | `str` | Pendiente de documentar | `04:29:38` |
| `start_date` | `float64` | Pendiente de documentar | `20260911.0` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49159049987793` |
| `longitude` | `float64` | Pendiente de documentar | `-99.13733673095705` |
| `bearing` | `float64` | Pendiente de documentar | `273.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `50.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `180.0` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1789101358` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-10 22:35:58-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-11T04:50:33Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T045030Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-11T04:50:30.379625` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-11` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260911T045030Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-09-11T04:50:30.328079` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3295096305` |
| `lon` | `float64` | Pendiente de documentar | `-99.3157853836` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-09-11T04:37:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-09-11T05:13:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3162896389, 19.3286406202], [-99.3162064905, 19.3287143363], [-99.3161152954` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ad320136-f8e8-4f16-a113-574c85e74a9b-TTL24456127836008000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
