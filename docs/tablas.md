...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-26T23:38:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T233805Z` |
...
| `start_time` | `str` | Pendiente de documentar | `23:19:00` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787787442` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-26` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260826T233805Z` |
| `entity_id` | `str` | Pendiente de documentar | `695e37b9-3e0b-4568-b3da-35e20871b6cc` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4785270690918` |
| `longitude` | `float64` | Pendiente de documentar | `-99.096923828125` |
| `bearing` | `float64` | Pendiente de documentar | `112.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787787442` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-26 17:37:22-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
