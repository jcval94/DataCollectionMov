...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-21T19:39:25Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T193921Z` |
...
| `start_time` | `str` | Pendiente de documentar | `19:30:04` |
...
| `bearing` | `float64` | Pendiente de documentar | `221.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787341147` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-21` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260821T193921Z` |
| `entity_id` | `str` | Pendiente de documentar | `8d4915be-27bc-4ff0-8c7d-f820013c40ca` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.47894859313965` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07872009277344` |
| `bearing` | `float64` | Pendiente de documentar | `221.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `27.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787341147` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-21 13:39:07-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
