...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T19:54:58Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T195457Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784749210` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-22 19:40:10` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T20:32:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T203242Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:30:06` |
...
| `bearing` | `float64` | Pendiente de documentar | `852.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784752341` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T203242Z` |
| `entity_id` | `str` | Pendiente de documentar | `5fa118e9-ba5a-4a40-8daa-2875e49d0bb8` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.511550903320312` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19725036621094` |
| `bearing` | `float64` | Pendiente de documentar | `852.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `18.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784752341` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-22 14:32:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-22T19:51:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T195113Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-22T19:51:13.464576` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.989689` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-22` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260722T195113Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-22T19:51:13.385067` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-22T19:49:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-22T20:09:31Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3552473838, 19.3590514896], [-99.3551535065, 19.3591292251], [-99.355134731,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24441700920027000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
