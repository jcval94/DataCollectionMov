...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T17:59:43Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T175942Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `9` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `0` |
| `num_docks_available` | `int64` | Pendiente de documentar | `30` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785434376` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-30 17:59:36` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T17:59:44Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T175942Z` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T16:51:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T165113Z` |
...
| `start_time` | `str` | Pendiente de documentar | `16:37:15` |
| `start_date` | `float64` | Pendiente de documentar | `20260730.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `102.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `45.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785430264` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T165113Z` |
| `entity_id` | `str` | Pendiente de documentar | `57d4876b-9bca-4420-a77c-c9273ad815fa` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.49779891967773` |
| `longitude` | `float64` | Pendiente de documentar | `-99.16638946533205` |
| `bearing` | `float64` | Pendiente de documentar | `102.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `45.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `162.0` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785430264` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-30 10:51:04-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T15:32:37Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T153233Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-30T15:32:33.653009` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `370.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `436.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.166666666666667` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `7.266666666666667` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-66.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-1.1` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-15.13761467889908` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T153233Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-30T15:32:34.932410` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T153233Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-30T15:32:33.571102` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T153233Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-30T15:32:37.530593` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `272.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `327.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `4.533333333333333` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `5.45` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-55.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.9166666666666666` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-16.81957186544343` |
...
| `delay_score` | `float64` | Pendiente de documentar | `0.0609110169491525` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.0179941274416794` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `2.491768142053929` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-30T17:55:11Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T175507Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-30T17:55:08.378539` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.2509225092250924` |
| `confidence` | `float64` | Pendiente de documentar | `0.993004` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 8, "freeFlowSpeed": 18, "currentTravelTime": 1220, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-30` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260730T175507Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-30T17:55:08.304130` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3610349593` |
| `lon` | `float64` | Pendiente de documentar | `-99.3513595218` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-30T17:45:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-30T18:13:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3522366042, 19.3611650441], [-99.3521869833, 19.3611663884], [-99.3521333391` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441700920011000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
