...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T13:29:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T132920Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787145115` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-19 13:11:55` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T14:54:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T145446Z` |
...
| `start_time` | `str` | Pendiente de documentar | `14:21:56` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787151267` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T145446Z` |
| `entity_id` | `str` | Pendiente de documentar | `1a491713-d2e9-44b4-8aa1-e03aa2397081` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.474029541015625` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06961059570312` |
| `bearing` | `float64` | Pendiente de documentar | `132.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `16.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787151267` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-19 08:54:27-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
