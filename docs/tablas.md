...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T23:32:09Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T233208Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `4` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `2` |
| `num_docks_available` | `int64` | Pendiente de documentar | `33` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784849406` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-23 23:30:06` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-24T03:41:02Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T034059Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:40:03` |
| `start_date` | `float64` | Pendiente de documentar | `20260724.0` |
...
| `bearing` | `float64` | Pendiente de documentar | `164.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `21.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784864448` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T034059Z` |
| `entity_id` | `str` | Pendiente de documentar | `21eda82e-55b7-4048-8ff2-b17e54ecc4cb` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.51124382019043` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1983642578125` |
| `bearing` | `float64` | Pendiente de documentar | `164.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `21.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `75.60000000000001` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1784864448` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-23 21:40:48-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T15:32:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T153215Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-23T15:32:15.994670` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `378.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `437.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.3` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `7.283333333333333` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-59.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.9833333333333332` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-13.501144164759726` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T153215Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-23T15:32:17.280379` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T153215Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-23T15:32:15.893422` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T153215Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-23T15:32:19.910312` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `603.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `492.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `10.05` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.2` |
| `delay_seconds` | `float64` | Pendiente de documentar | `111.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `1.85` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `22.560975609756092` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `1.85` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `22.560975609756092` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0554870530209617` |
| `delay_score` | `float64` | Pendiente de documentar | `0.1338709677419355` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.464792993330884` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `16.478261123528704` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-23T23:25:56Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T232552Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-23T23:25:52.927720` |
...
| `current_travel_time_seconds` | `int64` | Pendiente de documentar | `1220` |
...
| `delay_ratio` | `float64` | Pendiente de documentar | `2.3735408560311284` |
| `confidence` | `float64` | Pendiente de documentar | `0.995329` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 8, "freeFlowSpeed": 19, "currentTravelTime": 1220, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-23` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260723T232552Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-23T23:25:52.853688` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3598802447` |
| `lon` | `float64` | Pendiente de documentar | `-99.3507144506` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-23T23:18:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-23T23:44:00Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3513259942, 19.3609732777], [-99.3510483856, 19.3603067199], [-99.3509330506` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-3fb1dfa7-039c-47c7-a14c-14d46e883eb0-TTL24441700960015000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
