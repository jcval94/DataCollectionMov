...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T23:40:59Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T234058Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `30` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `3` |
| `num_docks_available` | `int64` | Pendiente de documentar | `6` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783553938` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-08 23:38:58` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-09T04:12:05Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T041200Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:55:12` |
| `start_date` | `float64` | Pendiente de documentar | `20260709.0` |
...
| `speed_mps` | `float64` | Pendiente de documentar | `30.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783570304` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-09` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260709T041200Z` |
| `entity_id` | `str` | Pendiente de documentar | `05ab44cf-5ea8-4889-b9a3-dd2332d6e626` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46763610839844` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08170318603516` |
| `bearing` | `float64` | Pendiente de documentar | `280.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `30.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `108.0` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783570304` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-08 22:11:44-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T15:42:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T154241Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-08T15:42:41.800282` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `372.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `444.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.2` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `7.4` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-72.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-1.2` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-16.216216216216218` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T154241Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-08T15:42:43.248559` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T154241Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-08T15:42:41.681966` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T154241Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-07-08T15:42:46.019568` |
...
| `duration_seconds` | `float64` | Pendiente de documentar | `615.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `493.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `10.25` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `8.216666666666667` |
| `delay_seconds` | `float64` | Pendiente de documentar | `122.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `2.033333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `24.74645030425964` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `2.033333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `24.74645030425964` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0577608747325885` |
| `delay_score` | `float64` | Pendiente de documentar | `0.1989606533036377` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.7577262536445405` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `24.717387301484617` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-08T23:34:12Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T233408Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-08T23:34:09.223191` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.995536` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260708T233408Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-08T23:34:09.146472` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3604247852` |
| `lon` | `float64` | Pendiente de documentar | `-99.353620624` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-08T23:27:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-08T23:52:30Z` |
...
| `event_codes` | `str` | Pendiente de documentar | `115` |
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3556819016, 19.3587282898], [-99.3554203863, 19.3589106483], [-99.3552514071` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-41b82937-4433-431b-afaa-fdf8681ff54e-TTL24441700912027000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
