...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-19T03:57:19Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T035716Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:14:25` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787111827` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-19` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260819T035716Z` |
| `entity_id` | `str` | Pendiente de documentar | `418420ba-196f-4e4c-b1fc-e15ddd8677ff` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48891830444336` |
| `longitude` | `float64` | Pendiente de documentar | `-99.12842559814452` |
| `bearing` | `float64` | Pendiente de documentar | `292.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787111827` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-18 21:57:07-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
