...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-12T15:50:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T155031Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1781279342` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-06-12 15:49:02` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-12T15:42:59Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T154254Z` |
...
| `start_time` | `str` | Pendiente de documentar | `15:36:57` |
...
| `bearing` | `float64` | Pendiente de documentar | `117.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781278964` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T154254Z` |
| `entity_id` | `str` | Pendiente de documentar | `2838e144-bc2c-43b7-a8ad-d14649f4ba23` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.51069450378418` |
| `longitude` | `float64` | Pendiente de documentar | `-99.19185638427734` |
| `bearing` | `float64` | Pendiente de documentar | `117.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `27.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1781278964` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-06-12 09:42:44-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-06-12T15:45:08Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T154504Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-12T15:45:05.124860` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.995506` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-06-12` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260612T154504Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-06-12T15:45:05.051157` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3620542044` |
| `lon` | `float64` | Pendiente de documentar | `-99.3490420932` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-06-12T15:43:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-06-12T16:03:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3488744552, 19.3621279846], [-99.3490420932, 19.3620542044], [-99.3492901976` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-208c1abc-26cd-42ed-a876-d2f71f564b3d-TTL24441700992003000", "iconCategory": 6, "magnitudeOfDelay": 3, "start` |
