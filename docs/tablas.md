...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T00:27:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T002709Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
| `num_bikes_available` | `int64` | Pendiente de documentar | `0` |
| `num_bikes_disabled` | `int64` | Pendiente de documentar | `0` |
| `num_docks_available` | `int64` | Pendiente de documentar | `39` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1786061011` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-07 00:03:31` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T03:13:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T031349Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:56:37` |
...
| `bearing` | `float64` | Pendiente de documentar | `335.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786072421` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T031349Z` |
| `entity_id` | `str` | Pendiente de documentar | `1358ece1-85b2-49bb-a935-d5747b4f7ac1` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.472309112548828` |
| `longitude` | `float64` | Pendiente de documentar | `-99.08707427978516` |
| `bearing` | `float64` | Pendiente de documentar | `335.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `20.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `72.0` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1786072421` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-06 21:13:41-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-06T15:44:22Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260806T154417Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-06T15:44:17.979473` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260806T154417Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-06T15:44:19.402087` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260806T154417Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-06T15:44:17.870398` |
| `origin` | `str` | Pendiente de documentar | `Metro Universidad` |
| `destination` | `str` | Pendiente de documentar | `Rectoria UNAM` |
| `travel_mode` | `str` | Pendiente de documentar | `DRIVE` |
| `route_found` | `bool` | Pendiente de documentar | `True` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-06` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260806T154417Z` |
| `query_timestamp` | `str` | Pendiente de documentar | `2026-08-06T15:44:22.252233` |
...
| `distance_meters` | `int64` | Pendiente de documentar | `1883` |
| `duration_seconds` | `float64` | Pendiente de documentar | `384.0` |
| `static_duration_seconds` | `float64` | Pendiente de documentar | `386.0` |
| `duration_minutes` | `float64` | Pendiente de documentar | `6.4` |
| `static_duration_minutes` | `float64` | Pendiente de documentar | `6.433333333333334` |
| `delay_seconds` | `float64` | Pendiente de documentar | `-2.0` |
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.0333333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-0.5181347150259086` |
...
| `delay_minutes` | `float64` | Pendiente de documentar | `-0.0333333333333333` |
| `traffic_delay_pct` | `float64` | Pendiente de documentar | `-0.5181347150259086` |
| `duration_score` | `float64` | Pendiente de documentar | `0.0007442322004465` |
| `delay_score` | `float64` | Pendiente de documentar | `0.0757333333333333` |
| `traffic_pct_score` | `float64` | Pendiente de documentar | `0.1589104905152621` |
| `criticality_score_0_100` | `float64` | Pendiente de documentar | `5.862366925992005` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-07T00:21:00Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T002057Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-07T00:20:57.676974` |
...
| `free_flow_travel_time_seconds` | `int64` | Pendiente de documentar | `610` |
| `delay_seconds` | `int64` | Diferencia entre tiempo actual y tiempo libre. | `120` |
| `delay_ratio` | `float64` | Pendiente de documentar | `1.778688524590164` |
| `confidence` | `float64` | Pendiente de documentar | `0.927902` |
...
| `raw_response` | `str` | Pendiente de documentar | `{"flowSegmentData": {"frc": "FRC5", "currentSpeed": 9, "freeFlowSpeed": 16, "currentTravelTime": 1085, "freeFlowTravelTi` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260807T002057Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-07T00:20:57.589402` |
...
| `lat` | `float64` | Pendiente de documentar | `19.3609732777` |
| `lon` | `float64` | Pendiente de documentar | `-99.3513259942` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-06T20:36:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-07T00:39:30Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-ec25b321-e5cd-4e06-8756-a264821e8718-TTL24441700940019000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
