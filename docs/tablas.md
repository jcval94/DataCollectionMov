...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T18:09:30Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T180929Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1785174766` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-27 17:52:46` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T18:49:38Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T184918Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:48:51` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785178161` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T184918Z` |
| `entity_id` | `str` | Pendiente de documentar | `f0129583-4e27-4160-acee-dab2b82fcbd5` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.510766983032227` |
| `longitude` | `float64` | Pendiente de documentar | `-99.1984634399414` |
| `bearing` | `float64` | Pendiente de documentar | `166.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `13.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1785178161` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-27 12:49:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-27T20:01:52Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T200148Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-27T20:01:49.053907` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.995296` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-27` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260727T200148Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-27T20:01:48.976418` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-27T19:32:30Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-27T20:20:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-f315a9e5-328a-4031-808e-52000a375ca2-TTL24441701004011000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
