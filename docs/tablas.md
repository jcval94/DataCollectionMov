...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-05T01:00:17Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260905T010014Z` |
...
| `start_time` | `str` | Pendiente de documentar | `00:23:17` |
...
| `bearing` | `float64` | Pendiente de documentar | `262.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788569999` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-05` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260905T010014Z` |
| `entity_id` | `str` | Pendiente de documentar | `cf583b67-00a6-4984-98ec-940076244b77` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.48397445678711` |
| `longitude` | `float64` | Pendiente de documentar | `-99.11255645751952` |
| `bearing` | `float64` | Pendiente de documentar | `262.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788569999` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-04 18:59:59-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
