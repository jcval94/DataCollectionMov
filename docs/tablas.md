...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-24T19:58:46Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T195845Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1784922767` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-24 19:52:47` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-24T21:30:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260724T213009Z` |
...
| `start_time` | `str` | Pendiente de documentar | `20:52:22` |
