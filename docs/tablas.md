...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T17:12:49Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T171248Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787586785` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-24 15:53:05` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-24T19:02:29Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T190224Z` |
...
| `start_time` | `str` | Pendiente de documentar | `18:46:05` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787598128` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-24` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260824T190224Z` |
| `entity_id` | `str` | Pendiente de documentar | `6932afa7-2e2e-4077-acd9-1d36aa8e0c7a` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.4785099029541` |
| `longitude` | `float64` | Pendiente de documentar | `-99.09671020507812` |
| `bearing` | `float64` | Pendiente de documentar | `111.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787598128` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-24 13:02:08-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
