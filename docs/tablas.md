...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T01:58:37Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T015835Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1787018195` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-08-18 01:56:35` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T03:07:34Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T030729Z` |
...
| `start_time` | `str` | Pendiente de documentar | `02:58:14` |
...
| `bearing` | `float64` | Pendiente de documentar | `215.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787022436` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T030729Z` |
| `entity_id` | `str` | Pendiente de documentar | `d14915b2-d33f-4f44-aeee-ea0aaa162e7c` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.478403091430664` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07826232910156` |
| `bearing` | `float64` | Pendiente de documentar | `215.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `25.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787022436` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 21:07:16-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-18T03:12:14Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T031211Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-18T03:12:11.663000` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.993413` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-18` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260818T031211Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-08-18T03:12:11.615685` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-08-18T03:06:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-08-18T03:31:00Z` |
...
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-1183a978-9987-4332-9a28-b6a0825228f3-TTL24441700924027000", "iconCategory": 6, "magnitudeOfDelay": 2, "start` |
