...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-20T17:47:26Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T174723Z` |
...
| `start_time` | `str` | Pendiente de documentar | `17:20:12` |
...
| `speed_mps` | `float64` | Pendiente de documentar | `9.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787248039` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-20` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260820T174723Z` |
| `entity_id` | `str` | Pendiente de documentar | `6a263717-1547-47a7-82b9-6a15e74dc7ef` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.471052169799805` |
| `longitude` | `float64` | Pendiente de documentar | `-99.07074737548828` |
| `bearing` | `float64` | Pendiente de documentar | `161.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `9.0` |
| `speed_kmh` | `float64` | Pendiente de documentar | `32.4` |
| `current_stop_sequence` | `float64` | Pendiente de documentar | `` |
| `stop_id` | `float64` | Pendiente de documentar | `` |
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787248039` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-20 11:47:19-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
