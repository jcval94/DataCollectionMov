...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-08-17T23:39:50Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T233947Z` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787009978` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-08-17` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260817T233947Z` |
| `entity_id` | `str` | Pendiente de documentar | `c6517ea8-d9dc-4afb-9cb0-72499be2ba02` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.475217819213867` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0888442993164` |
| `bearing` | `float64` | Pendiente de documentar | `138.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1787009978` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-08-17 17:39:38-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
