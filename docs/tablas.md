...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-02T23:42:06Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260702T234204Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1783035601` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-07-02 23:40:01` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-03T04:06:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T040629Z` |
...
| `start_time` | `str` | Pendiente de documentar | `03:19:39` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783050321` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-03` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260703T040629Z` |
| `entity_id` | `str` | Pendiente de documentar | `08d06b5f-4f45-4108-8efb-8379fccd9dcc` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.479122161865234` |
| `longitude` | `float64` | Pendiente de documentar | `-99.06460571289062` |
| `bearing` | `float64` | Pendiente de documentar | `304.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1783050321` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-07-02 21:45:21-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-07-02T23:34:10Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260702T233406Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-02T23:34:07.111547` |
...
| `confidence` | `float64` | Pendiente de documentar | `0.995462` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-07-02` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260702T233406Z` |
| `extraction_timestamp` | `str` | Pendiente de documentar | `2026-07-02T23:34:07.038010` |
...
| `lat` | `float64` | Pendiente de documentar | `19.4208764312` |
| `lon` | `float64` | Pendiente de documentar | `-99.3631907458` |
...
| `start_time` | `str` | Pendiente de documentar | `2026-07-02T23:32:00Z` |
| `end_time` | `str` | Pendiente de documentar | `2026-07-02T23:52:30Z` |
...
| `raw_geometry` | `str` | Pendiente de documentar | `{"type": "LineString", "coordinates": [[-99.3702315445, 19.4209890772], [-99.370173877, 19.4210279697], [-99.3700545187,` |
| `raw_properties` | `str` | Pendiente de documentar | `{"id": "TTI-0e6b35d1-b793-45b4-b4a5-22dc2fb82b8b-TTL24427274580082000", "iconCategory": 6, "magnitudeOfDelay": 1, "start` |
