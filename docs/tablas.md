...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-07T21:45:32Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-07` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260907T214530Z` |
| `station_id` | `int64` | Pendiente de documentar | `1` |
...
| `last_reported` | `int64` | Pendiente de documentar | `1788815180` |
| `eightd_has_available_keys` | `bool` | Pendiente de documentar | `False` |
| `is_charging` | `bool` | Pendiente de documentar | `False` |
| `last_reported_datetime` | `str` | Pendiente de documentar | `2026-09-07 21:06:20` |
...
| `_extracted_at_utc` | `str` | Pendiente de documentar | `2026-09-08T00:27:21Z` |
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T002717Z` |
...
| `start_time` | `str` | Pendiente de documentar | `00:11:26` |
...
| `bearing` | `float64` | Pendiente de documentar | `191.0` |
...
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788827220` |
...
| `_snapshot_date` | `str` | Pendiente de documentar | `2026-09-08` |
| `_snapshot_id` | `str` | Pendiente de documentar | `20260908T002717Z` |
| `entity_id` | `str` | Pendiente de documentar | `a947dc12-eb90-4a2f-a0a8-df752108b454` |
...
| `vehicle_label` | `int64` | Pendiente de documentar | `2306` |
| `license_plate` | `str` | Pendiente de documentar | `1240002` |
| `latitude` | `float64` | Pendiente de documentar | `19.46742248535156` |
| `longitude` | `float64` | Pendiente de documentar | `-99.0803451538086` |
| `bearing` | `float64` | Pendiente de documentar | `191.0` |
| `speed_mps` | `float64` | Pendiente de documentar | `0.0` |
...
| `current_status` | `float64` | Pendiente de documentar | `` |
| `timestamp_raw` | `int64` | Pendiente de documentar | `1788827220` |
| `timestamp_cdmx` | `str` | Pendiente de documentar | `2026-09-07 18:27:00-06:00` |
| `congestion_level` | `float64` | Pendiente de documentar | `` |
| `occupancy_status` | `float64` | Pendiente de documentar | `` |
